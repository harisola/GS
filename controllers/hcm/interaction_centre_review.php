...
class Interaction_centre_review extends MY_Controller {
	...
	public function index(){
		...
		if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0){
			...
			$this->load->view('hcm/career/interaction_centre_review_view');
		}		
	...
	public function add(){
		if(count($_POST))
		{
			...
			redirect('/hcm/interaction_centre_review', 'refresh');
		}
	}
