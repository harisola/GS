...
<div class="col-md-12 bootstrap-grid sortable-grid ui-sortable">
  ...
  <div class="powerwidget cold-grey" id="assign_teachers_x_div" data-widget-editbutton="false" role="widget" style="">
    <header role="heading">
      <h2>Class X</h2>
    ...
    <div class="inner-spacer" role="content" style="overflow-x:scroll ; overflow-y: hidden;">
      <div class="assign_teacher_x_image">
      ...
      <?php $Limit = count($this->data['ClassTeacher']); ?>
        ...
        <tr>
          ...
          <td class="tg-031e" rowspan="<?php echo $Limit+1; ?>">X</td>
