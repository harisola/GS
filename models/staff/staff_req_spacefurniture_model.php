<?php
class Staff_req_spacefurniture_model extends CI_Model{
	...
	protected $_table_name = 'staff_registered_requirements_spacefurniture';
	...
	public function exists_staff_req_spacefurniture($StaffID){
		$result = false;
