...
class Early_admission_offer_approve_ajax extends CI_Controller{
	...
	public function get_offer_detail(){
		...
		$offer_detail =  $this->am->offer_detail_by_grade_a_level($grade_id);
		...
		$html .= '<td class="text-center">'.$offer->final_batchslot.'</td>';
		...
		if($grade_id != 1 && $grade_id != 17 && $grade_id != 2 && $grade_id != 15){
		...
		if($offer->is_early_admission_printed_offer_letter == 1){
			$html .= '<li id="offer_'.$offer->form_id.'" class="tick">Print Early Admission  Offer Letter</li>'; 
		}
		else{
		$html .= '<li id="offer_'.$offer->form_id.'" class="cross">Print Early Admission Offer Letter</li>'; 
		}
		...
		if($offer->is_early_admission_print_fee_bill == 1){
			$html .= '<li id="printed_fee_'.$offer->form_id.'"class="tick">Print Early Admission Fee Bill</li>';
		}else{
			$html .= '<li id="printed_fee_'.$offer->form_id.'" class="cross">Print Early Admission Fee Bill</li>';
		}
		...
		//  Signed Early Admission  OFFER Letter
		if($offer->is_early_admission_signed_offer_letter == 1){
			$html .= '<li id="signed_offer_'.$offer->form_id.'" class="tick">Early Admission Offer  Letter Signed</li>';

		}else{
			$html .= '<li id="signed_offer_'.$offer->form_id.'" class="cross">Early Admission Offer Letter Signed</li>';
		...
		// Early Admission  Signed Pack Hand Over
		if($offer->early_admission_offer_pack_handover == 1){
			$html .= '<li id="is_offer_pack_handover_'.$offer->form_id.'" class="tick">Early Admission Fee Bill handedover</li>';
		}
		else{
			$html .= '<li id="is_offer_pack_handover_'.$offer->form_id.'" class="cross">Early Admission Fee Bill handedover</li>';
		...
		if($offer->is_address == 1 && $offer->is_date_of_payment == 1 && $offer->is_concession_code == 1){
		...
		if($offer->is_early_admission_printed_offer_letter == 1 && $offer->is_early_admission_print_fee_bill == 1){
	...
	public function add_detail(){
		...
		$DueDate = $this->am->get_dueDate_early_admission($form_id);
		...
		if($admission_form[0]->grade_id == 1 || $admission_form[0]->grade_id == 17 || $admission_form[0]->grade_id == 2 || $admission_form[0]->grade_id == 15 ){
		...
		if($concession_detail[0]->joining_date != ''){
			$html .= '<input type="date" placeholder="dd/mm/yyyy" name="activation_date" value="'.$concession_detail[0]->joining_date.'"  />';	
			}else{
			$html .= '<input type="date" placeholder="dd/mm/yyyy" name="activation_date"  />';
			}
		}
		else{
		$html .= '<input type="date" placeholder="dd/mm/yyyy" name="activation_date"  />';	
		...
		if($father_qualification != ''){
			$html .= '<div class="col-md-5"><input type="text"  placeholder="Final Academic Qualification"   name="father_qualification" value="'.$father_qualification.'"/></div>';
		}else{
			$html .= '<div class="col-md-5"><input type="text"  placeholder="Final Academic Qualification"   name="father_qualification"/></div>';
		}
		
		$html .= '<div class="col-md-2 text-center">Final Academic Qualification</div>';
		if($mother_qualification != ''){
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Final Academic Qualification"   name="mother_qualification" value="'.$mother_qualification.'"/></div>';
		}else{
			$html .= '<div class="col-md-5"><input type="text"  placeholder="Final Academic Qualification"   name="mother_qualification"/></div>';
		}
		$html .= '</div><!-- col-md-12 -->';
		$html .= '<div class="col-md-12">';
		if($father_profession != ''){
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Profession"   name="father_profession" value="'.$father_profession.'"/></div>';
		}else{
			$html .= '<div class="col-md-5"><input type="text"  placeholder="Profession"   name="father_profession"/></div>';
		}

		$html .= '<div class="col-md-2 text-center">Profession</div>';
		if($mother_profession != ''){
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Profession"   name="mother_profession" value="'.$mother_profession.'"/></div>';
		}else{
			$html .= '<div class="col-md-5"><input type="text"  placeholder="Profession"   name="mother_profession"/></div>';
		}	
		$html .= '</div><!-- col-md-12 -->';
		...
		$html .= '<div class="col-md-5"><input type="text"  placeholder="designation"   name="father_designation" value="'.$father_designation.'"/></div>';
		}else{
			$html .= '<div class="col-md-5"><input type="text"  placeholder="designation"   name="father_designation"/></div>';
		}

		$html .= '<div class="col-md-2 text-center">Designation</div>';

		if($mother_designation != ''){
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Designation"  name="mother_designation" value="'.$mother_designation.'"/></div>';
		}else{
			$html .= '<div class="col-md-5"><input type="text"  placeholder="Designation"  name="mother_designation"/></div>';
		}
		$html .= '</div><!-- col-md-12 -->';
		...
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Department"   name="father_department" value="'.$father_department.'"/></div>';
		}else{
			$html .= '<div class="col-md-5"><input type="text"  placeholder="Department"   name="father_department"/></div>';
		}

		$html .= '<div class="col-md-2 text-center">Department</div>';

		if($mother_department != ''){
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Department"  name="mother_department" value="'.$mother_department.'"/></div>';
		}else{
			$html .= '<div class="col-md-5"><input type="text"  placeholder="Department"  name="mother_department"/></div>';
		}
		$html .= '</div><!-- col-md-12 -->';
		...
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Organization"  name="father_organization" value="'.$father_organization.'" /></div>';
		}else{
			$html .= '<div class="col-md-5"><input type="text"  placeholder="Organization"  name="father_organization" /></div>';
		}
		$html .= '<div class="col-md-2 text-center">Organization</div>';

		if($mother_organization != ''){
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Organization"  name="mother_organization" value="
		'.$mother_organization.'"/></div>';
		}else{
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Organization"  name="mother_organization"/></div>';
		...
		$html .= '<div class="col-md-12">';
		if($father_address != ''){
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Office Address"  name="father_officeAddress" value="'.$father_address.'"/></div>';
		}else{
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Office Address"  name="father_officeAddress"/></div>';
		}

		$html .= '<div class="col-md-2 text-center">Office Address</div>';
		if($mother_address  != ''){
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Office Address"  name="mother_officeAddress" value="'.$mother_address.'"/></div>';
		}else{
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Office Address"  name="mother_officeAddress"/></div>';
		}
		$html .= '</div><!-- col-md-12 -->';
		$html .= '<div class="col-md-12">';

		if($father_phone != '' ){
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Office Phone"  name="father_officePhoneNumber" value="'.$father_phone.'"/></div>';
		}else{
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Office Phone"  name="father_officePhoneNumber"/></div>';

		}
		$html .= '<div class="col-md-2 text-center">Office Phone</div>';
		if($mother_phone != ''){
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Office Phone"  name="mother_officePhoneNumber" value="'.$mother_phone.'"/></div>';
		}else{
		$html .= '<div class="col-md-5"><input type="text"  placeholder="Office Phone"  name="mother_officePhoneNumber"/></div>';
		}
		$html .= '</div><!-- col-md-12 -->';
		...
		if($("#address_form").length){
			...
			$("#address_form").validate({
				rules:{
				    ...
				    $(form).ajaxSubmit({
                        type: "POST",
                        url:"'.base_url("index.php/gs_admission/early_admission_offer_approve_ajax/insert_address_concession").'",
                        success: function (data) {
                        	...
                        	$.ajax({
                        		...
                        		url:"'.base_url().'index.php/gs_admission/early_admission_offer_approve_ajax/get_detail_of_form",
                        		success:function(e){
	...
	public function add_preperation(){
		...
		//$html .= '<label class="bigLabel" for="1">Print Early Admission  Offer Letter <a href="javascript:void(0)"  class="smallLink" id="print_offer" data-formid='.$form_id.'><em>Print</em></a> <span class="required">*</span></label>';
		$html .= '<label class="bigLabel" for="1">Print Early Admission  Offer Letter <span class="required">*</span></label>';
		$html .= '</div><!-- col-md-8 -->';
		...
		if(!empty($preperation)){
			if($preperation[0]->fif_form == 0){
				$html .= '<input type="checkbox" id="2" name="fif_form"   class="bigCheck fif_form">';
			}
			else{
				$html .= '<input type="checkbox" id="2" name="fif_form"   class="bigCheck fif_form" checked>';
			}
		}else{
			$html .= '<input type="checkbox" id="2" name="fif_form"  class="bigCheck fif_form">';
		}
		...
		if(!empty($preperation)){
			...
			$html .= '<input type="checkbox" id="3" name="photo_taken"  class="bigCheck photo_taken">';
			}
			else{
			$html .= '<input type="checkbox" id="3" name="photo_taken"  class="bigCheck photo_taken" checked>';
			}
		}else{
			$html .= '<input type="checkbox" id="3" name="photo_taken"  class="bigCheck photo_taken">';	
		}
		...
		if(!empty($preperation)){
			...
			$html .= '<input type="checkbox" id="4" name="handbook"  class="bigCheck handbook">';
			}
			else{
			$html .= '<input type="checkbox" id="4" name="handbook"  class="bigCheck handbook" checked>';
			}
		}else{
			$html .= '<input type="checkbox" id="4" name="handbook"  class="bigCheck handbook">';
		}
		...
		$html .= '<div class="col-md-8 paddingBottom10 paddingLeft30">';
		if(!empty($preperation)){
			if($preperation[0]->early_admission_print_fee_bill == 0){
		...
		$html .= '<label class="bigLabel" for="5"> Print Early Admission Fee bill <a target="_blank" href="'.base_url().'index.php/gs_admission/admission_fee_bill/fb?FormID='.$form_id.'" class="smallLink"><em>Print</em></a> <span class="required">*</span></label>';
		//$html .= '<a target="_blank" href="" class="smallLink"><em> &nbsp;Print</em></a>';
		$html .= '</div><!-- col-md-8 -->';
		$html .= '<div class="col-md-2">&nbsp;</div>';
		$html .= '</div><!-- col-md-12 -->';
		$html .= '<hr />';
	...
	public function offer_submission(){
		...
		$html .= '<div class="col-md-8 paddingBottom10 paddingLeft30">';
		if(!empty($submission)){
			if($submission[0]->early_admission_signed_offer_letter == 1){
			$html .= '<input type="checkbox" id="11" data-formid='.$form_id.' name=""  class="bigCheck signed_offer" checked>';
			}
			else{
			$html .= '<input type="checkbox" id="11" data-formid='.$form_id.' name=""  class="bigCheck signed_offer">';
			}
		}
		else{
		$html .= '<input type="checkbox" id="11" data-formid='.$form_id.' name=""  class="bigCheck signed_offer">';
		}
		$html .= '<label class="bigLabel" for="11">Early Admission Offer Letter Signed <span class="required">*</span></label>';
		$html .= '</div><!-- col-md-8 -->';
		$html .= '<div class="col-md-2">&nbsp;</div>';
		$html .= '</div>';
		$html .= '<div class="col-md-12 paddingBottom10">';
		...
		if(!empty($submission)){
			...
			$html .= '<input type="checkbox" id="22" name=""  class="bigCheck signed_fif" checked>';	
			}
			else{
			$html .= '<input type="checkbox" id="22" name=""  class="bigCheck signed_fif">';	
			}
		}
		else{
		$html .= '<input type="checkbox" id="22" name=""  class="bigCheck signed_fif">';	
		...
		if(!empty($submission)){
			...
			$html .= '<input type="checkbox" id="33" name=""  class="bigCheck signed_handbook" checked>';			

			}else{
			 $html .= '<input type="checkbox" id="33" name=""  class="bigCheck signed_handbook">';			
			}
		...
		$html .= '<div class="col-md-8 paddingBottom10 paddingLeft30">';
		if(!empty($submission)){
			if($submission[0]->early_admission_offer_pack_handover == 1){
			$html .= '<input type="checkbox" id="44" name=""  class="bigCheck offer_pack_handover" checked>';

			}
			else{
			$html .= '<input type="checkbox" id="44" name=""  class="bigCheck offer_pack_handover">';
		...
		$html .= '<label class="bigLabel" for="44">Early Admission Offer Pack handedover <span class="required">*</span></label>';
		$html .= '</div><!-- col-md-8 -->';
		$html .= '<div class="col-md-2">&nbsp;</div>';
		$html .= '</div><!-- col-md-12 -->';
		$html .= '<hr />';
		...
		$html .= '<div class="col-md-9 paddingLeft20">';
		$html .= '<div class="col-md-5">';
		$html .= '<input type="submit" class="greenBTN" value="Submit" id="btn-submission" />';
		$html .= '</div><!-- col-md-2 -->';
		$html .= '</div><!-- col-md-9 -->';
		$html .= ' </div><!-- col-md-12 -->';
		$html .= ' </div><!-- inner -->';
	...
	public function insert_update_preperation(){
		...
		if(!empty($id)){
			...
			$updated_data_row = array(
				'early_admission_offer_letter' => $offer_letter_status,
				'fif_form' => $fif_form_status,
				'photo_token' => $photo_taken_status,
				'hand_book' => $handbook_status,
				'early_admission_print_fee_bill' => $printed_fee_bill_status,
				'modified' => time(),
				'modified_by' => $this->user_id
			);
	...
	public function get_detail_of_form(){
		...
		$form_id = $this->input->post('form_id');
		$this->load->model('admission/offer_model','am');
		$form_detail =  $this->am->offer_detail_by_alevel_form_id($form_id);
	...
	public function insert_update_submission(){
		...
		if(!empty($id)){
			...
			$updated_data_row = array(
				'early_admission_signed_offer_letter' => $signed_offer,
				'completed_fif_form' => $signed_fif,
				'signed_hand_book' => $signed_handbook,
				'early_admission_offer_pack_handover' => $offer_pack_handover,
				'modified' => time(),
				'modified_by' => $this->user_id
			);
	...
	public function BillUpdate($form_id,$date_of_payment){
		...
		$BillID = date('y') . '81';
		if(($data['student'][0]->grade_id >= 6 && $data['student'][0]->grade_id <= 14) || $data['student'][0]->grade_id == 17){
			$BillID = date('y') . '82';
