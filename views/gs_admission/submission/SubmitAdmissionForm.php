                    ...
                    <form action="<?=base_url();?>index.php/gs_admission/ajax_base/form_submission" method="POST" name="submission" id="submission" class="issuance">
                        <div class="col-md-12">
                            <div class="FormNoShow">
                                ...
                                <div class="col-md-9"><input type="text" placeholder="XX/XXXX" name="form_no" id="form_no" />
                        ...
                        <div class="submission_form" style="display: none;"> 
                            <!-- col-md-12 -->
                            <hr />
                            <div class="col-md-12 paddingBottom10" id="previousData">
                                <div class="col-md-6">
                            ...
                            <div class="col-md-12 paddingBottom10">
                                <div class="col-md-6">
                                     ...
                                     <input type="text" class="" placeholder="Referal Code" name="Referal_code" id="Referal_code" maxlength="6" minlength="6" />
                                  </div>
                                <!-- col-md-6 -->
                            </div>
                            <div class="col-md-12 paddingBottom0 batch-allocation-div" style="display: none">
                                <div class="col-md-6">
                                    <select name="reAllocateBatch" id="reAllocateBatch">
                                        <option value="" disabled selected>Batch</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <select name="reAllocateSlot" id="reAllocateSlot">
                            ...
                            <div class="alevelBox">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        ...
                                        <br />
                                        <input type="hidden" id="alevelChecklisFlag">
                            ...
                            <hr />
                            <div class="col-md-12">
                                <div class="col-md-6 paddingBottom0" style="margin-top: -20px;">
                                    <input type="checkbox" id="ps" name="ps" style="display:block;visibility:hidden;"> <label for="ps">Photos Submitted *</label>
                                </div>
                            </div><!-- col-md-12 -->
                            <div class="col-md-12">
                                <div class="col-md-6 paddingBottom0" style="margin-top: -10px;">
                            ...
                            <div class="col-md-12">
                                <div class="alevelBox">
                                    <div class="col-md-12 paddingBottom0 div_alevel_checklist" style="padding-left: 0;margin-top: -10px;" >
                                        <div class="col-md-12">
                                            <input type="checkbox" required="" id="alevel_supplement" name="alevel_supplement"  style="visibility:hidden;display:block;"> 
                                            <label for="alevel_supplement">Duly filled Admission Application Form and A-Level Supplement <span class="required">*</span></label>
                                        </div>
                                        ...
                                        <div class="col-md-12 paddingBottom0 div_APCOSR" style="margin-top: -10px;">
                                            <input type="checkbox" id="APCOSR" name="alevelCheckList[]" value="APCOSR" style="display:block;visibility:hidden;"> <label for="APCOSR">Attested Photo copy of school result for grade IX, X and XI (incl mocks) <span class="required">*</span></label>
                                        </div>
                                        <!-- col-md-12 -->
                                        <!--  <div class="col-md-12 paddingBottom0">
                                        ...
                                        <div class="col-md-12 paddingBottom0 div_PRFSSE" style="margin-top: -10px;">
                                            <input class="num" type="checkbox" id="PRFSSE" name="alevelCheckList[]" value="PRFSSE" style="display:block;visibility:hidden;"> <label for="PRFSSE">Principal recommendation form in school sealed envelope <span class="required">*</span></label>
                                        </div>

                                        <!-- col-md-12 -->    
                                        <div class="col-md-12 paddingBottom0 div_ACCIEX" style="margin-top: -10px;">
                                            <input type="checkbox" value="ACCIEX"  id="ACCIEX" name="alevelCheckList[]" style="display:block;visibility:hidden;"> <label for="ACCIEX">Attested copy of CAIE Olevel Statement of Results (grade X only) <span class="required">*</span></label>
                                        </div>                                        <!-- col-md-12 -->    
