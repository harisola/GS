...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // ========================================================================        
        if ($('#visitor_applicant_assignedcard_form').length) {
            $("#visitor_applicant_assignedcard_form").validate({
...
$(document).ready(function(){
    $('[name=visitor_applicant_assignedcard_reset_button]').click(function()  {        
		resetform();
        /*$('[name=cnic]').val("");
        $('[name=name]').val("");
        $('[name=mobile_phone]').val("");        
        $('[name=applicant_assigned_card]').val("");
        $('#cnic').focus();*/
    });
});
function resetform(){
...
$('[name=name]').val("");
$('[name=mobile_phone]').val("");        
$('[name=applicant_visit_purpose]').val("");
$('[name=applicant_assigned_card]').val("");
$('#cnic').focus();
}
...
$("#review-form").validate({
	...
	rules: {
		cnic: { required: true },
		name: { required: true },
		applicant_visit_purpose: { required: true },
		mobile_phone: { required: true },
		applicant_assigned_card: { 
			required: true,
			number: true,
			minlength: 10,
			maxlength: 10
	...
	messages: {
		...
		applicant_visit_purpose: { required: 'Please enter applicant purpose' },
		mobile_phone: { required: 'Please enter mobile phone' },
		applicant_assigned_card: { required: 'Please enter card' }
