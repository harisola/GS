...
<script type="text/javascript">
    ...
    $(document).on('click','.grade_section',function(){
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"<?php echo base_url(); ?>index.php/etab/program_grade_allocation_ajax/get_subject",
            data:{grade:grade,section:section,academic:academic},
            success:function(e){
                $('#gradingMarks').hide();
                $('#subject').html(e);
            }
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"<?php echo base_url() ?>index.php/etab/program_grade_allocation_ajax/get_asp",
            data:{grade:grade,section:section,academic:academic,grade_name:grade_dname},
            success:function(e){
                $('#gradeASP').html(e);
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"<?php echo base_url(); ?>index.php/etab/program_grade_allocation_ajax/get_overall",
            data:{grade:grade,section:section,academic:academic,grade_name:grade_dname},
            success:function(e){
                $('#overallpercentage').html(e);
            }
        });
    ...
    $(document).on('click','.optional',function(){
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"<?php echo base_url() ?>index.php/etab/program_grade_allocation_ajax/get_grading",
            data:{program:op_program,subject:op_subject,grade:op_grade,academic_id:op_academic,optional:is_optional,subject_name:subject_name},
            success:function(e){
    ...
    $(document).on('click','.compulsory',function(){
        ...
        $.ajax({
            ...
            cache:false,
            url:"<?php echo base_url(); ?>index.php/etab/program_grade_allocation_ajax/get_grading",
            data:{program:com_program,subject:com_subject,grade:com_grade,academic_id:com_academic,optional:is_optional,subject_name:subject_name},
            success:function(e){
...
<script type="text/javascript">
    $(document).on('click','.btn-submit',function(){
        ...
        var stationary = $('input[name=Stationary]').val();
        var orientation_ptm = $('input[name=orientation_ptm]').val();
        var unit_ptm = $('input[name=unit_ptm]').val();
        var term = $('#term option:selected').val();
        var academic = $('input[name="academic"]').val();
        var grade_id = $('input[name="grade_id"]').val();
        $.ajax({
            type:"POST",
            url:"<?php echo base_url(); ?>index.php/etab/program_grade_allocation_ajax/insert_asp",
            cache:false,
            data:{term:term,attendance:attendance,stationary:stationary,orientation_ptm:orientation_ptm,unit_ptm:unit_ptm,academic_id:academic,grade_id:grade_id},
            success:function(e){
    ...
    $(document).on('keypress','#asp-validate',function(e){
    ...
    $(document).ready(function(){
      $(document).on('click','#sub',function(){
        if($('#overallgrade').length){
            $('#overallgrade').validate({
                ignore:[],
                rules:{
                    "grade_wieghtage[]":{
                        required:true,
                ...
                submitHandler:function(form){
                    $(form).ajaxSubmit({
                        type:"POST",
                        url:"<?php echo base_url(); ?>index.php/etab/program_grade_allocation_ajax/insert_overallGrading",
                        cache:false,
                        success:function(e){
                           console.log(e);
                        }
