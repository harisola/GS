...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 && 
                ($this->uri->uri_string() == 'report/report_atdstudents_today' || $this->uri->uri_string() == 'report/report_atdstudents_today_north')) {?>
            if ($('#attendance_students_today_table').length) {
                var oTable = $('#attendance_students_today_table').dataTable({
                    "oLanguage": {
            ...
            // View, Edit, Delete from Table (Applicant) *** only VIEW
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 && 
                ($this->uri->uri_string() == 'report/report_atdstudents_daypass_today')) {?>
            if ($('#attendance_students_daypass_today_table').length) {
                var oTable = $('#attendance_students_daypass_today_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
