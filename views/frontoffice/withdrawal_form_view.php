  ...
  <!-- <div class="col-md-6 bootstrap-grid"> --> 
    ...
    <div class="powerwidget <?php echo $title_background_color_add; ?> powerwidget-sortable" id="withdrawal_student_div" data-widget-editbutton="false" role="widget">
      <header role="heading">
        <h2>Withdrawal<small>Student</small></h2>
      ...
      <div class="inner-spacer" role="content">
        <form action="<?php echo site_url()?>/fo/student_withdrawal" id="withdrawal_student_form" name="withdrawal_student_form" class="orb-form" novalidate="novalidate" method="POST">
          <header>Student Withdrawals Form</header>
          <?php
          ...
          ?>
            ...
            <section>
              ...
              <label class="input"> <i class="icon-append fa fa-user"></i>
                ...
                <b class="tooltip tooltip-bottom-right">Enter the student Withdrawal reason</b> </label>
              </section>
            </fieldset>            
