...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            //  Datatables
            // ========================================================================
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'sis/school_post_change') {?>
            if ($('#student_academic_record_table').length) {
                var oTable = $('#student_academic_record_table').dataTable({                    
                    "oLanguage": {
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.aneditable_section a').editable({
                            source: [
                                <?php foreach ($this->data['section'] as $section) { ?>                        
                                    {value: "<?php echo $section['id']; ?>", text: "<?php echo $section['name']; ?>"},
                                <?php } ?>
                            ],
                            url: '<?php echo base_url()?>index.php/sis/school_post_change/edit',
                        ...
                        $('.aneditable_house a').editable({
                            source: [
                                <?php foreach ($this->data['house'] as $house) { ?>                        
                                    {value: "<?php echo $house['id']; ?>", text: "<?php echo $house['name']; ?>"},
                                <?php } ?>
                            ],
                            url: '<?php echo base_url()?>index.php/sis/school_post_change/edit',
                            validate: function(value) {
                        ...
                        $('.aneditable_status a').editable({
                            source: [
                                <?php foreach ($this->data['status'] as $status) { ?>                        
                                    {value: "<?php echo $status['id']; ?>", text: "<?php echo $status['name']; ?>"},
                                <?php } ?>
                            ],
                            url: '<?php echo base_url()?>index.php/sis/school_post_change/edit',
                            validate: function(value) {
                        ...
                        $('.aneditable_student_status a').editable({
                            source: [
                                <?php foreach ($this->data['student_status'] as $status) { ?>                        
                                    {value: "<?php echo $status['id']; ?>", text: "<?php echo $status['code']; ?>"},
                                <?php } ?>
                            ],
                            url: '<?php echo base_url()?>index.php/sis/school_post_change/edit',
                            validate: function(value) {
                        ...
                        $('.aneditable_status_change a').editable({
                            type: 'text',
                            name: 'status_change_comments',
                            title: 'Student Status Change Comments',
                            url: '<?php echo base_url()?>index.php/sis/school_post_change/edit',
                        ...
                        $('.aneditable_section_change a').editable({
                            type: 'text',
                            name: 'section_change_comments',
                            title: 'Student Section Change Comments',
                            url: '<?php echo base_url()?>index.php/sis/school_post_change/edit',
                        ...
                        $('.aneditable_house_change a').editable({
                            type: 'text',
                            name: 'house_change_comments',
                            title: 'Student House Change Comments',
                            url: '<?php echo base_url()?>index.php/sis/school_post_change/edit',
