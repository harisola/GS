	   ...
	   if ($('#catType').length) {
		   $("#catType").validate({
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
						type: "POST",
						url : "<?php echo base_url(); ?>index.php/ajaxBaseManupulation/subCategoryType/categorytype/create",
						cache: false,               
						...
						$.ajax({
							 type: "POST",
							 url : "<?php echo base_url(); ?>index.php/automcomplete/autocomplete/get",
							 dataType: "html",
							 success: function(data){
								$('#createdCategories2').html(data);
							  }
