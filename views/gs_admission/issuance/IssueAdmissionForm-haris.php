...
.input_fields_wrap_additional_father:last-child,
.input_fields_wrap_additional_mother:last-child {
	margin-bottom:10px;
}
</style>
		<style>
...
<input type="hidden" name="family_exists" id="family_exists" value="5043" />
        	...
        	<div class="MaroonBorderBox">
                ...
                <div class="inner">
                                ...
                                <div class="col-md-12 paddingBottom0">
                                    <div class="col-md-6" style="margin-top:-18px;">
                                        <input id="c3" name="late_issuance" id="late_issuance" style="display:block; visibility:hidden;" type="checkbox"> 
                                ...
                                <div class="col-md-12 paddingBottom20">
                                    <div class="col-md-6">
                                        <!--input placeholder="Date of Birth *"  class="textbox-n" type="text" onfocus="(this.type='date')"  id="date_of_birth" onblur="(this.type='text')" name="date_of_birth" / -->
                                            <input placeholder="Date of Birth *"  type="text"  id="date_of_birth2" name="date_of_birth2" class="date_of_birth" />
                                    </div><!-- col-md-6 -->
                                    <div class="col-md-6">
                           	...
                           	<!-- <label>Mobile</label> -->
                                            <select class="countryCodeNumber">
                                            ...
                                            <input type="text" class="col-md-10" placeholder="Mobile" id="" value="" style="padding-left:60px;" /> 
                                            <button class="add_field_button">+</button>
                        				        </div><!-- input_fields_wrap -->
                                    </div><!-- col-md-6 -->
                                    <div class="col-md-6">
                                        <input type="text" placeholder="Email *" name="admission_grade" id="applicantEmail" readonly />
                                    </div><!-- col-md-6 -->
                                </div><!-- col-md-12 -->
                                <div class="col-md-12 paddingBottom0">
                                    <div class="col-md-6">
                                        <!--input placeholder="Date of Birth *"  class="textbox-n" type="text" onfocus="(this.type='date')"  id="date_of_birth" onblur="(this.type='text')" name="date_of_birth" / -->
                                            <input placeholder="NIC/Passport *"  type="text"  id="" name="date_of_birth" class="date_of_birth" />
                                    </div><!-- col-md-6 -->
                                </div><!-- col-md-12 -->
                                <hr />
                                ...
                                <div class="col-md-12 paddingBottom20">
                                    <div class="col-md-6">
                                        ...
                                        <!-- <input type="text" class="" placeholder="Father Mobile *" name="father_mobile" id="father_mobile" /> -->
             ...
             <div id="calloutMessage" style="display:none;">
                ...
                <?php /* <div id="tabs-container">
                    <ul class="tabs-menu">
                        <li class="current"><a href="#tab-1">Basic</a></li>
                        <li><a href="#tab-2">A-Levels</a></li>
                    </ul>
                    <div class="tab">
...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="input_fields_wrap_additional"><select class="countryCodeNumber"><option data-countryCode="US" value="1" selected>USA +1</option><option data-countryCode="GB" value="44">UK +44</option></select><input type="text" class="col-md-10" placeholder="Mobile" id="" value="" style="padding-left:150px;" /> <a href="#" class="remove_field">X</a></div>'); //add input box
        }
    });
	...
	$(add_button1).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            x++; //text box increment
            $(wrapper1).append('<div class="input_fields_wrap_additional_father"><select class="countryCodeNumber"><option data-countryCode="US" value="1" selected>USA +1</option><option data-countryCode="GB" value="44">UK +44</option></select><input type="text" class="col-md-10" placeholder="Mobile" id="" value="" style="padding-left:150px;" /> <a href="#" class="remove_field1">X</a></div>'); //add input box
        }
    });
	...
	$(add_button2).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            x++; //text box increment
            $(wrapper2).append('<div class="input_fields_wrap_additional_mother"><select class="countryCodeNumber"><option data-countryCode="US" value="1" selected>USA +1</option><option data-countryCode="GB" value="44">UK +44</option></select><input type="text" class="col-md-10" placeholder="Mobile" id="" value="" style="padding-left:150px;" /> <a href="#" class="remove_field2">X</a></div>'); //add input box
        }
    });
