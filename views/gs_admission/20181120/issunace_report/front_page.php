                            ...
                            <dd>
                                <div class="mutliSelect">
                                    <ul>
										...
										<li><input type="checkbox" value="16" name="A2" id="A2" /><label for="A2">A2</label></li>
										<li><input type="checkbox" value="17" name="PG" id="PG" /><label for="PG">PG</label></li>
							...
							<div class="col-md-6 boys tooltipp">
                              ...
                              <td class="text-center" style="border-left:2px solid #888;">
							   ...
							   <td class="text-center" style="border-left:2px solid #888;">
                              	<div class="col-md-6 tooltipp girls">
                                	<span class="">G</span><br />
                                   <strong><?php if( (int)$ir["A2_G"] > 0){ echo $ir["A2_G"]; 
								   $countGirls += (int)$ir["A2_G"]; 
								   $grandTotalGirlsxii2 += (int)$ir["A2_G"]; 
								   }else{ echo 0; } ?></strong>
                                </div>
                                <div class="col-md-6 boys tooltipp">
                                	<span class="">B</span><br />
                                    <strong><?php if( (int)$ir["A2_B"] > 0){ echo $ir["A2_B"]; 
									$countBoy += $ir["A2_B"]; 
									$grandTotalBoysxii2 += $ir["A2_B"];
									}else{ echo 0; } ?></strong>
                                </div>
                              </td>
