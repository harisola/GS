<?php
class Visitors_card_model extends CI_Model{
	...
	protected $_order_by = 'card_no asc';	
	protected $_timestamps = TRUE;

	public function checkRFIDCard($card_no, $card_type){
		$result = false;

		$query = "SELECT * FROM visitor_card where card_rfid_dec = '" . $card_no . "' and card_type = " . $card_type;
		$query_result = $this->db_visitors->query($query);
