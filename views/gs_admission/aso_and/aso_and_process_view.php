        	...
        	<div class="MaroonBorderBox">
                ...
                <div class="inner paddingLeft20 paddingRight20" style="padding:20px !important;">
                	<ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" id="BatchFilter" href="#AllApplicantTab">All Applicants for grade <strong><span id='selected_grade'></span></strong> <span id="grade_count"></span></a></li>
					</ul><!-- nav-tabs -->
