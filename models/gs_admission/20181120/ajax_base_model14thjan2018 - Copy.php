...
left join (select 
	...
	and new_form_stage = 3) as reminder on reminder.admission_form_id = af.id
...
left join (select 
	...
	$query .= " where af.form_status_id = 2";
     ...
     */
		public function getfif($gf_id){
			...
			$SQLQuery =  "select
						...
						sr.gr_no as photo_id,cl.house_name,cl.std_status_code,
