...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        <?php $siteURL = 'setup_role_teacher_pn'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
                ...
                url: '<?php echo base_url()?>index.php/staff_integration/<?php echo $siteURL; ?>/edit',
            ...
            $('.aneditable_year_tutor a').editable({
                type: 'select2',
                source: [
                    {value: 0, text: 'Undefined'},
                    <?php foreach ($this->data['staff'] as $data) { ?>
            ...
            $('.aneditable_subject_teacher a').editable({
                type: 'select2',
                source: [
                    {value: 0, text: 'Undefined'},
                    <?php foreach ($this->data['staff'] as $data) { ?>
        ...
        <?php $siteURL = 'setup_role_teacher_n'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_kg'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_i'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_ii'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_iii'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_iv'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_v'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_vi'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_vii'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_viii'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_ix'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_x'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_xi'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_a1'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
        ...
        <?php $siteURL = 'setup_role_teacher_a2'; ?>
        <?php if($this->uri->uri_string() == 'staff_integration/' . $siteURL) {?>
            $('.aneditable_lead_teacher a').editable({
                type: 'select2',
                source: [
