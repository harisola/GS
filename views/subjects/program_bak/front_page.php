...
<option value="">Academic Session</option>
	...
	if( !empty($academicsList) ){ 
		...
		if( $ac["branch_id"] == "1" ){ ?>
	<option value="<?=$ac["id"];?>">North Campus</option>
<?php }else{ ?>
<option value="<?=$ac["id"];?>">South Campus</option>	
<?php } ?>
<?php } ?>
<?php } ?>
	</select>
...
<section class="col-md-3" id="northCampusGrades2" style="display:block">
	<label class="select">
...
<div id="dlist">
  <!--h2>Drop Below...</h2 -->
    <ol class="h-droped-list">
      <li class="placeholder" style="display: none;">Placeholder (hides if it has items)</li>
    </ol>
