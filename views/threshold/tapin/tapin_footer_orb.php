...
$(document).ready(function(){
    ...
    $('#tapin_form').submit(function(e) {
        ...
        $.ajax({
            url: '<?php echo base_url() . "index.php/threshold/tapin_ajax/get_TapIn_Information";?>',
            type: 'POST',
            data: data,
			dataType:'JSON',
            success: function(response) {
                ...
                TimerInterval = setInterval(setDefaultScreen, 5000);
            }
        });     
    });
...
$(document).on("change", "#slocation_id", function(){
	
	$("#main_container_header").hide();
	$("#main_container").show();
	$("#visitor_parent_assignedcard_div").show();
	
	//$('#main_container').css({'display':'block', 'margin-bottom':'30'});
	//$('#main_container_header').css({'display','block'});
	
	var slocation_id = $("#slocation_id").val();
	$("#location_id").val( slocation_id );
	$("#rfid_dec").val('');
    $("#rfid_dec").focus();
...
$(document).on("click","#setFocus_div", function(){
    ...
    function setDefaultScreen(){
        $.ajax({
            url: '<?php echo base_url() . "index.php/threshold/tapin_ajax/getDefault_ScreenLayout";?>',
            success: function(response) {
