...
class Overall_term_report_split_ajax extends CI_Controller{
    ...
    public function get_overall_term_report_combine_pdf(){
        ...
        $pdf_link = '/etab_reports/overall_term_report_split_ajax/overall_term_report_combine?
        gradeID=' . $gradeID .
        '&sectionID=' . $sectionID .
        '&gradeName=' . $gradeName .
    ...
    public function overall_term_report_combine(){
        ...
        /******************************** Students Data 
        /***********************************************/
        $data['students_term1'] = $this->assessment_report_model->get_complete_marks_of($gradeID, 1);
        /***********************************************/
        ...
        if($termID == 2){
            if($session_year == "1617"){
                $TermReportTitle = ' (Overall Term Split Report 2016-17)';
            }else if($session_year == "1718"){
                $TermReportTitle = ' (Overall Term Split Report 2017-18)';
            }
        }else{
            $TermReportTitle = ' (Overall Term Split Report 2016-17)';
        }
            ...
            foreach ($data['assessment_titles'] as $title) {
                foreach ($data['assessment_marks'] as $marks) {
                    ...
                    if($marks->gs_id == $student->gs_id
                       && $marks->subject_name_full == $title->subject_name){  // Split Change 1
        ...
        $pdf->Cell(20, 4, 'Page '.$pageNo.' / ' . ceil(($no_of_subjects+5)/7), 0, 0, 'L');
        ...
        if(($startWith_X+$TotalWidthUsed) <= $pdf->w-50){
            $startWith_X += 5;
