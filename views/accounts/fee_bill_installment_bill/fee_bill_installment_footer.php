...
<script type="text/javascript">
$(document).on('click','#search_gsid',function(e){
    e.preventDefault();
    var GSID = $('#gs_id').val();
    $('#student_info').html('');
    $('#div_fee_bill').html('');
    ...
    $.ajax({
        type: "POST",
        data: {gs_id:GSID},
        url: "<?php echo site_url()?>/accounts/fee_bill_ajax/getStudentInfo/",
        success: function(data) //we're calling the response json array 'selected_section'
        {
...
$(document).on('click','#generate_bill',function(e){
    e.preventDefault();
    $('#div_fee_bill').html('<h1>Generating...</h1>');

    var GSID = $('#gs_id').val();
    var waive = $('#waive_percentage').val();
    ...
    $.ajax({
        ...
        url: "<?php echo site_url()?>/accounts/fee_bill_ajax/get_student_bill/",
        success: function(data) //we're calling the response json array 'selected_section'
        {
            $('#div_fee_bill').html(data);
        }
