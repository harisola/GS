...
<script type="text/javascript">
        ...
        if ($("#roles-teacher").length) {
            $("#roles-teacher").validate({
                // Rules for form validation
                rules: {
                     academic: {
                        required: true
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
                        type: "POST",
                        url:"<?php echo base_url() ?>index.php/roles/assign_teacher_ajax/get_table",
                        cache:false,
                        datatype: "html",
...
<script type="text/javascript">
    ...
    function fetch_SC(){
        $.ajax({
            type:"POST",
            url:"<?php echo base_url(); ?>index.php/roles/assign_teacher_ajax/get_SC",
            cache:false,
            data:"json",
            success:function(e)
            {
...
function fetch_NC(){
    $.ajax({
        type:"POST",
        url:"<?php echo base_url(); ?>index.php/roles/assign_teacher_ajax/get_NC",
        cache:false,
        data:"json",
        success:function(e)
        {
