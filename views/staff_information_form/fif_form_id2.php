...
<form action="<?php echo site_url()?>/staff_information_form_basic/viewtifb" id="visitor_guest_assignedcard_form" name="visitor_guest_assignedcard_form" class="orb-form" novalidate="novalidate" method="POST" target="_black">
          ...
          <fieldset>
            <div class="row">
              <section class="col col-2">              
                ...
                <label class="input">
                  <input type="text" name="solangigtID" autofocus="autofocus" placeholder="GT-ID" id="searchGtIDFitB" />
