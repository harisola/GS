...
class Admission_aso_and_process extends CI_Controller{
	...
	public function get_detail_aso_and(){
		...
		if($aso_and_process->flag_ast_presence == 0){
			...
			$html .= '<td class="text-center"><small><a href="javascript:void(0)" data-toggle="modal" data-target="#myModal4" id="view_and_edit" data-form="'.$aso_and_process->form_id.'">View & Edit</a><br /><br />';	
		}
       ...
       if($aso_and_process->flag_ast_presence == 0){
		...
		if($aso_and_process->flag_ast_presence == 0){
			$html .= '<td class="text-center"><small>Mark Attendance to proceed<br /><br />';	
				...
				if($aso_and_process->flag_dis_presence == 0){
				$html .= '<td class="text-center"><small>Mark Discussion Attendance to proceed<br /><br />';
				}
				else{
					$html .= '<td class="text-center"><br/><br/>';
				}
				$html .= '<a href="#" data-toggle="modal" data-target="#myModal4" id="view_and_edit" data-form="'.$aso_and_process->form_id.'">View & Edit</a><br /><br />';
			
		}
		$html .= '<a href="javascript:void(0)" id="mark_present_aso" data-presesnt="'.$aso_and_process->form_id.'">Mark as Present</a></small></td>';
	...
	public function get_view_and_edit_a_level_modal(){
       ...
       /* $html .= '<div class="col-md-6 paddingBottom20 no-padding" id="ddIfOFR_date" style="display:none">';
        ...
        $html .= '</div>'; //<!-- col-md-6 -->
        $html .= '<div class="row">';
        $html .= '<div class="col-md-6" id="ddOFR_ALevel" style="display:none">';
        $html .= '<select name="admission_criteria_for_a_level" id="admission_criteria_for_a_level">';
