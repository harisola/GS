...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'accounts/fee_bill_arrears_advance') {?>
            if ($('#student_ana_table').length) {
                var oTable = $('#student_ana_table').dataTable({
                    "oLanguage": {
