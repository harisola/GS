...
class Option_level_allocation extends MY_Controller{
	...
	public function index(){
		...
		$where3 = array("subject_selection_grade_id" => $subjectID, "grade_id" =>$gradesID, "group_no"=>$groupID, 'subject_selection_grade_id !=' => 1, "record_deleted"=>0 );
		...
		$where2 = array("b.grade_id" =>$gradesID, "b.group_no"=>$groupID, 'b.subject_selection_grade_id !=' => 1,"b.record_deleted"=>0  );
		$select2  = "a.id, a.name";
	...
	public function getSbtBl( $unique ){
		...
		$where = array( "key" => $unique,"record_deleted"=>0  );
		$select = "ID,block";
	...
	public function subjectStudents( $sessionID, $term, $gradesID, $groupID, $subjectID,$blockID,$ID ){
		...
		foreach( $results as $r ):
			...
			$html .= ' <td width="3%">';
			$where2 = array("studentID" => $r["id"], "blockID" => $ID,"record_deleted"=>0  );
