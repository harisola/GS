...
class Tt_profile_ajax extends CI_Controller{
	...
	public function add_new_profile(){
	    ...
	    $html .= '<td style="border-right: 1px solid #666;"><input type="date"  id="july_start" max="2017-07-31" /></td>';
	    ...
	    $html .= '</div><!-- col-md-4 -->';
	    $html .= '<div class="col-md-8 no-padding">';
	    $html .= '<input type="time" id="flexy_time_std" />';
	    $html .= '</div><!-- col-md-8 -->';
	    $html .= '</div><!-- col-md-6 -->';
		$html .= '<div class="col-md-6">';
	    $html .= '<div class="col-md-4 text-right" style="padding-top: 5px;padding-left:0px;">';
	    $html .= 'Relaxation Time';
	    $html .= '</div><!-- col-md-4 -->';
	    $html .= '<div class="col-md-8 no-padding">';
	    $html .= '<input type="time" id="relaxation_time_std" />';
	    $html .= '</div><!-- col-md-8 -->';
	    $html .= '</div><!-- col-md-6 -->';
		$html .= '</div><!-- col-md-12 paddingBottom20 -->';
	    ...
	    $html .= '<td style="border-right: 1px solid #666;"><input type="date" id="cus_july_start" name="custom_july_start" max="2017-07-31" /></td>';
	    ...
	    $html .= '</div><!-- col-md-4 -->';
	    $html .= '<div class="col-md-8 no-padding">';
	    $html .= '<input type="time" id="flexy_time_cus" />';
	    $html .= '</div><!-- col-md-8 -->';
	    $html .= '</div><!-- col-md-6 -->';
		$html .= '<div class="col-md-6">';
	    $html .= '<div class="col-md-4 text-right" style="padding-top: 5px;padding-left:0px;">';
	    ...
	    $html .= '</div><!-- col-md-4 -->';
	    $html .= '<div class="col-md-8 no-padding">';
	    $html .= '<input type="time" id="relaxation_time_cus" />';
	    $html .= '</div><!-- col-md-8 -->';
	    $html .= '</div><!-- col-md-6 -->';
		$html .= '</div><!-- col-md-12 paddingBottom20 -->';
	    $html .= '</div><!-- #StandardTimingWrapper -->';
	...
	public function insert_profile_timing(){
		...
		$flexy_time = $this->input->post('flexy_time');
		$relaxation_time = $this->input->post('relaxtion_time');
	...
	public function profile_update_interface(){
		...
		if($profile_timing[0]->ext_july != '1970-01-01'){
	    $html .= '<td style="border-right: 1px solid #666;"><input type="date" placeholder="" value="'.$profile_timing[0]->ext_july.'" id="july_start_update" max="2017-07-31"  /></td>';
		}else{
	    ...
	    if($profile_timing[0]->is_on_flexy == 1){
	    	$html .= '<input type="time" id="flexy_time_std_upd" value="'.$profile_timing[0]->flexy_time.'" />';
	    }else{
	    	$html .= '<input type="time" id="flexy_time_std_upd" />';
	    }
	    ...
	    $html .= '</div><!-- col-md-4 -->';
	    $html .= '<div class="col-md-8 no-padding">';
	    if($profile_timing[0]->is_on_relaxation == 1){
	    	$html .= '<input type="time" id="relaxation_time_std_upd" value="'.$profile_timing[0]->relaxation_time.'"/>';
	    }else{
	    	$html .= '<input type="time" id="relaxation_time_std_upd" />';
	    }
		...
		if($profile_timing[0]->ext_july != '1970-01-01'){
			$html .= '<td><input type="date" id="cus_july_start_update" name="custom_july_start_update" value="'.$profile_timing[0]->ext_july.'" max="2017-07-31" /></td>';
		}else{
	    ...
	    $html .= '<div class="col-md-8 no-padding">';
	    if($profile_timing[0]->is_on_flexy == 1){
	    	$html .= '<input type="time" id="flexy_time_cus_upd" value="'.$profile_timing[0]->flexy_time.'" />';
	    }else{
	    	$html .= '<input type="time" id="flexy_time_cus_upd" />';
	    }
	    ...
	    $html .= '<div class="col-md-8 no-padding">';
	    if($profile_timing[0]->is_on_relaxation == 1){
	    	$html .= '<input type="time" id="relaxation_time_cus_upd" value="'.$profile_timing[0]->relaxation_time.'" />';
	    }else{
	    	$html .= '<input type="time" id="relaxation_time_cus_upd" />';
	    }
