  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Are you sure to delete Category</h4></div>
      
                      
            
      <div class="modal-footer">
	   <button type="button" class="btn btn-default" id="yesdelet">YES</button>
...
$(document).on("click",".link_edit",function(){
    ...
    $('#yesdelet').click(function () {
        ...
        $('#student_information_modal').modal('hide');
    });
	   ...
	   // custom function in jquery validition 
	   //http://stackoverflow.com/questions/241145/jquery-validate-plugin-how-to-create-a-simple-custom-rule
		...
		$.validator.addMethod(
			...
			function(value, element) {
				var n1 = parseInt($('#totalWeightage').val()); // greater than zero
				var n2 = parseInt(  value );
				var n3 = parseInt($('#current_weightage').val()); // current weightage
				
				var n4 = parseInt($('#aviableWeightage').val()); // Aviable Weightage
				var n5;
				var n6;
				
				//console.log( "Total "+n1 );
				//console.log( "Wants to Add "+n2 );
				//console.log( "Previous value "+n3 );
				//console.log( "Availabe "+n4 );
		...
		$(document).on("click","#createAssMain",function(){
			
			var weightage = $("#ass_cat_weightage").val();
			var totalR = $("#totalR").text();
			var totalR = parseInt( totalR );
			if( weightage > totalR ){
			var reT = ( weightage - totalR );	
			}else{
				var reT = ( totalR -  weightage );
			}
			 ...
			 $("#order-form").validate({
                ...
                messages: {
                    ...
                    ass_cat_weightage: {
						required: 'Please enter category Weightage',
					    uniqueUserName: "Weightage Exceed"
                    }
                },
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
						type: "POST",
						url : "<?php echo base_url(); ?>index.php/automcomplete/autocomplete/createCategory",
						cache: false,               
						...
						complete:function(){
							...
							$("#order-form").removeClass('submited');
							$("#order-form").addClass('orb-form');
						}
                    });
                },
		...
		$(document).on("click", "#updateAssMain", function(){
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
                        ...
                        success: function ( data ) {
							 ...
							 $.ajax({
							 type: "POST",
							 url : "<?=base_url(); ?>index.php/automcomplete/autocomplete/getCreatedCategories2",
							 dataType: "html",
							 success: function(data){
								$('#afterUpdate').html(data);
							  }
