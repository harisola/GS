...
<form action="<?=base_url();?>index.php/gs_admission/frontoffice_followup/add_comments" method="POST" name="form_followup" id="form_followup" class="issuance">
...
<?php //echo $form_batch_id; //var_dump($batch); ?>
...
<?php if(!empty($timeSlots)){
	foreach( $timeSlots as $b ){
		$id = $b["slotID"];
		$cat_name = $b["Duration"];
	?>
	<option value="<?=$id;?>" <?php if( $give_slot_id == $id ){ echo "selected"; } ?>> <?=$cat_name;?></option>	
	<?php } 
	} ?>
