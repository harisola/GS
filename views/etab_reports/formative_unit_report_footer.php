...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 0 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'hcm/applicant_form') {?>
            if ($('#applicant_view_table').length) {
                var oTable = $('#applicant_view_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
            ...
            <?php } else if($this->data['can_user_view'] == 1 && ($this->data['can_user_edit'] == 1 || $this->data['can_user_delete'] == 1) && $this->uri->uri_string() == 'hcm/applicant_form') { ?>
            if ($('#applicant_edit_table').length) {
                var oTable = $('#applicant_edit_table').dataTable({                    
                    "oLanguage": {
                        "sSearch": "Search all columns:"
                    },
                    "sDom": 'T<"clear">lfrtip',
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.sorting_1 a').editable({
                            type: 'text',
                            name: 'full_name',
                            title: 'Applicant Name',
                            url: '<?php echo base_url()?>index.php/hcm/applicant_form/edit',
                        ...
                        $('.aneditablerequiredmobilephone a').editable({
                            type: 'text',                                
                            url: '<?php echo base_url()?>index.php/hcm/applicant_form/edit',                
                        ...
                        $('.aneditablerequirednic a').editable({
                            type: 'text',                                
                            url: '<?php echo base_url()?>index.php/hcm/applicant_form/edit',                
                        ...
                        $('.aneditableposition a').editable({
                            type: 'select2',
                            inputclass: 'input-large',
                            emptytext: 'None',
                            url: '<?php echo base_url()?>index.php/hcm/applicant_form/edit',
                            select2: {
                                tags: ['Management', 'Teaching', 'Admin', 'Technical'],
                                tokenSeparators: [",", " "]
                            }
                        }); 

                        $('.aneditablelandline a').editable({
                            type: 'text',                                
                            url: '<?php echo base_url()?>index.php/hcm/applicant_form/edit'                               
                        });

                        $('.aneditablerequirednic a').on('shown', function(e, editable) {
                            $(this).data('editable').input.$input.mask('99999-9999999-9');
                        });

                        $('.aneditablelandline a').on('shown', function(e, editable) {
                            $(this).data('editable').input.$input.mask('999-9999999');
                        });

                        $('.aneditablerequiredmobilephone a').on('shown', function(e, editable) {
                            $(this).data('editable').input.$input.mask('0999-9999999');
                        });

                        $('.aneditable a').editable({
                            type: 'text',                                
                            url: '<?php echo base_url()?>index.php/hcm/applicant_form/edit'
                        });

                        <?php if($this->data['can_user_delete'] == 1) { ?>
                        $('#applicant_edit_table .aneditableremove a').editable({                
                            source: [
                                {value: '0', text: '0'},
                                {value: '1', text: '1'}
                            ],
            ...
            <?php } ?>
             ...
             // View all forms in Table (Applicant) *** only VIEW
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'hcm/view_applicant_form') {?>
            if ($('#applicant_view_table').length) {
                var oTable = $('#applicant_view_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                ...
                $('#applicant_view_table tbody').on('click', 'tr', function () {
                    var form_no = $('td', this).eq(7).text();
                    //testDirectCall_Source(form_no);                                        
                });
            }
            <?php } ?>

            function testDirectCall_Source(form_no){
                alert( 'You clicked on form # ' + (form_no +1) );
            }


            /**************************************
            ** Users placement in Branch
            **************************************/
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 0 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'organization/branch_users') {?>
            if ($('#users_edit_table').length) {
                var oTable = $('#users_edit_table').dataTable({                    
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
            ...
            <?php } else if($this->data['can_user_view'] == 1 && ($this->data['can_user_edit'] == 1 || $this->data['can_user_delete'] == 1) && $this->uri->uri_string() == 'organization/branch_users') { ?>
            if ($('#users_edit_table').length) {
                var oTable = $('#users_edit_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {                                                
                        // Change branch data
                        $('.selectbranch a').editable({                
                            source: [
                                {value: '1', text: 'North Campus'},
                                {value: '2', text: 'South Campus'}
                            ],
                            url: '<?php echo base_url()?>index.php/organization/branch_users/edit',                
                            validate: function(value) {
                               if($.trim(value) == '') return 'This field is required';                   
                            }   
                        });                                                                      
            ...
            **************************************/
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 0 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'organization/department') {?>
            if ($('#departments_existing').length) {
                var oTable = $('#departments_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
            ...
            <?php } else if($this->data['can_user_view'] == 1 && ($this->data['can_user_edit'] == 1 || $this->data['can_user_delete'] == 1) && $this->uri->uri_string() == 'organization/department') { ?>
            if ($('#departments_existing').length) {
                var oTable = $('#departments_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {                                                
                        ...
                        $('.sorting_1 a').editable({
                            ...
                            url: '<?php echo base_url()?>index.php/organization/department/edit',
            ...
            ** All Existing Wings
            **************************************/
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 0 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'organization/wing') {?>
            if ($('#wings_existing').length) {
                var oTable = $('#wings_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
            ...
            <?php } else if($this->data['can_user_view'] == 1 && ($this->data['can_user_edit'] == 1 || $this->data['can_user_delete'] == 1) && $this->uri->uri_string() == 'organization/wing') { ?>
            if ($('#wings_existing').length) {
                var oTable = $('#wings_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {                                                
                        ...
                        $('.sorting_1 a').editable({
                            ...
                            name: 'name',
                            title: 'Wing Name',
                            url: '<?php echo base_url()?>index.php/organization/wing/edit',
            ...
            ** All Existing Grades
            **************************************/
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 0 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'organization/grade') {?>
            if ($('#grades_existing').length) {
                var oTable = $('#grades_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
            ...
            <?php } else if($this->data['can_user_view'] == 1 && ($this->data['can_user_edit'] == 1 || $this->data['can_user_delete'] == 1) && $this->uri->uri_string() == 'organization/grade') { ?>
            if ($('#grades_existing').length) {
                var oTable = $('#grades_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {                                                
                        ...
                        $('.sorting_1 a').editable({
                            ...
                            name: 'name',
                            title: 'Grade Name',
                            url: '<?php echo base_url()?>index.php/organization/grade/edit',
                        ...
                        $('.complete_in_years a').editable({
                            type: 'text',
                            name: 'complete_in_years',
                            title: 'Complete in years',
                            url: '<?php echo base_url()?>index.php/organization/grade/edit',
                        ...
                        $('.complete_in_years a').on('shown', function(e, editable) {
                            $(this).data('editable').input.$input.mask('99');
                        });
                    }
                });
            ...
            **************************************/
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 0 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'organization/section') {?>
            if ($('#sections_existing').length) {
                var oTable = $('#sections_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
            ...
            <?php } else if($this->data['can_user_view'] == 1 && ($this->data['can_user_edit'] == 1 || $this->data['can_user_delete'] == 1) && $this->uri->uri_string() == 'organization/section') { ?>
            if ($('#sections_existing').length) {
                var oTable = $('#sections_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {                                                
                        ...
                        $('.sorting_1 a').editable({
                            ...
                            name: 'name',
                            title: 'Section Name',
                            url: '<?php echo base_url()?>index.php/organization/section/edit',
            ...
            /**************************************
            ** All Existing departments in branch
            **************************************/
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 0 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'organization/linkdepartment') {?>
            if ($('#departments_in_branch_existing').length) {
                var oTable = $('#departments_in_branch_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
            ...
            /**************************************
            ** All Existing Grades in Wings in Branch
            **************************************/
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 0 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'organization/linkgrade') {?>
            if ($('#grades_in_branch_existing').length) {
                var oTable = $('#grades_in_branch_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
            ...
            /**************************************
            ** All Existing wings in branch
            **************************************/
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 0 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'organization/linkwing') {?>
            if ($('#wings_in_branch_existing').length) {
                var oTable = $('#wings_in_branch_existing').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
        ...
        <?php if($this->uri->uri_string() == 'hcm/applicant_form') { ?>
        //HCM Applicant Form Validation
        if ($('#hcm_new_applicant_form').length) {
            $("#hcm_new_applicant_form").validate({
                ...
                messages: {
                    ...
                    hcm_all_position_tags: {
                        required: 'Please select atleast one position'
                    }
                },
        ...
        if ($('#hcm_exists_applicant_form').length) {
            $("#hcm_exists_applicant_form").validate({
                // Rules for form validation
                rules: {                    
                    exists_applicant_form_action: {
                        required: true
                    }
                },
                ...
                messages: {
                    exists_applicant_form_action: {
                        required: 'Please select form action'
                    }
                },
        ...
        <?php if($this->uri->uri_string() == 'organization/org') { ?>
        //organization detail Form Validation
        if ($('#organization_detail_form').length) {
            $("#organization_detail_form").validate({
                // Rules for form validation
                rules: {                    
                    org_name: {
                        required: true
                    ...
                    org_currency_no_of_decimal_places: {
                        required: true,
                        range: [0, 3]
                    }                    
                },
        ...
        <?php if($this->uri->uri_string() == 'organization/linkdepartment') { ?>
        //organization detail Form Validation
        if ($('#link_branch_dept_form').length) {
            $("#link_branch_dept_form").validate({
                // Rules for form validation
                rules: {                    
                    department: {
                        required: true
        ...
        <?php if($this->uri->uri_string() == 'organization/branch_users') { ?>
        //organization detail Form Validation
        if ($('#branch_users_form').length) {
            $("#branch_users_form").validate({
                // Rules for form validation
                rules: {                    
                    branch: {
                        required: true
        ...
        <?php if($this->uri->uri_string() == 'admin/users') { ?>
        //organization detail Form Validation
        ...
        <?php if($this->uri->uri_string() == 'organization/linkgrade') { ?>
        //organization detail Form Validation
        if ($('#wing_grades_form').length) {
            $("#wing_grades_form").validate({
                // Rules for form validation
                rules: {                    
                    wing: {
                        required: true
...
<script type="text/javascript">
    ...
    $(document).on('click','.grade_section',function(){
        var academic_id = $(this).attr('data-academic');
        var academic = parseInt(academic_id);

        var grade = $(this).attr('data-grade');
        var section = $(this).attr('data-section');

        var grade_name = $(this).attr('data-gradename');
        var section_name = $(this).attr('data-sectionname');

        var row = $('#report_selection tr').closest("tr");    // Find the selected report row
        var selected_report = row.find(".highlighted2").text(); // Find the selected report text


        if(selected_report == ''){selected_report='Term-1 Unit Report'}


        if($('.table td').hasClass('highlighted')){
        ...
        if(grade!=''){
            if(selected_report == '(2016-17) Term-1 Unit Report'){
                $('#option_definition').html('');
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/formative_unit_report_ajax/get_unit_Report_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, session_year:"1617"},
                    success:function(e){
                        $('#setup_2').html(e);
                    }
                });
                ...
                $.ajax({
                    type: "POST",
                    url:"<?php echo base_url(); ?>index.php/etab_reports/formative_unit_report_ajax/generate_unit_report_html",
                    data: {grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, session_year:"1617"},
                ...
                $('#programme_report').hide();     
            }else if(selected_report == '(2016-17) Term-1 Report'){
                $('#setup_2').show();
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/formative_unit_report_ajax/get_UnitAssessment_n_Review_Report_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:1, session_year:"1617"},
                    success:function(e){
                        $('#setup_2').html(e);
                    }
                });
                ...
                if(parseInt(grade)>=13){
                    ...
                    $.ajax({
                        type:"POST",
                        cache:false,
                        url:"<?php echo base_url(); ?>index.php/etab_reports/Formative_unit_report_split_ajax/get_UnitAssessment_n_Review_Report_split_pdf",
                        data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:1, session_year:"1617"},
                        success:function(e){
                            $('#setup_3').html(e);
                        }
                ...
                $('#programme_report').html('');
                $('#option_definition').hide();
                $('#get_formative_report_term2').html('');
                $('#unit_report_term2').html('');
                
            }else if(selected_report == 'Programme Report'){
                $('#programme_report').show();
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/programme_report_ajax/get_programme",
                    data:{grade_id:grade,academic_id:academic,grade_name:grade_name},
                    success:function(e){
                        $('#programme_report').html(e);
                    }
                ...
                $('#get_formative_report_term2').html('');
                $('#unit_report_term2').html('');
            }else if(selected_report == '(2016-17) Term-1 Formative Report'){
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/formative_unit_report_ajax/get_term_formative_report_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:1, session_year:"1617"},
                    success:function(e){
                        $('#setup_2').html(e);
                    }
            ...
            }else if(selected_report == 'Option Definition Report'){
                $('#option_definition').show();
                $('#get_formative_report_term2').html('');
                $('#unit_report_term2').html('');
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/option_defination_ajax/get_option_defination_report",
                    data:{grade_id:grade,academic_id:academic,grade_name:grade_name},
                    success:function(e){
                        $('#option_definition').html(e);
                    }
                });
            ...
            else if(selected_report == 'Library Formates'){
                ...
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url() ?>index.php/etab_reports/library_formates_ajax/get_library_formates",
                    data:{grade_id:grade,section_id:section,academic_id:academic,grade_name:grade_name,section_name:section_name},
                    success:function(data){
                        $('#option_definition').html(data);
                    }
                })
            }
            else if(selected_report == '(2016-17) Term-2 Unit Report'){
                ...
                $.ajax({
                    type:"POST",
                    cache:false,
                     url:"<?php echo base_url(); ?>index.php/etab_reports/formative_unit_report_ajax/get_unit_Report_term2_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, session_year:"1617"},
                    success:function(e){

                        $('#unit_report_term2').html(e);
                    }
                })
            }
            else if(selected_report == '(2017-18) Term-1 Reading Assessment Report'){
                ...
                $.ajax({
                    type:"POST",
                    cache:false,
                     url:"<?php echo base_url(); ?>index.php/etab_reports/formative_unit_report_ajax/get_reading_assessment_report",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, session_year:"1718"},
                    success:function(e){
            ...
            else if(selected_report == '(2016-17) Term-2 Formative Report'){

                 $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/formative_unit_report_ajax/get_term_formative_report_term2_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:2, session_year:"1617"},
                    success:function(e){
                        $('#get_formative_report_term2').html(e);
                    }
                });
                $('#unit_report_term2').html('');
                $('#setup_2').html('');
            ...
            else if(selected_report == '(2016-17) Term-2 Report'){
            ...
            else if(selected_report == '(2016-17) Overall Report'){
                    $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/overall_term_report_ajax/get_overall_term_report_combine_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:2, session_year:"1617"},
                    success:function(e){
                        $('#setup_2').html(e);
                        $('#setup_3').html('');
            ...
            else if(selected_report == '(2016-17) Overall Report - Split'){
                    $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/overall_term_report_split_ajax/get_overall_term_report_combine_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:2, session_year:"1617"},
                    success:function(e){
                        $('#setup_2').html('');
                        $('#setup_3').html(e);
            ...
            else if(selected_report == '(2016-17) Overall Report - Science'){
                    $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/overall_term_report_science_ajax/get_overall_term_report_combine_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:2, session_year:"1617"},
                    success:function(e){
                        $('#setup_2').html('');
                        $('#setup_3').html(e);
            ...
            /******************************************************/
            /***** ***** ***** 2017 - 18 (Term-1) ***** ***** *****/
            else if(selected_report == '(2017-18) Term-1 Unit Report'){
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/formative_unit_report_ajax/get_unit_Report_pdf",
            ...
            else if(selected_report == '(2017-18) Term-1 Formative Report'){
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/formative_unit_report_ajax/get_term_formative_report_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:1, session_year:"1718"},
                    success:function(e){
                        $('#setup_2').html(e);
                    }
                });
            ...
            }else if(selected_report == '(2017-18) Term-1 Report'){
                $('#setup_2').show();
                $.ajax({
                    type:"POST",
                    cache:false,
            ...
            else if(selected_report == '(2017-18) Term-2 Unit Report'){
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/unit_report_ajax/get_unit_Report_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name},
                    success:function(e){
                        $('#setup_2').html(e);
                    }
                });
            ...
            else if(selected_report == '(2017-18) Term-2 Junior Unit Report'){
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url() ?>index.php/etab_reports/junior_unit_report_ajax/get_junior_report",
                    data:{grade:grade,section:section,academic:academic,grade_name:grade_name,section_name:section_name},
                    success:function(e){
                        $('#setup_2').html(e);
                    }
            ...
            else if(selected_report == '(2017-18) Term-2 Formative Report'){

                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/unit_report_ajax/get_term_formative_report_term1_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:2},
                    success:function(e){
                        //$('#get_formative_report_term2').html(e);
                        $('#setup_2').html(e);
                    }
            ...
            }else if(selected_report == '(2017-18) Term-2 Report'){

            $('#setup_2').show();
                $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/unit_report_ajax/get_UnitAssessment_n_Review_Report_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:2},
                    success:function(e){
                        $('#setup_2').html(e);
                    }
                ...
                if(parseInt(grade)>=13){
                    ...
                    $.ajax({
                        type:"POST",
                        cache:false,
                        url:"<?php echo base_url(); ?>index.php/etab_reports/unit_report_ajax/get_UnitAssessment_n_Review_Report_split_pdf",
                        data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:2},
                        success:function(e){
                            $('#setup_3').html(e);
                        }
            ...
            }else if(selected_report == '(2017-18) Overall Report'){
                    $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/overall_term_report_ajax/get_overall_term_report_combine_pdf",
                    data:{grade:grade,section:section,academic:academic, grade_name:grade_name, section_name:section_name, term:2, session_year:"1718"},
                    success:function(e){
                        $('#setup_2').html(e);
                        $('#setup_3').html('');
                    }
            ...
            else if(selected_report == '(2017-18) Overall Report - Split'){
                    $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/overall_term_report_split_ajax/get_overall_term_report_combine_pdf",
            ...
            else if(selected_report == '(2017-18) Overall Report - Science'){
                    $.ajax({
                    type:"POST",
                    cache:false,
                    url:"<?php echo base_url(); ?>index.php/etab_reports/overall_term_report_science_ajax/get_overall_term_report_combine_pdf",
    ...
    $(document).on('click','.report_selection',function(){
        if($('.table td').hasClass('highlighted2')){
            $('.table td').removeClass('highlighted2');
        }
