...
<div class="FormNoShow">
	...
	<div class="col-md-9">
	<input type="text" name="form_no" id="form_no" disabled value="<?php echo $data_id["Form_no"]?>" />
...
<div class="col-md-12 paddingBottom10" id="previousData" style="display:<?=$pD;?>">
                      ...
                      <div class="col-md-6">
                              ...
                              <?php $numbers = explode(",",$data_id["Student_mobile"]); 
                              	...
                              	<div class="input_fields_wrap" style="margin-bottom: 14px;">
                                        ...
                                        <input name="student_mobile_phone[]" type="text" class="col-md-10 student_mobile_phone" placeholder="Mobile" id="student_mobile" value="<?php echo $otherNumber[1]; ?>" style="padding-left:60px;"> 
...
<div class="col-md-12 paddingBottom10">
             ...
             <div class="col-md-6 state-success">
                    ...
                    <div class="col-md-12 paddingBottom10">
                        <div class="col-md-6">                            
                              <input type="text" class="" value="<?=$data_id["referal_code"];?>" placeholder="Referral Code" name="Referal_code" id="Referal_code" maxlength="6" minlength="6"  />
                      </div>
                    </div>  
			...
			<?php  if (!empty($data_id["Father_mobile"])) {
			 ...
			 ?>
			 	...
			 	<div class="input_fields_wrap_father" style="margin-bottom: 14px;">
                    ...
                    <input required="" name="father_mobile_phone[]" type="text" class="col-md-10 father_mobile_phone" placeholder="Mobile" id="father_mobile" value="<?php echo $data_id["Father_mobile"]; ?>" style="padding-left:60px;"> 
		...
		<?php } if (!empty($data_id["Father_mobile_other"]) ) { 
			...
			for($i=0; $i< count($data_id["Father_mobile_other"]); $i++){  
				...
				<div class="input_fields_wrap_additional_father" style="margin-bottom: 14px;">
                    ...
                    <input required="" name="father_mobile_phone[]" type="text" class="col-md-10 father_mobile_phone" placeholder="Mobile" id="father_mobile" value="<?php echo $otherNumber[1]; ?>" style="padding-left:60px;"> 
...
<div class="col-md-6">
	...
	<?php  if (!empty($data_id["Mother_mobile"])) {
	 ...
	 <div class="input_fields_wrap_mother" style="margin-bottom: 14px;">
                ...
                <input required="" name="mother_mobile_phone[]" type="text" class="col-md-10 mother_mobile_phone" placeholder="Mobile" id="father_mobile" value="<?php echo $data_id["Mother_mobile"]; ?>" style="padding-left:60px;"> 
		...
		for($i=0; $i< count($data_id["Mother_mobile_other"]); $i++){ 
		 ...
		 ?>
				<div class="input_fields_wrap_additional_mother" style="margin-bottom: 14px;">
                    ...
                    <input required="" name="mother_mobile_phone[]" type="text" class="col-md-10 mother_mobile_phone" placeholder="Mobile" id="mother_mobile" value="<?php echo $otherNumber[1]; ?>" style="padding-left:60px;"> 
...
<hr />
<div class="col-md-12">
	<div class="col-md-12 paddingBottom0" style="margin-top: -10px;">
...
<hr />
                            ...
                            <div class="col-md-12">
                                <div class="alevelBox " style="display: none;">
                                    <div class="col-md-12 paddingBottom0 " style="margin-top: -10px;" >
                                        <div class="col-md-12">
                                            <input <?php if( $data_id["Alevel_supplement"] == 1){ echo "checked"; }?>  type="checkbox" id="alevel_supplement" name="alevel_supplement" style="visibility:hidden;display:block;"> 
                                            <label for="alevel_supplement">Duly filled Admission Application Form and A-Level Supplement</label>
                                        </div>
                                    </div>                                  
                                    <!-- <div class="col-md-12 paddingBottom0">
                                    ...
                                    <!-- col-md-12 -->    
                                    <div class="col-md-12 paddingBottom0 div_APCOSR" style="margin-top: -10px;">
                                    ...
                                    <!-- col-md-12 -->
                                    <div class="col-md-12 paddingBottom0 div_PRFSSE" style="margin-top: -10px;">
                                    ...
                                    <!-- col-md-12 -->    
                                     <div class="col-md-12 paddingBottom0 div_ACCIEX" style="margin-top: -10px;">
                                        <input class="acciex" type="checkbox" value="ACCIEX"  id="ACCIEX" name="alevelCheckList[]" style="display:block;visibility:hidden;"> <label for="ACCIEX">Attested copy of CAIE Olevel Statement of Results  (grade X only)</label>
                                    </div>                                    
                                    <!-- col-md-12 -->    
                                     <div class="col-md-12 paddingBottom0" style="margin-top: -10px;">
                                        <input type="checkbox" value="ACCIE" class="accie" id="ACCIE" name="alevelCheckList[]" style="display:block;visibility:hidden;"> <label for="ACCIE">Attested copy of CAIE Olevel Statement of Results</label>
                                    </div>
                                    <!-- col-md-12 -->    
                                    <!-- <div class="col-md-12 paddingBottom0">
