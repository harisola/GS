                            ...
                            <div class="col-md-12 paddingBottom20">
                                <div class="col-md-6">
                                    ...
                                    <div class="input_fields_wrap_father" style="margin-bottom: 14px;">
                                        ...
                                        <input required="" name="father_mobile_phone[]" type="text" class="col-md-10" placeholder="Mobile" id="father_mobile" value="" style="padding-left:60px;" /> 
            ...
            <div id="MaroonBorderBox2">
                ...
                <?php //var_dump( $formlist ); ?>
                    ...
                    <?php if( !empty( $formlist ) ){
                      ...
                      if( ( (int)substr($value, 0, 2) == 18 ) || ( (int)substr($value, 0, 2) == 17 ) ){
