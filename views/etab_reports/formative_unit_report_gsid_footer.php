...
$(document).ready(function(){
    ...
    $(document).on('click', '#student_log_grade_section_std tr', function (event) {
        ...
        var grade_id = $('.highlight1 .grade_section').attr('data-grade');
        var section_id = $('.highlight1 .grade_section').attr('data-section');



        $.ajax({
            type: "POST",
            url: "<?php echo site_url() . '/etab_reports/formative_unit_report_gsid_ajax/getStudentReports';?>",
            data: {
                gsid: $gsID,
