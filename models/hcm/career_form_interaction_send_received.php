<?php
class Career_form_interaction_send_received extends CI_Model{
	...
	protected $_table_name = 'form_send_received';
	protected $_primary_key = 'id';
	protected $_primary_filter = 'intval';	
	protected $_order_by = 'form_send_datetime asc';	
	...
	public function getTagsCount(){
		...
		$query = $this->db->query('SELECT id FROM interaction_tags where record_deleted = 0');
