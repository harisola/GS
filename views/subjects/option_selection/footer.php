...
swal({
  title: "Are you sure?",
  text: "Wants to change student's Optional Programme Selection",
  type: "warning",
...
*/			
	...
	/*swal("Changed!", "Student Group Changed.", "success");

  
   } else {
    selected=1;
	 swal("Cancelled", "No! Change take placed!", "error");
...
*/
	...
	<script src="<?php echo base_url()?>components/gs_theme/js/sweetalert/dist/sweetalert.js"></script>
    <link rel="stylesheet" href="<?php echo base_url()?>components/gs_theme/js/sweetalert/dist/sweetalert.css">
    <!--.......................-->
