<?php
class Staff_req_transport_model extends CI_Model{
	...
	protected $_table_name = 'staff_registered_requirements_transport';
	...
	public function exists_staff_req_transport($StaffID){
		$result = false;
