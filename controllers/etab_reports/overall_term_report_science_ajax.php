...
class Overall_term_report_science_ajax extends CI_Controller{
    ...
    public function get_overall_term_report_combine_pdf(){
        ...
        $pdf_link = '/etab_reports/overall_term_report_science_ajax/overall_term_report_combine?
        gradeID=' . $gradeID .
        '&sectionID=' . $sectionID .
        '&gradeName=' . $gradeName .
    ...
    public function overall_term_report_combine(){
        ...
        /******************************** Students Data 
        /***********************************************/
        $data['students_term1'] = $this->assessment_report_model->get_complete_marks_of_Science(10, 1, $gradeID, "_".$session_year);
        /***********************************************/
