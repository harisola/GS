...
//window.location.replace("http://localhost/gs/index.php/master_calendar/master_calendar");
...
switch(appendType){
	...
	//case 'Holiday_Hijri' : appendClass='HolidayParameterSet edtHP'; break;
	...
	switch(Type){
	 ...
	 $.ajax({
		...
		success: function(res){
			...
			if( ParaType ==  'StaffP' || ParaType ==  'StaffPH' ){
...
function Update_Weekly_Time_Sheet(From_date, To_Date){
	...
	success: function(res){ console.log("Update_Weekly_Time_Sheet"); },
	complete: function (){}
	});
}
