...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // View, Edit, Delete from Table (Admission) *** only VIEW
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'assestment/category_grade' ) {?>
                
            if ($('#category-grade').length) {
                var oTable = $('#category-grade').dataTable({
                    "oLanguage": {
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        ...
                        $('.aneditable-weightage a').editable({
                            type: 'text',
                            name: 'weightage',
                            title:'Weightage Name',
                            url: '<?php echo base_url()?>index.php/assestment/category_grade/edit' ,
                        ...
                        //     name: 'date_from',
                        //     title: 'Date From',
                        //     url: '<?php echo base_url()?>index.php/assestment/academic/edit',
...
<script type="text/javascript">
    /*$(document).ready(function(){
     $('#Submit').click(function(){
        ...
        var name = $('#assest_name').val();
        var dname = $('#display').val();
        var sname = $('#assest_ncode').val();

       

$.post("http://localhost/gs/index.php/assestment/ass_term/testing",
{
                name:name,
                dname:dname,
                sname:sname
