...
fr.primary_contact AS primary_contact,
fbs.id as slot_id,fbs.form_batch_id as batch_id,
_fb.batch_category as batch_name,_fb.date as batch_date,
...
LEFT JOIN atif_gs_admission.family_registration AS fr ON (fr.gf_id = af.gf_id)
	LEFT JOIN atif_gs_admission._form_batch_slots as fbs 
	on (fbs.admission_form_id = af.id and fbs.revised_batch_slot_id = 0)
	LEFT JOIN atif_gs_admission._form_batch as _fb on
	(_fb.id = fbs.form_batch_id)";
