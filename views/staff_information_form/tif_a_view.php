...
select#soflow, select#soflow-color {
   ...
   background-image: url(../../Components/image/15xvbd5.png), -webkit-linear-gradient(#FAFAFA, #F4F4F4 40%, #E5E5E5);
...
.secondLevelReporting h5,
.firstLevelReporting h5 {
    font-weight: bold;
}
...
<link rel="stylesheet" media="screen" href="/application/views/staff_information_form/style/stylex.css" />
<link rel="stylesheet" media="screen" href="/application/views/staff_information_form/style/StaffList.css" />


<script src="/application/views/staff_information_form/js/jquery.min.js"></script>
<script src="/application/views/staff_information_form/js/multiSelect.js"></script>
<style>
                          ...
                          <tbody id="staff_listing_body">
                            <?php
                              ...
                              <tr id="row-<?php echo $data['gt_id']; ?>">
                                ...
                                <td class="data-gt_id"><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="GT-ID: <?php echo $data['gt_id']; ?>" data-pin-nopin="true" class="anchorCol"><?php echo $data['abridged_name']; ?></a><br /><small><?php echo $data['c_topline']; ?></small></td>
