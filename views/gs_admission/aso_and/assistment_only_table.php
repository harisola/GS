...
<script>$(document).ready(function() {
        ...
        <?php foreach($batch_aso_and as $aso_and_process){ ?>
          ...
          <div class="text-center">
              ...
              <?php if($aso_and_process->flag_ast_reminder == 0){ ?>
                <img src="'.base_url("components/gs_theme/images/ReminderIcon.png") ?>" title="" width="20" data-toggle="tooltip" data-placement="top" data-original-title="Reminder" data-pin-nopin="true"> &nbs;
              <?php  }else{ ?>
                <img src="'.base_url("components/gs_theme/images/ReminderIcon_active.png") ?>" title="" width="20" data-toggle="tooltip" data-placement="top" data-original-title="Reminder" data-pin-nopin="true"> &nbsp;
             <?php } ?>
          ...
          <?php } ?>
           ...
           <div class="text-center no-padding">
              ...
              <?php if($aso_and_process->flag_ast_result == 0){ ?>
                <img src="'.base_url("components/gs_theme/images/result.png") ?>" title="" width="20" data-toggle="tooltip" data-placement="top" data-original-title="Result" data-pin-nopin="true"> &nbsp; 
           <?php  }else{ ?>
         ...
         <?php } ?>
          ...
          <?php if($aso_and_process->form_discussion_decision == ''){ ?>
            <div class="col-md-12 text-right">-</div>
          <?php }else{  ?>
            <div class="col-md-12 text-right"><?= $aso_and_process->form_discussion_decision ?></div>
          <?php  } ?>
            <div class="text-center no-padding">
            <hr class="lowMargin" />
