...
<script type="text/javascript">
	...
	$(document).on('change','#grade',function(e){
		...
		$.ajax({
			...
			url:"<?php echo base_url(); ?>index.php/gs_admission/admission_aso_and_process_view/get_batch",
			success:function(e){
				var a='';
		...
		$.ajax({
			...
			cache:false,
			data:{grade_id:grade_id},
			url:"<?php echo base_url(); ?>index.php/gs_admission/admission_aso_and_process_view/count_form_in_grade",
			success:function(e){
		...
		$.ajax({
 		...
 		cache:false,
 		data:{grade_id:grade_id},
 		url:"<?php echo base_url(); ?>index.php/gs_admission/admission_aso_and_process_view/get_all_applicant",
 		success:function(e){
	...
	$(document).on('change','#batch',function(){
		...
		$.ajax({
			...
			url:"<?php echo base_url(); ?>index.php/gs_admission/admission_aso_and_process_view/get_batch_form_submitted",
			success:function(e){
		...
		$.ajax({
			...
			url:"<?php echo base_url(); ?>index.php/gs_admission/admission_aso_and_process_view/get_detail_aso_and",
			success:function(e){
				 $('#aso_and_data').html(e);
	...
	$(document).on('click','#mark_present',function(){
		...
		$.ajax({
			...
			url:"<?php echo base_url(); ?>index.php/gs_admission/admission_aso_and_process_view/get_and_present",
			success:function(e){

				if(e == 'Status Update Successfully'){
					...
					// AND CASE PRESENCE
					$('#img_presence_'+form_no).prop('src','<?php echo base_url() ?>components/gs_theme/images/PresenceIcon_active.png');
					...
					$.ajax({
						...
						cache:false,
						data:{form_no:form_no},
						url:"<?php echo base_url(); ?>index.php/gs_admission/admission_aso_and_process_view/get_and_present_detail",
	...
	$(document).on('click','#mark_present_aso',function(){
		...
		$.ajax({
			...
			cache:false,
			data:{form_no:form_no},
			url:"<?php echo base_url(); ?>index.php/gs_admission/admission_aso_and_process_view/present_aso",
			success:function(e){
	...
	$(document).on('click','#view_and_edit',function(){
		...
		$.ajax({
			...
			url:"<?php echo base_url() ?>index.php/gs_admission/admission_aso_and_process_view/get_view_and_edit_modal",
			success:function(e){
...
$(document).on('click','#selectAll',function() {
	...
	$(document).on('click','#status_update',function(){
        ...
        $.ajax({
        	...
        	url:"<?php echo base_url(); ?>index.php/gs_admission/admission_aso_and_process_view/update_action",
        	success:function(f){
        		...
        		for(var i=0; i<obj.length; i++){
        			...
        			// Regert
        			if(obj[i][0].form_status_stage_id == 6){
        				$('#offer_'+obj[i][0].id).text('Regert');
        			}

        			// On Hold
        			if(obj[i][0].form_status_stage_id == 8){
        				$('#offer_'+obj[i][0].id).text('On Hold');
        			}

        			// WaitList
        			if(obj[i][0].form_status_stage_id == 9){
 ...
 // ======================================================================//
 	...
 	$(document).on('click','#applicant_status',function(){
 		...
 		$.ajax({
 			...
 			url:"<?php echo base_url(); ?>index.php/gs_admission/admission_aso_and_process_view/filter_applicant",
 			success:function(e){
