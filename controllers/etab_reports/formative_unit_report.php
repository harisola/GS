...
class Formative_unit_report extends MY_Controller{
	...
	public function index(){
		...
		$this->load->view('etab_reports/formative_unit_report_view');
		$this->load->view('etab_reports/formative_unit_report_footer');
	}
