        ...
        <!-- <div class="ColVis"><button class="ColVis_Button ColVis_MasterButton"><span>Show / hide columns</span></button></div> -->
          ...
          <table class="display table table-striped table-hover dataTable" id="attendance_staff_today_table" aria-describedby="class_list_info">
            ...
            <thead>
              <tr role="row">
                ...
                <th class="sorting centered-cell" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Campus: activate to sort column ascending" style="width: 5px;">Campus</th>
                <th class="sorting centered-cell" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Staff Type: activate to sort column ascending" style="width: 5px;">Staff Type</th>
              </tr>
            </thead>
            ...
            <tfoot>
              <tr>
                ...
                <th rowspan="1" colspan="1"><input type="text" name="filter_Gender" placeholder="Filter Campus" class="search_init"></th>
                <th rowspan="1" colspan="1"><input type="text" name="filter_Gender" placeholder="Filter Staff Type" class="search_init"></th>
              </tr>
            </tfoot>
          ...
          ?>
            <tr class="<?php echo $class_odd_even; ?>">
              ...
              <td class=" centered-cell"><?php echo $staff->name; ?></td>
              ...
              <?php if (empty($staff->time)) { ?>
                <td class=" centered-cell">Absent</td>
              <?php } else { ?>
                <td class=" centered-cell"><?php echo $staff->time; ?></td>
              <?php } ?>


              <td class=" centered-cell"><?php echo $staff->branch_name; ?></td>
              <td class=" centered-cell"><?php echo $staff->staff_type; ?></td>
            </tr>
          <?php } ?>
          </tbody>
        </table>
