...
$ad_full_assessmentNotInterested_query = "(lgs.new_form_stage = 7) and  (lgs.new_form_status = 2) 
        and af.form_status_id=2 and af.form_status_stage_id=7 group by af.id";
            }
            ...
            if($dd['form_status_id']==6622 && $dd['form_status_stage_id']==6622)
                ...
                $ad_full_discussionNotInterested_query = "( ( af.form_status_id=3 or  af.form_status_id=4) and (  af.form_status_stage_id = 7  ) ) group by af.id
                ";
                        }
