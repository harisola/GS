...
class View_online_form extends MY_Controller {
	...
	public function index()
	{
		...
		if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0){
			...
			$this->online['applicant_data'] = array($this->career_form_model->get());
			// Loading applicant data --> From View
			$this->load->view('hcm/career/career_view_forms');
		}
	...
	public function printForm2()
	{
		if(count($_POST))
		{
			$this->getPDF2Now($this->input->post('career_id'));
		}
	}


	public function getPDF2Now($career_id)
	{
		...
		// get the page count
		$pageCount = $pdf->setSourceFile('components/pdf/hcm/HRApplicantForm22.pdf');
	...
	public function getPDFNow($career_id)
	{
		...
		$online['applicant_form_uni'] = array($this->career_form_uni_model->get_by(array('career_id =' => $career_id)));
		$online['applicant_form_emp'] = array($this->career_form_emp_model->get_by(array('career_id =' => $career_id)));
		$online['applicant_pro_q'] = array($this->career_form_proq_model->get_by(array('career_id =' => $career_id)));		
		...
		$formTime = $datetime[1];
		$DOB = '';
		if($online['applicant_form'][0][0]->dob != null && $online['applicant_form'][0][0]->dob != '0000-00-00'){
