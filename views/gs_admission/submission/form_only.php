                      ...
                      <div class="col-md-6">
                              ...
                              <?php $numbers = explode(",",$data_id["Student_mobile"]); 
                              	...
                              	<div class="input_fields_wrap" style="margin-bottom: 14px;">
                                        ...
                                        <input name="student_mobile_phone[]" type="number" class="col-md-10" placeholder="Mobile" id="student_mobile" value="<?php echo $otherNumber[1]; ?>" style="padding-left:60px;"> 
			...
			<?php  if (!empty($data_id["Father_mobile"])) {
			 ...
			 ?>
			 	...
			 	<div class="input_fields_wrap_father" style="margin-bottom: 14px;">
                    ...
                    <input required="" name="father_mobile_phone[]" type="number" class="col-md-10" placeholder="Mobile" id="father_mobile" value="<?php echo $data_id["Father_mobile"]; ?>" style="padding-left:60px;"> 
		...
		<?php } if (!empty($data_id["Father_mobile_other"]) ) { 
			...
			for($i=0; $i< count($data_id["Father_mobile_other"]); $i++){  
				...
				<div class="input_fields_wrap_additional_father" style="margin-bottom: 14px;">
                    ...
                    <input required="" name="father_mobile_phone[]" type="number" class="col-md-10" placeholder="Mobile" id="father_mobile" value="<?php echo $otherNumber[1]; ?>" style="padding-left:60px;"> 
...
<div class="col-md-6">
	...
	<?php  if (!empty($data_id["Mother_mobile"])) {
	 ...
	 <div class="input_fields_wrap_mother" style="margin-bottom: 14px;">
                ...
                <input required="" name="mother_mobile_phone[]" type="number" class="col-md-10" placeholder="Mobile" id="father_mobile" value="<?php echo $data_id["Mother_mobile"]; ?>" style="padding-left:60px;"> 
		...
		for($i=0; $i< count($data_id["Mother_mobile_other"]); $i++){ 
		 ...
		 ?>
				<div class="input_fields_wrap_additional_mother" style="margin-bottom: 14px;">
                    ...
                    <input required="" name="mother_mobile_phone[]" type="number" class="col-md-10 " placeholder="Mobile" id="mother_mobile" value="<?php echo $otherNumber[1]; ?>" style="padding-left:60px;"> 
