    ...
    <div class="powerwidget <?php echo $online_applicant_color_view; ?> powerwidget-sortable" id="datatable-filter-column" data-widget-editbutton="false" role="widget" style="">
      ...
      <div class="inner-spacer" role="content">
        ...
        <!-- <div class="ColVis"><button class="ColVis_Button ColVis_MasterButton"><span>Show / hide columns</span></button></div> -->
          ...
          <table class="display table table-striped table-hover dataTable" id="online_applicant_forms_stage1_shortlista_table" aria-describedby="class_list_info">
            ...
            <thead>
              <tr role="row">
                ...
                <th class="sorting centered-cell" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="AppliedFor: activate to sort column ascending" style="width: 10px;">Applied For</th>                
            ...
            <tfoot>
              <tr>
                ...
                <th rowspan="1" colspan="1"><input type="text" name="filter_view" placeholder="Filter Applied For" class="search_init"></th>                
          ...
          ?>
            <tr class="<?php echo $class_odd_even; ?>">
               ...
               <?php if ($applicant_data->shortlist_a_comments == "") { ?>
                  <td class=" centered-cell aneditable_shortlist_a_comments"><a href="#" data-type="textarea" data-name="shortlist_a_comments" data-pk="<?php echo $applicant_data->id; ?>" data-placement="top">.....</a></td>
               <?php } else {?>
                  <td class=" centered-cell aneditable_shortlist_a_comments"><a href="#" data-type="textarea" data-name="shortlist_a_comments" data-pk="<?php echo $applicant_data->id; ?>" data-placement="top"><?php echo $applicant_data->shortlist_a_comments; ?></a></td>
               <?php } ?>
               <?php if ($applicant_data->shortlist_a == 1) { ?>
                  <td class=" centered-cell aneditable_shortlist_a"><a href="#" data-type="select" data-name="shortlist_a" data-pk="<?php echo $applicant_data->id; ?>" data-placement="top">Call Now</a></td>
               <?php } else if ($applicant_data->shortlist_a == 0) { ?>
                  <td class=" centered-cell aneditable_shortlist_a"><a href="#" data-type="select" data-name="shortlist_a" data-pk="<?php echo $applicant_data->id; ?>" data-placement="top">.....</a></td>
               <?php } else if ($applicant_data->shortlist_a == 2) { ?>
                  <td class=" centered-cell aneditable_shortlist_a"><a href="#" data-type="select" data-name="shortlist_a" data-pk="<?php echo $applicant_data->id; ?>" data-placement="top">Archive</a></td>
                <?php } else if ($applicant_data->shortlist_a == 3) { ?>
                  <td class=" centered-cell aneditable_shortlist_a"><a href="#" data-type="select" data-name="shortlist_a" data-pk="<?php echo $applicant_data->id; ?>" data-placement="top">For evaluation: 1 Week</a></td>
               <?php }else { ?>
                  <td class=" centered-cell aneditable_shortlist_a"><a href="#" data-type="select" data-name="shortlist_a" data-pk="<?php echo $applicant_data->id; ?>" data-placement="top">For evaluation: 3 Weeks</a></td>
               <?php } ?>
