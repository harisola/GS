...
class Admission_aso_and_process_presence extends CI_Controller{
	...
	public function index(){
		...
		if($this->ion_auth->logged_in() == FALSE){
			...
			$this->load->view('gs_admission/aso_and/aso_and_process_presence',$data);
			$this->load->view('gs_admission/aso_and/aso_and_presence_footer');
		}
	}
	...
	public function result_decision_insert(){
		...
		// if(!empty($affected_rows)){
			...
			$reason = $assessment_result_decision." by ". $teacher_name;
			}
			else{
				$reason = "Result by ".$teacher_name;
			}
	...
	public function get_detail_aso_and(){
		...
		$html .= '<td class="text-center"><small><a href="javascript:void(0)" id="mark_present" data-presesnt="'.$aso_and_process->form_id.'">Mark as Present</a></small></td>';
		$html .= '</tr>';
		}
		} //End BAtch
       ...
       if($aso_and_process->flag_ast_presence == 0){
		...
		$html .= '<td class="text-center"><small><a href="javascript:void(0)" id="mark_present_aso" data-presesnt="'.$aso_and_process->form_id.'">Mark as Present</a></small></td>';
		$html .= '</tr>';
	...
	public function get_A_level(){
        ...
        $html .='<tr>';
        //$html .='<th class="no-sort" width="2%"><input type="checkbox" id="selectAll" class="normal" /></th>'; 
       // $html .= '<th width="" class="text-center"></th>';
        $html .='<th width="" class="text-center">Form #</th>'; 
        $html .='<th width="" class="no-sort">Applicant Name<br /><small>Father Name</small></th>';
        $html .='<th width="" class="text-center no-sort">DIS Appointment<br /><div class="col-md-6 no-padding"><small>DIS Done on</small></div><div class="col-md-6 no-padding text-right"><small>DIS by</small></div></th>';
        $html .='<th width="" class="text-left no-sort">DIS Result<br /><div class="col-md-12 no-padding text-right">DIS Decision</div></th>';
		...
		$html .= '<td><a href="javascript:void(0)" id="mark_present" data-presesnt="'.$aso_and_process->form_id.'">Mark as Present</a></small></td>';
