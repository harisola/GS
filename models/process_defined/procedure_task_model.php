<?php
class Procedure_task_model extends CI_Model{
	...
	protected $_table_name = 'procedure_task';
	...
	public function getAllTasksOf($ProcedureID){
		$query=$this->db->query('select 
							t.id as task_id,
							t.name as task_name, t.description as task_description, t.limit_hours as hours_limit,
							pt.id as procedure_task_id, pt.task_order


							from atif_process.task t
							left join atif_process.procedure_task pt on pt.task_id=t.id


							where pt.procedure_id = '.$ProcedureID.'
							and t.record_deleted=0
							and pt.record_deleted=0');
