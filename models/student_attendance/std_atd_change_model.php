<?php
class Std_atd_change_model extends CI_Model{
	...
	protected $_table_name = 'attendance_status_changed';
	...
	public function getStudentAttendance($GSID)
	{
		$cQuery = "SELECT * FROM student_attendance
				where date = curdate() and gs_id = '" . $GSID . "' order by time desc limit 1";
