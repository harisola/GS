    ...
    $EOA_NI_FB_Query = "";
        ...
        foreach ($this->data['full'] as $dd) {
            ...
            if($dd['form_status_id']==9988 && $dd['form_status_stage_id']==9988){
                ...
                $ad_full_issuanceExtentionCurrent_query = "(af.form_status_id=1) and ( af.form_status_stage_id <= 3 ) and (af.form_submission_date >= curdate()) group by af.id";
            }
            ...
            if($dd['form_status_id']==7799 && $dd['form_status_stage_id']==7799){
                ...
                $ad_full_submissionTBI_Current = $dd['num'];
                                $ad_full_submmisionTBI_Current_query = "(af.form_status_id=2 and af.form_assessment_date = '2001-01-01') group by af.id";
            }
            ...
            if($dd['form_status_id']==7777 && $dd['form_status_stage_id']==7777){
                ...
                /*$ad_full_assessmentCurrent_query = "(af.form_dd = '0000-00-00' and af.form_assessment_date != '0000-00-00' and af.form_assessment_date != '2001-01-01' and af.form_status_stage_id != 7
                    and af.form_status_stage_id != 15 and af.form_assessment_date > CURDATE())"; */
                                ...
                                $ad_full_assessmentCurrent_query = "af.form_status_id=2 and (af.form_assessment_date > curdate()) group by af.id";
...
select af.id as Form_id
            ...
            if($dd['form_status_id']==5501 && $dd['form_status_stage_id']==5501)
                ...
                $ad_full_PO_RegretAPR_query = "(af.form_status_stage_id = 6) group by af.id";
            }
            ...
            if($dd['form_status_id']==4477 && $dd['form_status_stage_id']==4477)
               ...
               $ad_full_offerCurrenlty2Days  = $dd['num'];
                ...
                $ad_full_offerFollowupOver_query = "( ( af.form_status_stage_id != 7) and( af.form_status_stage_id != 10 ) and af.offer_date < curdate() )";
            }
                ...
                #$ad_full_offerExtention_query  = "(lgs.new_form_stage = 10)  and (lgs.new_form_status = 5) group by lgs.admission_form_id";
                                $ad_full_offerExtention_query  = "( (lgs.new_form_stage = 10)  and (lgs.new_form_status = 5)  and ( lgs.old_form_stage <= 3 ) ) group by lgs.admission_form_id";        
...
if($dd['form_status_id']== 3301 && $dd['form_status_stage_id']== 3301)
        {
            ...
            $ROA_Overall_Status = 9900;
            $ROA_Overall_Stage = 9900;
        ...
        if($dd['form_status_id']== 3302 && $dd['form_status_stage_id']== 3302)
        {
            ...
            $ROA_WaitingR_Status = 9900;
            $ROA_WaitingR_Stage = 9900;
            $ROA_WaitingR_Query = " ( `af`.`grade_id`=15 or `af`.`grade_id`=16) and (`af`.`form_discussion_criteria` ='RAO') and `af`.`form_status_stage_id` = 2";
        }
        ...
        if($dd['form_status_id']== 3303 && $dd['form_status_stage_id']== 3303)
        {
            ...
            $EOA_Overall_Status = 9900;
            $EOA_Overall_Stage = 9900;
            $EOA_Overall_Query = " (( `af`.`grade_id`=15 or `af`.`grade_id`=16) and (`af`.`form_discussion_criteria` ='EAO') and `af`.`form_status_stage_id` = 2)";
        }
        ...
        if ($dd['form_status_id'] == 3305 && $dd['form_status_stage_id'] == 3305)
         {
            ...
            $Move_To_EOA_Proc_Status = 9999;
            $Move_To_EOA_Proc_Stage = 9999;
            $Move_To_EOA_Proc_Query = "(
                ( `af`.`grade_id`=15 or `af`.`grade_id`=16) 
                and (`af`.`form_discussion_criteria` ='EAO') 
                and ( `afo`.`early_admission_offer_letter`=1)
                and ( `afo`.`early_admission_print_fee_bill`=1 )
 ...
 if ($dd['form_status_id'] == 3107 && $dd['form_status_stage_id'] == 3107)
 {
    ...
    $EOA_NI_FB_Query = urlencode(
        ...
        $html .= 
            ...
            <span class="totalApplicants tooltipp"><a href="#" data-toggle="modal" data-target="#myModal" data-title="Total Issuance"  id="status_stage" data-status="'.$ad_full_issuance_statusID.'" data-stage="'.$ad_full_issuance_stageID.'" data-query="">'.$ad_full_issuance.'</a><span class="tooltiptext">Form Issuance</span></span>
        </div><!-- issuanceArea -->
<!--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->        
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12 no-padding" style="width: 335px; text-align: center; position: absolute; top: 80%; left: 40%; background: rgb(241, 239, 239); border: 1px solid rgb(204, 204, 204); padding: 10px; z-index:99999;display:none" id="Generations_AjaxLoader">
   <img src="http://10.10.10.50/gs/components/image/gsLoader.gif" width="200"><br><hr style="margin: 7px 0;border-top: 1px solid #ccc;"> Please Wait...
                            ...
                            <dd>
                                <div class="mutliSelect">
                                    <ul>
                                        ...
                                        <li><input type="checkbox" value="A1" name="A1" id="A1" /><label for="A1">A1</label></li>
                                        <li><input type="checkbox" value="A2" name="A2" id="A2" /><label for="A2">A2</label></li>
    ...
    <div class="fixedWidthScroll">
        <img src="<?php echo base_url() ?>components/gs_theme/images/ProcessFlowschart_05.jpg" width="3000" />
...
$('.mutliSelect input[type="checkbox"]').on('click', function() {
  ...
  if ($(this).is(':checked')) {
    ...
    $.ajax({
        ...
        url:"<?php echo base_url(); ?>index.php/gs_admission/admission_process_flows_xp/edit2",
        success:function(e){
            $('#BiGSelectBox').html(e);
...
$(document).on("click", "#btn_apply_filters", function(){
    ...
    $.ajax({
        ...
        url:"<?php echo base_url(); ?>index.php/gs_admission/admission_process_flows_xp/edit",
        success:function(e){
...
$(document).on('click','#status_stage',function(){
    ...
    $.ajax({
        type:"POST",
        cache:false,
        data:{status_id:status, stage_id:stage, gradeID:selectedGrades, batch:selectedBatch, gender:selectedGender, query:query, Modal_Title:Modal_Title },
        url:"<?php echo base_url() ?>index.php/gs_admission/admission_process_flows_xp/modal_load",
        success:function(e){
            $('.processflow').html(e);
           $("#Generations_AjaxLoader").hide();
...
$(document).on('click','.timeline',function(){
    ...
    $.ajax({
        ...
        url:"<?php echo base_url() ?>index.php/gs_admission/admission_process_flows_xp/modal_timeline",
        success:function(e){
