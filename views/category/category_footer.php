...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // View, Edit, Delete from Table (Admission) *** only VIEW
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 &&   $this->uri->uri_string() == 'category/assessment_grade' ) {?>
...
<script type="text/javascript">
    ...
    {
        sum = 100 - total;
        a = "<p style='font-size:18px;color:#993838'> The Remaining Weightage is " +sum+ "</p>";
        $('#total').html(a);
        $('#total').fadeOut(5000);
    }
    else if(total > 100)
    {
        sum  =100;
        a="<p style='font-size:18px;color:#993838' > The total Weightage is greater than"+sum+ "</p>";
        $('#total').html(a);
        $('#total').fadeOut(5000);
    }
    else if (total == 100)
        ...
        // Rules for form validation
            rules: {
                ...
                messages:{
                    ...
                    att_weight:{
                        required:"Please Enter Attendence Weightage"
                    },
                    stat_weight:{
                        required:"Please Enter Stationary Weightage"
                    },
                    parent_weight:{
