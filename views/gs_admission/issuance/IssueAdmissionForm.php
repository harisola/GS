                            ...
                            <div class="col-md-12 paddingBottom10">
                                <div class="col-md-6">
                                    ...
                                    <div class="input_fields_wrap">
                                        <!-- <label>Mobile</label> -->
                                        <select class="countryCodeNumber" id="student_mobile_Code[]" name="student_mobile_Code[]" >
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input_fields_wrap_father" style="margin-bottom: 14px;">
                                        <select required="" class="countryCodeNumber" name="father_mobile_code[]">
                                          ...
                                          <option data-countryCode="OM" value="968">+968</option>
                                          <!-- zzk -->
                                          <option selected="selected" data-countryCode="PK" value="92">+92</option>
                                          <option data-countryCode="PW" value="680">+680</option>
                                          <option data-countryCode="PA" value="507">+507</option>
                                          <option data-countryCode="PG" value="675">+675</option>
                                          <option data-countryCode="PY" value="595">+595</option>
