...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'student_directory/student_directory_name_view') {?>
            if ($('#student_directory_table').length) {
                var oTable = $('#student_directory_table').dataTable({
                    "oLanguage": {
