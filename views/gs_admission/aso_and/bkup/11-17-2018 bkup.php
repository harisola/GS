        ...
        <?php foreach($batch_aso_and_new as $aso_and_process){ ?>
         ...
         <?php }else{ ?>
          ...
          <?php } 
            ...
            <div class="col-md-12 text-right" id="form_assessment_decision_aso_<?= $aso_and_process->form_assessment_result ?>"><?= $aso_and_process->form_id ?></div>
          <?php } ?>
   ...
   <?php } ?>
        ...
        <?php foreach($batch_aso_old as $aso_and_process){ ?>
         ...
         <?php } ?>
          ...
          <td class="text-left">
            <span id="offer_<?= $aso_and_process->form_id ?>"><?= $aso_and_process->final_decision ?></span></td>
