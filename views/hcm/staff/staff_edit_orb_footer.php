...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('.aneditable_dob a').editable({
        type: 'date',
        combodate: {
            minYear: 1900,
            maxYear: 2050,
        },
        url: '<?php echo base_url() ?>index.php/hcm/staff_edit/edit',
...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 0 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'hcm/staff_edit') {?>
            ...
            <?php } else if($this->data['can_user_view'] == 1 && ($this->data['can_user_edit'] == 1 || $this->data['can_user_delete'] == 1) && $this->uri->uri_string() == 'hcm/staff_edit') { ?>
            if ($('#staff_edit_table').length) {
                var oTable = $('#staff_edit_table').dataTable({                    
                    "oLanguage": {
                        "sSearch": "Search all columns:"
                    },
                    "sDom": 'T<"clear">lfrtip',
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.aneditable_staff_name a').editable({
                            type: 'text',
                            name: 'name',
                            title: 'Staff Name',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit',
                        ...
                        $('.aneditable_staff_status a').editable({
                            source: [                            
                                <?php foreach ($this->staff_data['staff_status'][0] as $ddd) {
                                    echo "{value: '".$ddd->id."', text: '".$ddd->name." ".$ddd->code."'},";
                                }?>
                            ],
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit',
                            validate: function(value) {
                        ...
                        $('.aneditable_abridged_name a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit',

                            validate: function(value) {
                               if($.trim(value) == '') return 'This field is required';
                               if(value.length > 18) return 'Maximum length 18 characters allowed';
                            }
                        });
                        ...
                        /*$('.aneditable_call_name a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit',

                            validate: function(value) {
                               if($.trim(value) == '') return 'This field is required';
                               if(value.length > 9) return 'Maximum length 9 characters allowed';
                               //if ($.isNumeric(value) == '') return 'Only numbers are allowed';
                            }
                        });*/

                        $('.aneditable_name_code a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit',
                        ...
                        $('.aneditable_designation a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit',
                        ...
                        $('.aneditable_department a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit',
                        ...
                        $('.aneditable_section a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit'
                        });

                        $('.aneditable_sub_section a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit'
                        });

                        $('.aneditable_category a').editable({
                            source: [
                        ...
                        $('.aneditable_is_active a').editable({
                            source: [
                                {value: 2, text: 'No'},
                                {value: 1, text: 'Yes'}
                            ],
                        ...
                        $('.aneditable_staff_title a').editable({
                            source: [
                                <?php foreach ($this->staff_data['staff_title'][0] as $StaffTitle) { ?>
                                {value: <?php echo $StaffTitle->id; ?>, text: <?php echo "'" . $StaffTitle->title . "'"; ?>},
                                <?php } ?>
                            ],
                        ...
                        $('.aneditable_is_posted a').editable({
                            source: [
                                {value: 2, text: 'No'},
                                {value: 1, text: 'Yes'}
                            ],
                        ...
                        $('.aneditable_eobi_no a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit'
                        });

                        $('.aneditable_sessi_no a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit'
                        });


                        $('.aneditable_mobile_phone a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit',
                        ...
                        $('.aneditable_landline a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit'
                        });

                        $('.aneditable_employee_id a').editable({
                            type: 'int',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit',
                        ...
                        $('.aneditable_father_name a').editable({
                            type: 'int',
                            url: '<?php echo base_url()?>index.php/hcm/staff_edit/edit',
                        ...
                        $('.aneditable_branch_id a').editable({
                            source: [
                                {value: 1, text: 'North'},
                                {value: 2, text: 'South'}
                            ],
                        ...
                        $('.aneditable_staff_type a').editable({
                            source: [
                        ...
                        $('.aneditable_nic a').on('shown', function(e, editable) {
                            $(this).data('editable').input.$input.mask('99999-9999999-9');
                        });

                        $('.aneditable_landline a').on('shown', function(e, editable) {
                            $(this).data('editable').input.$input.mask('99-99999999');
                        });

                        $('.aneditable_mobile_phone a').on('shown', function(e, editable) {
