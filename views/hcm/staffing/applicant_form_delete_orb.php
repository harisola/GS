<!-- Datatables View users -->
  ...
  <!-- <div class="col-md-12 bootstrap-grid"> -->
    <div class="powerwidget <?php echo $title_background_color_view; ?> powerwidget-sortable" id="datatable-filter-column" data-widget-editbutton="false" role="widget" style="">
      <header role="heading">
        <h2>Applicant Forms<small>Edit or Remove</small></h2>
        ...
        <div id="applicant_edit_table_wrapper" class="dataTables_wrapper form-inline" role="grid">
          ...
          <table class="display table table-striped table-hover dataTable" id="applicant_edit_table" aria-describedby="applicant_info">
            ...
            <thead>
              <tr role="row">
                ...
                <th class="sorting" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Applicant Name: activate to sort column ascending" style="width: 25px;">Form #</th>
                ...
                <th class="sorting" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Deleted Records: activate to sort column ascending" style="width: 10px;">Deleted</th>                
              </tr>
            </thead>
            ...
            <tfoot>
              <tr>                
                ...
                <th rowspan="1" colspan="1"><input type="text" name="filter_form_no" placeholder="Filter Deleted Records" class="search_init"></th>
              </tr>
            </tfoot>
          ...
          ?>
            <tr class="<?php echo $class_odd_even; ?>">              
              ...
              <td class="aneditableremove"><a href="#" data-type="select" data-name="record_deleted" data-pk="<?php echo $applicant_record->id; ?>" data-placement="left" data-title="Remove Applicant Record"><?php echo $applicant_record->record_deleted ; ?></td>
