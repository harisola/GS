        ...
        <!-- <div class="ColVis"><button class="ColVis_Button ColVis_MasterButton"><span>Show / hide columns</span></button></div> -->
          ...
          <table class="display table table-striped table-hover dataTable" id="online_applicant_forms_recommended_for_ic" aria-describedby="class_list_info">
            ...
            <thead>
              <tr role="row">
                ...
                <th class="sorting centered-cell" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="View Full Form: activate to sort column ascending" style="width: 10px;">View Full Form</th>
                ...
                <th class="sorting centered-cell" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Handedover Date: activate to sort column ascending" style="width: 20px;">Handedover</th>
              </tr>
            </thead>
            ...
            <tfoot>
              <tr>
                ...
                <th rowspan="1" colspan="1"><input type="text" name="filter_action" placeholder="Filter View Full Form" class="search_init"></th>
          ...
          ?>
            <tr class="<?php echo $class_odd_even; ?>">
               ...
               <?php }else {?>
                 <td class=" centered-cell"><?php echo $applicant_data->recommended_interaction_name; ?>
                    <a class="btn btn-success interaction_recommended_from_centre" data-toggle="modal" data-id="<?php echo $applicant_data->id;?>" href="#"><i class="fa fa-mail-forward"></i></a>
                 </td>
               <?php } ?>
               ...
               <?php }else if($applicant_data->form_location == 1) {?>
                  <td class=" centered-cell">in transit from HR to <?php echo $applicant_data->form_in_centre;?>
                    <div class="btn-group">
                      <a class="btn btn-warning interaction_form_received" data-toggle="modal" data-id="<?php echo $applicant_data->form_send_received_id;?>" href="#"><i class="fa fa-check"></i></a>
                    </div>
                  </td>
               <?php }else if($applicant_data->form_location == 2) {?>
                  <td class=" centered-cell"><?php echo $applicant_data->form_in_centre;?>
                    <div class="btn-group">
                      <a class="btn btn-danger interaction_form_send_to_hr" data-toggle="modal" data-id="<?php echo $applicant_data->id;?>" href="#"><i class="fa fa-send"></i></a>
                    </div>                                      
                  </td>
               ...
               <td class=" centered-cell">
                  <form action="<?php echo site_url()?>/hcm/interaction_centre_review/printForm" method="post" accept-charset="utf-8">
                ...
                <td class=" centered-cell"><?php if(file_exists($this->data['applicant_form_path2'] . $converted_GCID . "_1.jpg"))
                            { ?>                
                              <form action="<?php echo site_url()?>/hcm/interaction_centre_review/printForm2" method="post" accept-charset="utf-8">
               ...
               <?php if($applicant_data->modified == "") { ?>
                  <td class=" centered-cell"></td>
               <?php } else { ?>
                  <td class=" centered-cell"><?php echo unix_to_human($applicant_data->modified); ?></td>
               <?php } ?>
            </tr>
          <?php } }?>
          </tbody>
