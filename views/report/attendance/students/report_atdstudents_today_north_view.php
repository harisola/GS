        ...
        <!-- <div class="ColVis"><button class="ColVis_Button ColVis_MasterButton"><span>Show / hide columns</span></button></div> -->
          ...
          <table class="display table table-striped table-hover dataTable" id="attendance_students_today_table" aria-describedby="class_list_info">
            ...
            <thead>
              <tr role="row">
                ...
                <th class="sorting centered-cell" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="IP: activate to sort column ascending" style="width: 5px;">ip</th>
                <th class="sorting centered-cell" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Location: activate to sort column ascending" style="width: 5px;">Location</th>
              </tr>
            </thead>
            ...
            <tfoot>
              <tr>
                ...
                <th rowspan="1" colspan="1"><input type="text" name="filter_remarks" placeholder="Filter IP" class="search_init"></th>
                <th rowspan="1" colspan="1"><input type="text" name="filter_location" placeholder="Filter Location" class="search_init"></th>
              </tr>
            </tfoot>
          ...
          ?>
            <tr class="<?php echo $class_odd_even; ?>">
              ...
              <?php if (empty($student->time)) { ?>
                <td class=" centered-cell">absent</td>
              <?php } else { ?>
                <td class=" centered-cell"><?php echo $student->time; ?></td>              
              <?php } ?>

				<?php if ($student->grade_name == 'PN') { ?>
	              <?php if (empty($student->time)) { ?>
	                <td class=" centered-cell">absent</td>                
	              <?php } else if (strtotime($student->time) > strtotime("08:30:00")) { ?>
	            ...
	            <?php } else if ($student->grade_name == 'N') { ?>
            	  <?php if (empty($student->time)) { ?>
	                <td class=" centered-cell">absent</td>                
	              <?php } else if (strtotime($student->time) > strtotime("08:15:00")) { ?>
	                <td class=" centered-cell">Late In</td>
	              <?php } else { ?>
	                <td class=" centered-cell">On Time</td>
	              <?php } ?>
	            <?php } else if ($student->grade_name == 'KG' || $student->grade_name == 'I' || $student->grade_name == 'II') { ?>
	            	<?php if (empty($student->time)) { ?>
	                <td class=" centered-cell">absent</td>                
	              <?php } else if (strtotime($student->time) > strtotime("07:45:00")) { ?>
	                <td class=" centered-cell">Late In</td>
	              <?php } else { ?>
	                <td class=" centered-cell">On Time</td>
	              <?php } ?>
	            <?php } ?>
              <td class=" centered-cell"><?php echo $student->ip4; ?></td>
              <td class=" centered-cell"><?php echo $student->location_name; ?></td>
            </tr>
          <?php } ?>
          </tbody>
        </table>
