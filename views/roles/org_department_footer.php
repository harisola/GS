...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 &&   $this->uri->uri_string() == 'roles/org_department') {?>
                ...
                var oTable = $('#view_table').dataTable({
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.aneditable_org_name a').editable({
                            ...
                            url: '<?php echo base_url()?>index.php/roles/org_department_ajax/edit',
                        ...
                        $('.aneditable_domain_name a').editable({
                            ...
                            <?php foreach($org_domain_table as $org_domain) { ?>
                                {value:'<?php echo $org_domain->id ?>',text:'<?php echo $org_domain->name ?>'},
                            <?php } ?>    
                            ],
                            select2:{
                                width:200,
...
if($('#insert-role').length){
    $('#insert-role').validate({
        ...
        messages:{
            ...
            domain:{
                required:"Please Select the Domain"
            }
        },
        submitHandler: function(form){
            $(form).ajaxSubmit({
                type:"POST",
                url:"<?php echo base_url(); ?>index.php/roles/org_department_ajax/insert_org_domain",
                cache:false,
                success:function(data){
                   if(data != 1){
                       ...
                       $('#error').fadeOut(5000); 
                        ...
                        $.get("<?php echo base_url(); ?>index.php/roles/org_department_ajax/getLastId" ,function(e){
                            var name = $('#name').val();
                            var dname = $('#dname').val();
                            var sname = $('#sname').val();
                            var code =  $('#code').val();
                            ...
                            var id = parseInt(e);
                            $('#view_table tr:last').after('<tr><td class="centered-cell">'+id+ '</td> <td class="centered-cell aneditable_org_name"><a href="#" data-type="text" data-name="name" data-pk="'+id+'" data-placement="top">'+name+'</a></td> <td class="centered-cell aneditable_org_dname"><a href="#" data-type="text" data-name="dname" data-pk="'+id+'" data-placement="top">'+dname+ '</a></td> <td class="centered-cell aneditable_org_sname"><a href="#" data-type="text" data-name="sname" data-pk="'+id+'" data-placement="top">'+sname+ '</a></td> <td class="centered-cell aneditable_org_code"><a href="#" data-type="text" data-name="code" data-pk="'+id+'" data-placement="top">'+code+'</a></td> <td class="centered-cell aneditable_domain_name"><a href="#" data-type="select2" data-name="domainID" data-pk="'+id+'" data-placement="top">'+domain+ '</a></td> <td class="centered-cell aneditable_org_position"><a href="#" data-type="text" data-name="position" data-pk="'+id+'" data-placement="top">'+position+'</a></td> <td class="aneditable_org_color"><input type="text" class="form-control jscolor" value="'+color+'" id="'+id+'" style="width:90px"></td></tr>');
