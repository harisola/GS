...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // ========================================================================        
        if ($('#threshold_assigncard_parent_form').length) {
            $("#threshold_assigncard_parent_form").validate({
        ...
        $(document).ready(function () {
            ...
            <?php if($this->data['can_user_view'] == 1 && ($this->uri->uri_string() == 'threshold/visitors_today')) {?>
            if ($('#threshold_all_visitors').length) {
                var oTable = $('#threshold_all_visitors').dataTable({
                    "oLanguage": {
