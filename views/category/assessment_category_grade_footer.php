...
$(document).ready(function(){
    ...
    $('.aneditable_weightage a').editable({
        type:'select',
        source:[
            <?php for($i=1;$i<=100;$i++)  { ?>
                {value:'<?php echo $i ?>',text:'<?php echo $i; ?>'},
            <?php } ?>    
        ],
    ...
    url:'<?php echo base_url(); ?>index.php/category/assessment_category_grade_ajax/update',
    ...
    $(document).on('click','.insertable_weightage a',function(){
         grade_id = $(this).attr('data-grade');
         category = $(this).attr('data-category');


    });

    $('.insertable_weightage a').editable({
        type:'select',
        source:[
            <?php for($i=1;$i<=100;$i++)  { ?>
                {value:'<?php echo $i ?>',text:'<?php echo $i; ?>'},
        ...
        params:function(params){
            ...
            params.assessment_category = category;
            return params;
        },
        url:'<?php echo base_url(); ?>index.php/category/assessment_category_grade_ajax/insert',


    });


        //Update Total if data is already insert

    $(document).on('click','.aneditable_weightage a',function(){
        var text;
        var grade = $(this).attr('data-grade');
        var category = $(this).attr('data-category');
        var weightage = $(this).text();
        ...
        $('.editable-submit').click(function(){
            ...
            var value  = $('.editable-input option:selected').val();

            // Get the value which is already exist
            $('table').each(function(){
              text = $(this).find("[data-grade='"+grade+"'][data-category = '"+category+"']").text();
              text = parseInt(text);

            //Get the total which is already exist
              total = $(this).find("[data-gradeid='"+grade+"']").text();
            ...
            //formula to subtract already text to total and then add selected value
            formula = total-text;
            var result1;

            result=parseInt(formula)+parseInt(value);
            if(result == 100){
             result1 = "<b style='color:green'>"+result+"</b>";
            }
            else
            {
             result1 ="<b style='color:red'>"+result+"</b>";   
            }


            //To find the current position of total to insert
            $('table').each(function(){
                $(this).find("[data-gradeid='"+grade+"']").html(result1);
    ...
    $(document).on('click','.insertable_weightage a',function(){
        ...
        $('.editable-submit').click(function(){
            ...
            $('table').each(function(){
             // Get the total    
             total = $(this).find("[data-gradeidempty='"+grade+"']").text();
             // alert(total);
             if(total.length == 0){
                total = 0;
             }
            ...
            // Formula to add  selected value and total
            result = parseInt(value) + parseInt(total);
            if(result == 100){
             result1 = "<b style='color:green'>"+result+"</b>";
            }
            else
            ...
            $('table').each(function(){
                 $(this).find("[data-gradeidempty='"+grade+"']").html(result1);
