...
<?php //var_dump( $grades ); ?>
<section class="col-md-3">
	<label class="select" id="northCampusGrades2">
	
	 <select name="grade" id="grade" class="grade" disabled>
...
<div class="callout callout-info" style="display:none;" id="sucess-msg"> Thank you, You have sucessfully set up Grade Level Programme </div>
</section>
</div>
...
<div class="powerwidget dark-red" data-widget-editbutton="false">
<header><h2>Grade Programme</h2></header>
...
<div id="dlist">
  <!--h2>Drop Below...</h2 -->
    <ol class="h-droped-list">
      <li class="placeholder" style="display: none;">Empty! Grade Level Prgramme Setup</li>
    </ol>
	
<input type="hidden" name="sessionID" id="sessionID" value="" />
<input type="hidden" name="gradeID" value="" id="gradeID" />
<input type="hidden" name="Hiddensubjects" value="" id="Hiddensubjects" />
</div>
<br />

<footer id="footerSaveBtn" style="display:none;">
	<button class="btn btn-default" type="submit" id="btn_sgp">Set Grade Programme</button>
</footer>
<footer id="sucess_msg2" style="display:none;min-height:0px;">
<div class="callout callout-danger" style="min-height:0px;"> <h4> Grade Programme Assigned To Teacher </h4> <p> So, Please unassigned programme in matrix role. After you can edit programme </p> </div>
...
*/
.header-favorites ol {margin:0;padding:0;background-color: hsl(195, 67%, 93%);clear:both;overflow:hidden;}
...
.addedToFav{ background-color: hsl(195, 67%, 93%); }
.addedToFav2{ 
