											...
											<div class="form-group">
												...
												* </span>
												...
												<div class="col-md-4">
													<div class="radio-list">
														<label>
														<input type="radio" name="applied_before" value="Y" data-title="Yes" required="" />
														Yes </label>
														<label>
														<input type="radio" name="applied_before" value="N" data-title="No" required="" />
														No </label>
													</div>
										...
										<div class="tab-pane" id="tab3">											
											...
											<div class="containerXYZ">											
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control level_3_institute" name="level_3_institute[0]"/>
													</div>												
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control level_3_subjects" name="level_3_subjects[0]"/>
													</div>												
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control level_3_degree" name="level_3_degree[0]"/>
													</div>												
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control level_3_grade" name="level_3_grade[0]"/>
													</div>												
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control level2year level_3_year" name="level_3_year[0]"/>
													</div>																									
												</div>
											</div>
										</div>
											...
											<div class="form-group">
												<label class="control-label col-md-3">
													<button id='add' type="button" class="btn">Add University Qualification</button>
													<button id='remove' type="button" class="btn">Remove</button>
												</label>
											</div>
										...
										<div class="tab-pane" id="tab5">
											...
											<div class="containerPRO">											
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control pro_name" name="pro_name[0]"/>
													</div>												
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control pro_institute" name="pro_institute[0]"/>
													</div>												
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">Year Awarded
													...
													<div class="col-md-4">
														<input type="text" class="form-control proyear pro_year" name="pro_year[0]"/>
													</div>																									
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control pro_detail" name="pro_detail[0]"/>
													</div>												
												</div>												
											</div>
											...
											<div class="form-group">
												<label class="control-label col-md-3">
													<button id='add_pro' type="button" class="btn">Add Professional Qualification</button>
													<button id='remove_pro' type="button" style="display:none;" class="btn">Remove</button>
												</label>
											</div>	
										...
										<div class="tab-pane" id="tab4">
											...
											<div class="containerABC">												
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control emp_institute" name="emp_institute[0]" />
													</div>												
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control emp_designation" name="emp_designation[0]"/>
													</div>												
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control emp_classes" name="emp_classes[0]"/>
													</div>												
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control emp_subject" name="emp_subject[0]"/>
													</div>												
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control expected_salary emp_salary" name="emp_salary[0]"/>
													</div>												
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control level2year emp_year_from" name="emp_year_from[0]"/>
													</div>																									
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control level2year emp_year_to" name="emp_year_to[0]"/>
													</div>																									
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control emp_leaving_reason" name="emp_leaving_reason[0]"/>
													</div>																									
												</div>
											...
											<div class="form-group">
												<label class="control-label col-md-3">
													<button id='add_emp_record' type="button" class="btn">Add more employment record</button>
													<button id='remove_emp_record' type="button" style="display: none" class="btn">Remove</button>
												</label>
											</div>										
										</div>										
									</div>					
...
if($('.block:visible').text()=="Employment Practicalities"){
	jQuery.validator.addMethod("checked_employment_true", function(value, element){
		...
		if($("input[type='radio'][name=currently_employed]:checked").val() == 'Y') {
			if(ce_notice_period>0 && ce_employed_salary>=3 && ce_expected>=3 && ce_timing>=3 ){
				return true;
			}else{
				return false;
			}
            ...
            form.validate({
                ...
                rules: { 
                    ...
                    cell_number: {
                		...
                		required: true,
                		remote: {
				            url: "<?php echo site_url();?>/career/user_availability2",
				            type: "post",
				             data: {
						        cell_number: function () {
							        return $("input[name='cell_number']").val();
						        }
						      }  
				        }
                    },
                    ...
                    cnic: {
                		...
                		required: true,
						remote: {
				            url: "<?php echo site_url();?>/career/user_availability",
				            type: "post",
				             data: {
						        cnic: function () {
					...
					currently_employed_notice_period : {
						required: function(){
							if ($('input[name=currently_employed]:checked').val() == "Y") {	
								return true
							}else{
								return false
							}
...
'emp_institute[0]':{ 
    required:function(){
		if ($('input[name=currently_employed]:checked').val() == "Y") {	
			return $("input[name='emp_institute[0]']").filter(function(){
...
'emp_designation[0]':{ 
    required:function(){
		if ($('input[name=currently_employed]:checked').val() == "Y") {	
			return $("input[name='emp_designation[0]']").filter(function(){
	        	return $.trim($(this).val()).length>0
	      	}).length==0
		}else{
			return false
 ...
 'emp_salary[0]':{ 
    required:function(){
		if ($('input[name=currently_employed]:checked').val() == "Y") {	
			return $("input[name='emp_salary[0]']").filter(function(){
	        	return $.trim($(this).val()).length>0
	      	}).length==0
		}else{
			return false
 ...
 'emp_year_from[0]':{ 
    required:function(){
		if ($('input[name=currently_employed]:checked').val() == "Y") {	
			return $("input[name='emp_year_from[0]']").filter(function(){
	        	return $.trim($(this).val()).length>0
	      	}).length==0
		}else{
			return false
 ...
 'emp_year_to[0]':{ 
    required:function(){
		if ($('input[name=currently_employed]:checked').val() == "Y") {	
			return $("input[name='emp_year_to[0]']").filter(function(){
	        	return $.trim($(this).val()).length>0
	      	}).length==0
		}else{
			return false
 ...
 'emp_leaving_reason[0]':{ 
    required:function(){
		if ($('input[name=currently_employed]:checked').val() == "Y") {	
			return $("input[name='emp_leaving_reason[0]']").filter(function(){
	        	return $.trim($(this).val()).length>0
	      	}).length==0
		}else{
			return false
	...
	maxlength: 35
  	...
  	'pro_name[0]':{ maxlength: 45 },
	'pro_institute[0]':{ maxlength: 30 },
  	'pro_year[0]':{ maxlength: 4 },
  	'pro_detail[0]':{ maxlength: 40 },
                ...
                messages: { // custom messages for radio buttons and checkboxes
                    ...
                    cnic:{
			         ...
			         remote: jQuery.validator.format("NIC is already taken.")
			        },
...
<script type="text/html" id="form_tpl_iii">
	<div class="containerXYZ">											
	<div class="form-group">
		<br><br>
		<label class="control-label col-md-3">University Name
		...
		<div class="col-md-4">
			<input type="text" class="form-control level_3_institute" name="level_3_institute[<%= element.i %>]"/>
		</div>												
	</div>
	<div class="form-group">
		<label class="control-label col-md-3">Main Subjects
		...
		<div class="col-md-4">
			<input type="text" class="form-control level_3_subjects" name="level_3_subjects[<%= element.i %>]"/>
		</div>												
	</div>
	<div class="form-group">
		<label class="control-label col-md-3">Degree
		...
		<div class="col-md-4">
			<input type="text" class="form-control level_3_degree" name="level_3_degree[<%= element.i %>]"/>
		</div>												
	</div>
	<div class="form-group">
		<label class="control-label col-md-3">Grade / GPA
		...
		<div class="col-md-4">
			<input type="text" class="form-control level_3_grade" name="level_3_grade[<%= element.i %>]"/>
		</div>												
	</div>
	<div class="form-group">
		<label class="control-label col-md-3">Year Awarded
		...
		<div class="col-md-4">
			<input type="text" class="form-control level2year level_3_year" name="level_3_year[<%= element.i %>]"/>
		</div>																									
	</div>
</div>
</script>
...
<script type="text/html" id="form_tpl_ii">
	<div class="containerPRO">											
	<div class="form-group">
		<br><br>
		<label class="control-label col-md-3">Name / Title of Qualification														
		...
		<div class="col-md-4">
			<input type="text" class="form-control pro_name" name="pro_name[<%= element.i %>]"/>
		</div>												
	</div>
	<div class="form-group">
		<label class="control-label col-md-3">Awarding Body / Institute
		...
		<div class="col-md-4">
			<input type="text" class="form-control pro_institute" name="pro_institute[<%= element.i %>]"/>
		</div>												
	</div>
	<div class="form-group">
		<label class="control-label col-md-3">Year Awarded
		...
		<div class="col-md-4">
			<input type="text" class="form-control proyear pro_year" name="pro_year[<%= element.i %>]"/>
		</div>																									
	</div>
	<div class="form-group">
		<label class="control-label col-md-3">Detail
		...
		<div class="col-md-4">
			<input type="text" class="form-control pro_detail" name="pro_detail[<%= element.i %>]"/>
		</div>												
	</div>												
</div>
</script>
...
<div class="form-group">
	...
	<div class="col-md-4">
		<input type="text" class="form-control emp_institute" name="emp_institute[<%= element.i %>]" />
	</div>												
</div>
<div class="form-group">
	<label class="control-label col-md-3">Designation
	...
	<div class="col-md-4">
		<input type="text" class="form-control emp_designation" name="emp_designation[<%= element.i %>]"/>
	</div>												
</div>
<div class="form-group">
	<label class="control-label col-md-3">Class(s) taught (comma seperated)
	...
	<div class="col-md-4">
		<input type="text" class="form-control emp_classes" name="emp_classes[<%= element.i %>]"/>
	</div>												
</div>
<div class="form-group">
	<label class="control-label col-md-3">Subject(s) taught (comma seperated)
	...
	<div class="col-md-4">
		<input type="text" class="form-control emp_subject" name="emp_subject[<%= element.i %>]"/>
	</div>												
</div>
<div class="form-group">
	<label class="control-label col-md-3">Salary
	...
	<div class="col-md-4">
		<input type="text" class="form-control expected_salary emp_salary" name="emp_salary[<%= element.i %>]"/>
	</div>												
</div>
<div class="form-group">
	<label class="control-label col-md-3">From (year)
	...
	<div class="col-md-4">
		<input type="text" class="form-control level2year emp_year_from" name="emp_year_from[<%= element.i %>]"/>
	</div>																									
</div>
<div class="form-group">
	<label class="control-label col-md-3">To (year)
	...
	<div class="col-md-4">
		<input type="text" class="form-control level2year emp_year_to" name="emp_year_to[<%= element.i %>]"/>
	</div>																									
</div>
<div class="form-group">
	<label class="control-label col-md-3">Reason for leaving
	...
	<div class="col-md-4">
		<input type="text" class="form-control emp_leaving_reason" name="emp_leaving_reason[<%= element.i %>]"/>
	</div>																									
</div>
...
$(document).ready(function(e) {
	...
	var tpl_uni = _.template($("#form_tpl_iii").html());
	var counter3 = 1;
    ...
    $('#add').click(function(e) {
    	...
    	var tplData3 = { i: counter3 };


		if ($('div.containerXYZ').length < 2 ) {
       		//$('div.containerXYZ:last').after($('div.containerXYZ:first').clone());
       		$("#containerXYZ").append(tpl_uni(tplData3)); 	
   		}

   		counter3 += 1;
		$('.level_3_institute').each(function () {
	        $(this).rules("add", {
	        	minlength: 4,
        		maxlength: 35
	        });
    	...
    	$('.level_3_subjects').each(function () {
	        $(this).rules("add", {
	          minlength: 4,
                		maxlength: 35
	        });
       ...
       $('form#submit_form').submit(function(e){ e.preventDefault(); });
    });
	...
	_.templateSettings.variable = "element";
	var tpl_emp = _.template($("#form_tpl").html());
	var counter = 1;
	$('#add_emp_record').click(function(e) {
    	...
    	var tplData = { i: counter };
		if(counter < 5 ){
   			$("#containerABC").append(tpl_emp(tplData)); 	
   		 }
    	counter += 1;

    	$('.emp_institute').each(function () {
	        $(this).rules("add", {
	            required: function(){
	            	if ($('input[name=currently_employed]:checked').val() == "Y") {	
						return true
	...
	$('.emp_leaving_reason').each(function () {
	        $(this).rules("add", {
	              required: function(){
	            	if ($('input[name=currently_employed]:checked').val() == "Y") {	
						return true
    ...
    $('#remove_emp_record').click(function(e) {
   ...
   _.templateSettings.variable = "element";
	...
	var counter2 = 1;
	 $('#add_pro').click(function(e) {
		...
		if(counter2 < 5 ){
   			$("#containerPRO_container").append(tpl(tplData2)); 	
   		}
    	counter2 += 1;
    	...
    	$('.pro_institute').each(function () {
	        $(this).rules("add", {
	           maxlength:30
	        });
    	});

    	$('.pro_year').each(function () {
	        $(this).rules("add", {
	           maxlength:4
	        });
    	});
