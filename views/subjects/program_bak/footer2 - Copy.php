  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Error!</h4></div>
...
$(document).ready(function(){
		...
		if (item.length  > 0 ) {
		   ...
		   //item.last().remove();
            ...
            $target
              ...
              .clone()
			  .append('<span class="edit">Customize</span>')
			  .append('<div style="display:none;" class="optH"><input type="checkbox" value="'+subjectID+'" name="optional[]"> opt </div>')
              .appendTo($dropedList);
    ...
    $(document).on('click','ol.h-droped-list li .fa-plus',function(){
       ...
       // $target.removeClass("addedToFav");
		...
		// $target.removeClass("addedToFav");
		// $dropList.removeClass("addedToFav");
	...
	if ($('#frm').length) {
		$("#frm").validate({
			...
			messages: {
				...
				subjects : { required: 'Please Choose Grade Programme' },
			},
			// Ajax form submition					
