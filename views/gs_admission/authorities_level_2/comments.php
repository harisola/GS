...
$in_out = "in";
			...
			<?php }
					...
					<span class="arrowHeadLeft">&nbsp;</span>
						...
						?>
							...
							<?php /* <strong> <?=$reason;?> </strong> for form submission on <strong><?=$reason[1];?></strong><?php */ ?>
						<?php }?>
	...
	?>
		...
		<div class="TimelineAddForm">
			<form method="POST" action="<?=base_url();?>index.php/gs_admission/authorities_ad2/getFormData" name="postComments" id="postComments">
