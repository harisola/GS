<?php
class Master_calendar2 extends CI_Controller{
	...
	public function index(){
		...
		$this->load->view('master_calendar/calendar_without_header',$data);
	...
	public function get_date_events($date_id,$MonBox){
		...
		if( $r["Type"] != '' ){
			switch($r["Type"]){
				...
				case 'Holiday':
					$class = "HolidayParameterSet"; $class3 = "HolidayParameterSet"; $data_target="SetHolidayParameter";
				break;
				case 'Staff': 
					$class = "StaffParameterSet";   $class3 = "StaffParameterSet";   $data_target="SetStaffParameter";
				break;
				case 'Student'  : 
			...
			if( $Loop_Counter < 4 ){
				if( $date_id < $TodayDate){
					$html .='<a class="'.$class3.'" href="#" id="H_'.$r["ID"].'" data-id="'.$MonBox.'" data-toggle="modal" data-target="#'.$data_target.'">';	
				}else{
