<!-- Datatables View users -->
  ...
  <!-- <div class="col-md-12 bootstrap-grid"> -->
    <div class="powerwidget <?php echo $title_background_color_view; ?> powerwidget-sortable" id="datatable-filter-column" data-widget-editbutton="false" role="widget" style="">
      <header role="heading">
        <h2>wings<small>in <?php echo $this->data['branch'][0]->dwebname; ?></small></h2>
      ...
      <div class="inner-spacer" role="content">
        <div id="wings_in_branch_existing_wrapper" class="dataTables_wrapper form-inline" role="grid">
              
          <table class="display table table-striped table-hover dataTable" id="wings_in_branch_existing" aria-describedby="applicant_info">
          ...
          <?php
            $class_odd_even = 'even';
            foreach($this->data['branch_wings'][0] as $wing) {
          ...
          ?>
            <tr class="<?php echo $class_odd_even; ?>">              
              <td class=" sorting_1"><a href="#" data-type="text" data-name="name" data-pk="<?php echo $wing->id; ?>" data-placement="right"><?php echo $wing->wing_name; ?></a></td>
              <td class="display_name"><a href="#" data-type="text" data-name="dname" data-pk="<?php echo $wing->id; ?>" data-placement="right"><?php echo $wing->wing_dname; ?></a></td>
