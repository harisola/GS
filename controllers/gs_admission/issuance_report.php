...
class Issuance_report extends CI_Controller{
	...
	public function index(){
		...
		//}else{
			...
			$data["issuance_report"] = $this->IRM->getList();
			
			
			
			
			$this->load->view('gs_admission/issunace_report/front_page',$data);
	        $this->load->view('gs_admission/issunace_report/footer');
	   // }		
	}
	...
	public function fliter(){
		...
		$this->load->view('gs_admission/issunace_report/fliter_result',$data);
	...
	public function grade_query( $grade_id,$from_date,$to_date ){
		...
		foreach( $grade_id as $g_id )
		{
			if( $g_id == 1 ){
				if( $size == 1  ){
					$query .= " sum(if(af.grade_id=1 and af.gender = 'G', 1, 0)) as PN_G, sum(if(af.grade_id=1 and af.gender = 'B', 1, 0)) as PN_B ";
				}else{
					$query .= " sum(if(af.grade_id=1 and af.gender = 'G', 1, 0)) as PN_G, sum(if(af.grade_id=1 and af.gender = 'B', 1, 0)) as PN_B, ";
				}
			}
			...
			if( $g_id == 2 ){
				if( $size == 2 ){
					$query .= " sum(if(af.grade_id=2 and af.gender = 'G', 1, 0)) as N_G, sum(if(af.grade_id=2 and af.gender = 'B', 1, 0)) as N_B ";
				}else{
					$query .= " sum(if(af.grade_id=2 and af.gender = 'G', 1, 0)) as N_G, sum(if(af.grade_id=2 and af.gender = 'B', 1, 0)) as N_B, ";
				}
			}
				...
				if( $g_id == 3 ){
					if( $size ==3 ){
					$query .= " sum(if(af.grade_id=3 and af.gender = 'G', 1, 0)) as KG_G, sum(if(af.grade_id=3 and af.gender = 'B', 1, 0)) as KG_B ";	
					}else{
					$query .= " sum(if(af.grade_id=3 and af.gender = 'G', 1, 0)) as KG_G, sum(if(af.grade_id=3 and af.gender = 'B', 1, 0)) as KG_B, ";	
					}
				}
				...
				if( $g_id == 4 ){
					if( $size == 4 ){
						$query .= " sum(if(af.grade_id=4 and af.gender = 'G', 1, 0)) as I_G, sum(if(af.grade_id=4 and af.gender = 'B', 1, 0)) as I_B  ";	
					}else{
						$query .= " sum(if(af.grade_id=4 and af.gender = 'G', 1, 0)) as I_G, sum(if(af.grade_id=4 and af.gender = 'B', 1, 0)) as I_B, ";	
					}
				}
				...
				if( $g_id == 5 ){
					if( $size == 5  ){
						$query .= " sum(if(af.grade_id=5 and af.gender = 'G', 1, 0)) as II_G, sum(if(af.grade_id=5 and af.gender = 'B', 1, 0)) as II_B ";	
					}else{
						$query .= " sum(if(af.grade_id=5 and af.gender = 'G', 1, 0)) as II_G, sum(if(af.grade_id=5 and af.gender = 'B', 1, 0)) as II_B,  ";	
					}
				}
				...
				if( $g_id == 6 ){
					if( $size == 6 ){
						$query .= " sum(if(af.grade_id=6 and af.gender = 'G', 1, 0)) as III_G, sum(if(af.grade_id=6 and af.gender = 'B', 1, 0)) as III_B  ";	
					}else{
						$query .= " sum(if(af.grade_id=6 and af.gender = 'G', 1, 0)) as III_G, sum(if(af.grade_id=6 and af.gender = 'B', 1, 0)) as III_B,  ";	
					}
				}
				...
				if( $g_id == 7 ){
					if( $size == 7  ){
						$query .= " sum(if(af.grade_id=7 and af.gender = 'G', 1, 0)) as IV_G, sum(if(af.grade_id=7 and af.gender = 'B', 1, 0)) as IV_B ";	
					}else{
						$query .= " sum(if(af.grade_id=7 and af.gender = 'G', 1, 0)) as IV_G, sum(if(af.grade_id=7 and af.gender = 'B', 1, 0)) as IV_B, ";
					}
				}
				...
				if( $g_id == 8 ){
					if( $size == 8 ){
						$query .= " sum(if(af.grade_id=8 and af.gender = 'G', 1, 0)) as V_G, sum(if(af.grade_id=8 and af.gender = 'B', 1, 0)) as V_B ";	
					}else{
						$query .= " sum(if(af.grade_id=8 and af.gender = 'G', 1, 0)) as V_G, sum(if(af.grade_id=8 and af.gender = 'B', 1, 0)) as V_B, ";	
					}
				}
				...
				if( $g_id == 9 ){
					if( $size ==9  ){
						$query .= " sum(if(af.grade_id=9 and af.gender = 'G', 1, 0)) as VI_G, sum(if(af.grade_id=9 and af.gender = 'B', 1, 0)) as VI_B ";	
					}else{
						$query .= " sum(if(af.grade_id=9 and af.gender = 'G', 1, 0)) as VI_G, sum(if(af.grade_id=9 and af.gender = 'B', 1, 0)) as VI_B, ";	
					}
				}
				...
				if( $g_id == 10 ){
					if( $size == 10  ){
						$query .= " sum(if(af.grade_id=10 and af.gender = 'G', 1, 0)) as VII_G, sum(if(af.grade_id=10 and af.gender = 'B', 1, 0)) as VII_B ";	
					}else{
						$query .= " sum(if(af.grade_id=10 and af.gender = 'G', 1, 0)) as VII_G, sum(if(af.grade_id=10 and af.gender = 'B', 1, 0)) as VII_B, ";	
					}
				}
				...
				if( $g_id == 11 ){
					if( $size == 11  ){
						$query .= " sum(if(af.grade_id=11 and af.gender = 'G', 1, 0)) as VIII_G, sum(if(af.grade_id=11 and af.gender = 'B', 1, 0)) as VIII_B ";
					}else{
						$query .= " sum(if(af.grade_id=11 and af.gender = 'G', 1, 0)) as VIII_G, sum(if(af.grade_id=11 and af.gender = 'B', 1, 0)) as VIII_B, ";	
					}
				}
				...
				if( $g_id == 12 ){
					if( $size == 12 ){
						$query .= " sum(if(af.grade_id=12 and af.gender = 'G', 1, 0)) as IX_G, sum(if(af.grade_id=12 and af.gender = 'B', 1, 0)) as IX_B ";
					}else{
						$query .= " sum(if(af.grade_id=12 and af.gender = 'G', 1, 0)) as IX_G, sum(if(af.grade_id=12 and af.gender = 'B', 1, 0)) as IX_B, ";	
					}
				}
				...
				if( $g_id == 13 ){
					if( $size == 13  ){
						$query .= " sum(if(af.grade_id=13 and af.gender = 'G', 1, 0)) as X_G, sum(if(af.grade_id=13 and af.gender = 'B', 1, 0)) as X_B ";
					}else{
						$query .= " sum(if(af.grade_id=13 and af.gender = 'G', 1, 0)) as X_G, sum(if(af.grade_id=13 and af.gender = 'B', 1, 0)) as X_B, ";	
					}
				}
				...
				if( $g_id == 14 ){
					if( $size == 14 ){
						$query .= " sum(if(af.grade_id=14 and af.gender = 'G', 1, 0)) as XI_G, sum(if(af.grade_id=14 and af.gender = 'B', 1, 0)) as XI_B ";
					}else{
						$query .= " sum(if(af.grade_id=14 and af.gender = 'G', 1, 0)) as XI_G, sum(if(af.grade_id=14 and af.gender = 'B', 1, 0)) as XI_B, ";	
					}
				}
				...
				if( $g_id == 15 ){
					...
					if( $size == 15 ){
						$query .= " sum(if(af.grade_id=15 and af.gender = 'G', 1, 0)) as A1_G, sum(if(af.grade_id=15 and af.gender = 'B', 1, 0)) as A1_B ";
					}else{
						$query .= " sum(if(af.grade_id=15 and af.gender = 'G', 1, 0)) as A1_G, sum(if(af.grade_id=15 and af.gender = 'B', 1, 0)) as A1_B, ";	
					}
				...
				if( $g_id == 16 ){
					if( $size == 16 ){
						$query .= " sum(if(af.grade_id=16 and af.gender = 'G', 1, 0)) as A2_G, sum(if(af.grade_id=16 and af.gender = 'B', 1, 0)) as A2_B ";	
					}else{
						$query .= " sum(if(af.grade_id=16 and af.gender = 'G', 1, 0)) as A2_G, sum(if(af.grade_id=16 and af.gender = 'B', 1, 0)) as A2_B, ";	
					}
				}
				...
				{	
					...
					if( $size == 17 ){
						$query .= " sum(if(af.grade_id=17 and af.gender = 'G', 1, 0)) as PG_G, sum(if(af.grade_id=17 and af.gender = 'B', 1, 0)) as PG_B ";
					}else{
						$query .= " sum(if(af.grade_id=17 and af.gender = 'G', 1, 0)) as PG_G, sum(if(af.grade_id=17 and af.gender = 'B', 1, 0)) as PG_B, ";
					}
...
(select
	...
	left join atif._grade as gg on gg.id = af.grade_id  ";
	...
	$query .= " where af.issuance_date >= '".$from_date."' and af.issuance_date <= '".$to_date."' ";
		
	$query .= " group by af.issuance_date ";
	
	return $query;
		
	}	
	public function grade_query2( $grade_id,$from_date,$to_date ){
		...
		foreach( $grade_id as $g_id ){
				...
				if( $g_id == 1 ){
					if( $size == 1  ){
					$query .= " IFNULL(pn_g.num,'') as PN_G, IFNULL(pn_b.num,'') as PN_B ";	
					}else{
					$query .= " IFNULL(pn_g.num,'') as PN_G, IFNULL(pn_b.num,'') as PN_B, ";	
					}
				}
				...
				if( $g_id == 2 ){
					if( $size == 2 ){
					$query .= " IFNULL(n_g.num,'') as N_G, IFNULL(n_b.num,'') as N_B ";	
					}else{
					$query .= " IFNULL(n_g.num,'') as N_G, IFNULL(n_b.num,'') as N_B, ";	
					}
				}
				...
				if( $g_id == 3 ){
					if( $size ==3 ){
					$query .= " IFNULL(kg_g.num,'') as KG_G, IFNULL(kg_b.num,'') as KG_B ";	
					}else{
					$query .= " IFNULL(kg_g.num,'') as KG_G, IFNULL(kg_b.num,'') as KG_B, ";	
					}
				}
				...
				if( $g_id == 4 ){
					if( $size == 4 ){
					$query .= " IFNULL(i_g.num,'') as I_G, IFNULL(i_b.num,'') as I_B ";	
					}else{
					$query .= " IFNULL(i_g.num,'') as I_G, IFNULL(i_b.num,'') as I_B, ";	
					}
				}
				...
				if( $g_id == 5 ){
					if( $size == 5  ){
						$query .= " IFNULL(ii_g.num,'') as II_G, IFNULL(ii_b.num,'') as II_B ";	
					}else{
						$query .= " IFNULL(ii_g.num,'') as II_G, IFNULL(ii_b.num,'') as II_B, ";	
					}
				}
				...
				if( $g_id == 6 ){
					if( $size == 6 ){
					$query .= " IFNULL(iii_g.num,'') as III_G, IFNULL(iii_b.num,'') as III_B ";	
					}else{
					$query .= " IFNULL(iii_g.num,'') as III_G, IFNULL(iii_b.num,'') as III_B, ";	
					}
				}
				...
				if( $g_id == 7 ){
					if( $size == 7  ){
					$query .= " IFNULL(iv_g.num,'') as IV_G, IFNULL(iv_b.num,'') as IV_B ";	
					}else{
					$query .= " IFNULL(iv_g.num,'') as IV_G, IFNULL(iv_b.num,'') as IV_B, ";
					}
				}
				...
				if( $g_id == 8 ){
					if( $size == 8 ){
					$query .= " IFNULL(v_g.num,'') as V_G, IFNULL(v_b.num,'') as V_B ";	
					}else{
					$query .= " IFNULL(v_g.num,'') as V_G, IFNULL(v_b.num,'') as V_B, ";	
					}
				}
				...
				if( $g_id == 9 ){
					if( $size ==9  ){
					$query .= " IFNULL(vi_g.num,'') as VI_G, IFNULL(vi_b.num,'') as VI_B ";	
					}else{
					$query .= " IFNULL(vi_g.num,'') as VI_G, IFNULL(vi_b.num,'') as VI_B, ";	
					}
				}
				...
				if( $g_id == 10 ){
					if( $size == 10  ){
					$query .= " IFNULL(vii_g.num,'') as VII_G, IFNULL(vii_b.num,'') as VII_B ";	
					}else{
					$query .= " IFNULL(vii_g.num,'') as VII_G, IFNULL(vii_b.num,'') as VII_B, ";	
					}
				}
...
left join (select af.grade_id, 
	...
	$query = " sum(if(af.grade_id=4 and af.gender = 'G', 1, 0)) as I_G, sum(if(af.grade_id=2 and af.gender = 'B', 1, 0)) as I_B ";
				return $query;
	}
