...
<script type="text/javascript">
    ...
    //=============================Term Change Selection========================//
    //==========================================================================//

    var term = $('#term option:selected').val();
    $(document).on('change','#term',function(){
         term = $('#term select option:selected').val();
    ...
    $(document).on('click','.grade_section',function(){
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"<?php echo base_url(); ?>index.php/etab_reports/formative_report_ajax/get_subject",
            data:{term_id:term,grade:grade,section:section,academic:academic},
            success:function(e){
                $('#optional').hide();
                $('#subject').html(e);
            }
    ...
    $(document).on('click','.optional',function(){
        var op_program = $(this).attr('data-program');
        var op_subject = $(this).attr('data-subject');
        var op_grade = $(this).attr('data-grade');
        var op_academic = $(this).attr('data-academic');
        var is_optional = $(this).attr('data-optional');
        var term_id = $(this).attr('data-term');
        var subject_name = $(this).text();
        var labelheading ='';
        if(term_id == 1){
            labelheading = subject_name+" (1st Term)";
        }
        else if(term_id == 2){
            labelheading = subject_name+" (2nd Term)";
        }
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"<?php echo base_url() ?>index.php/etab_reports/formative_report_ajax/get_optional_group",
            data:{program:op_program,subject:op_subject,grade:op_grade,academic_id:op_academic,optional:is_optional,term_id:term_id},
            success:function(e){
                $('#optional').show();
                $('#LabelHeading').html(labelheading);
               $("#optional").html(e);
            }
    ...
    $(document).on('click','.compulsory',function(){
        ...
        var com_program = $(this).attr('data-program');
        var com_subject = $(this).attr('data-subject');
        var com_grade = $(this).attr('data-grade');
        var com_academic = $(this).attr('data-academic');
        var com_section = $(this).attr('data-section');
        var is_optional = $(this).attr('data-optional');
        var role = $(this).attr('data-role');
        var term_id = $(this).attr('data-term');
        var gp_id = $(this).attr('data-gp-id');
        var labelheading='';
        ...
        //var labelheading = subject_name + "("+ term_id+ "term" + ")";
        ...
        //     type:"POST",
        //     cache:false,
        //     url:"<?php echo base_url(); ?>index.php/ajax/station_process/programmeAsesmntList",
        //     data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term_id,subjectID:com_subject, gradeID:com_grade},
        //     success:function(e){
        //         $('#optional').hide();
        //         $('#LabelHeading').html(labelheading);
        //         $('#setup_2').html(e);
        ...
        //     type:"POST",
        //     cache:false,
        //     url:"<?php echo base_url(); ?>index.php/ajax/station_process/getThisProgramAssessment_PDF",
        //     data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term,subjectID:com_subject, gradeID:com_grade},
        //     success:function(e){
        //         $('#setup_3').html(e);
        //     }
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"<?php echo base_url(); ?>index.php/etab_reports/get_subject_report_ajax/get_programme_assessment_subject_report",
            data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term,subjectID:com_subject, gradeID:com_grade},
            success:function(e){
                $('#subject_report').html(e);
                // console.log(e);
            }
        });
        ...
        //     cache:false,
        //     data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term,subjectID:com_subject,gradeID:com_grade},
        //     url:"<?php echo base_url(); ?>index.php/etab_reports/formative_framework/getThisFormativeframework_PDF",
        //     success:function(e){
        //         $('#formative_framework_report').html(e);
        //     }
        // });
         ...
         $.ajax({
            ...
            cache:false,
            data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term,subjectID:com_subject,gradeID:com_grade},
            url:"<?php echo base_url(); ?>index.php/etab_reports/formative_framework/getThisSummativeFramework",
            success:function(e){
                $('#summative_framework_report').html(e);
            }
        });
          ...
          $.ajax({
            ...
            cache:false,
            data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term,subjectID:com_subject,gradeID:com_grade},
            url:"<?php echo base_url(); ?>index.php/etab_reports/formative_framework/getThisUpdatedFramework",
            success:function(e){
                $('#updated_framework_report').html(e);
            }
        });
    ...
    //==========================================================Optional Group Grade Selection====================================================================//

    $(document).on('click','.option_selection',function(){
        ...
        var com_grade = $(this).attr('data-grade');
        var com_academic = $(this).attr('data-academic');
        var gp_id = $(this).attr('data-gp_id');
        var is_optional = $(this).attr('data-optional');
        ...
        //     cache:false,
        //     url:"<?php echo base_url(); ?>index.php/ajax/station_process/programmeAsesmntList",
        //     data:{role_id:role_id,gradeID:com_grade,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,subjectID:com_subject,term:term_id},
        //     success:function(e){
        //         $('#setup_2').html(e);
        //     }
        ...
        //     type:"POST",
        //     cache:false,
        //     url:"<?php echo base_url(); ?>index.php/etab_reports/formative_report_ajax/getThisProgramAssessment_PDF",
        //     data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term,subjectID:com_subject, gradeID:com_grade},
        //     success:function(e){
        //         $('#setup_4').html(e);
        //     }
        ...
        //     type:"POST",
        //     cache:false,
        //     url:"<?php echo base_url(); ?>index.php/etab_reports/formative_report_ajax/get_student_option_allocation",
        //     data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term_id,subjectID:com_subject, gradeID:com_grade},
        //     success:function(e){
        //         $('#setup_5').html(e);    
        //     }
        ...
        $.ajax({
            ...
            cache:false,
            data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term,subjectID:com_subject,gradeID:com_grade},
            url:"<?php echo base_url(); ?>index.php/etab_reports/formative_framework/getThisSubjectFramework",
            success:function(e){
                $('#subject_marksheet_report').html(e);
            }
        });
        ...
        $.ajax({
            ...
            cache:false,
            data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term,subjectID:com_subject,gradeID:com_grade},
            url:"<?php echo base_url(); ?>index.php/etab_reports/formative_framework/getThisSubjectFormativeFramework",
            success:function(e){
                $('#subject_marksheet_formative_report').html(e);
            }
        });
         ...
         $.ajax({
            ...
            cache:false,
            data:{user_id:user_id,role_id:role_id,sectionID:com_section,optional:is_optional,prgmID:com_program,gpp_id:gp_id,academic:com_academic,term:term,subjectID:com_subject,gradeID:com_grade},
            url:"<?php echo base_url(); ?>index.php/etab_reports/formative_framework/getThisTermFramework",
            success:function(e){
                $('#subject_marksheet_term_report').html(e);
            }
        }); 
