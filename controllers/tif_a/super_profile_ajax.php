...
class Super_profile_ajax extends CI_Controller{
	...
	public function insert_super_profile(){
		...
		$super_profile_id = $this->spm->insert_data('atif_gs_events.event_category',$data);
	...
	public function get_table_interface(){
        ...
        $super_profile_desc = $this->spm->get_by('atif_gs_events.event_category',$select,$where);
		...
		$html .= '<div class="modal-header">
                            ...
                            <div class="modal-footer">
							 <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
                              ...
                              <input type="button" class="btn btn-primary" aria-hidden="true" value="Add New Super Profile" id="add_super_profile" />
							  	 	
  <strong id="sucess_msg" style="display:none">Created Successfully!</strong>
  <img src="'.base_url().'/components/image/ajax-loader.gif" id="ajaxloader" style="display:none" />
	...
	public function After_Ajax_Loading(){
		$this->load->model('tif_a/super_profile_model','spm');
		...
		$data["thisCont"]=$this;
		$this->load->view('tif_a/sp_html/ajax_loading.php',$data);
	}
