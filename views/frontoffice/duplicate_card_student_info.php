<!-- Datatables View users -->
  ...
  <!-- <div class="col-md-12 bootstrap-grid"> -->
    <div class="powerwidget <?php echo $class_list_color_view; ?> powerwidget-sortable" id="datatable-filter-column" data-widget-editbutton="false" role="widget" style="">
      <header role="heading">
        <h2>Duplicate Card Request<small>Detail</small></h2>
      ...
      <div class="inner-spacer" role="content">
        ...
        <!-- <div class="ColVis"><button class="ColVis_Button ColVis_MasterButton"><span>Show / hide columns</span></button></div> -->
          ...
          <table class="display table table-striped table-hover dataTable" id="duplicatecard_student_table" aria-describedby="class_list_info">
          ...
          <?php
            $class_odd_even = 'even';
            $SNo = 1;
            foreach($this->data['DuplicateCardData'] as $table_data) {
          ...
          ?>
            <tr class="<?php echo $class_odd_even; ?>">              
              <form action="<?php echo site_url()?>/fo/student_duplicate_card/printForm2" method="post" accept-charset="utf-8">
                <td class=" centered-cell sorting_2"><input type="submit" name="duplicate_card_id" value="<?php echo $table_data['id']; ?>"></td>
              </form>
