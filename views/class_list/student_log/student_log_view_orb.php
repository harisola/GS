      ...
      <table class="table table-hover margin-0px student_log_grade_section_table" id="student_log_grade_section_table">
        ...
        <tbody>
            ...
            <?php foreach($this->data['gradeSection'] as $gs) { ?>
              ...
              <tr>
              <?php } ?>
                <td class="grade_section"><?php echo $gs['grade_name'] . '-' . $gs['section_name']; ?></td>            
              </tr>
            <?php } ?>
...
<!-- Sticky footer -->
<div class="col-md-12 bootstrap-grid sortable-grid ui-sortable" id="student_timeline_options_div"
     style="
     position: fixed;
     bottom: 0px;
     border-radius: 25px;
  ...
  <div id="student_timeline_all_options">    
