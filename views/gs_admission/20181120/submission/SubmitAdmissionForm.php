                    ...
                    <form action="<?=base_url();?>index.php/gs_admission/ajax_base/form_submission" method="POST" name="submission" id="submission" class="issuance">
                        <div class="col-md-12">
                            <div class="FormNoShow">
                                ...
                                <div class="col-md-9"><input type="text" placeholder="XXXXX" name="form_no" id="form_no" />
                        ...
                        <div class="submission_form" style="display: none;"> 
                            ...
                            <div class="col-md-12">
                                <div class="alevelBox">
                                    <div class="col-md-12 paddingBottom0 div_alevel_checklist" style="padding-left: 0;" >
                                        <div class="col-md-12">
                                        ...
                                        <!-- col-md-12 -->    
                                        <div class="col-md-12 paddingBottom0 div_APCOSR">
                                        ...
                                        <!-- col-md-12 -->
                                        <div class="col-md-12 paddingBottom0 div_PRFSSE">
                                        ...
                                        <!-- col-md-12 -->    
                                        <div class="col-md-12 paddingBottom0 div_ACCIEX" >
