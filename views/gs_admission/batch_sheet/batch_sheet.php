...
.absoluteDiv4 input[type="button"] {
	width: 140px;
    font-size: 14px;
    padding: 14px;
}
        ...
        <div class="col-md-12 BatchListing">
        	<div class="MaroonBorderBox">
                ...
                <div class="inner paddingLeft20 paddingRight20" style="padding:20px !important;">
					<div class="absoluteDiv4">
						<input type="button" class="greenBTN" value="Generate Report" />
					</div>
                	<div class="absoluteDiv3">
						...
						<div class="mutliSelect">
						 <ul>
					       ...
					       <dl class="dropdownG">
                            <dt>
                            	<a href="#"><span class="hidaG">Select Batch</span> <p class="multiSelG" style="display:;"></p></a>
                            </dt>
                            <dd>
                                <div class="mutliSelectG" id="BiGSelectBox">
							
                                    <ul>
                                        <li><input type="checkbox" value="All Batches" name="AllG" id="AllG"/><label for="AllG">All Batches</label></li>
                                        <li><input type="checkbox" value="1" name="1" id="1" /><label for="1">1</label></li>
                                        <li><input type="checkbox" value="2" id="2" name="2" /><label for="2">2</label></li>
                                        <li><input type="checkbox" value="3" name="3" id="3" /><label for="3">3</label></li>
                                        <li><input type="checkbox" value="4" name="4" id="4" /><label for="4">4</label></li>
                                        <li><input type="checkbox" value="5" name="5" id="5" /><label for="5">5</label></li>
                                        <li><input type="checkbox" value="6" name="6" id="6" /><label for="6">6</label></li>
                                        <li><input type="checkbox" value="7" name="7" id="7" /><label for="7">7</label></li>
                                        <li><input type="checkbox" value="8" name="8" id="8" /><label for="8">8</label></li>
                                        <li><input type="checkbox" value="9" name="9" id="9" /><label for="9">9</label></li>
                                        <li><input type="checkbox" value="10" name="10" id="10" /><label for="10">10</label></li>
                                    </ul>
                                </div>
                            </dd>
                        </dl>
				...
				<table id="batch_sheet" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%" > 
							...
							<th class="no-sort" width="5%">
                              ...
                              <th class="no-sort" width="5%">
                                ...
                                <span class="text-right">
                               	<select class="width34" id="ass_decission_name_code">
                              ...
                              <th class="no-sort" width="5%">
                                ...
                                <br />
                                <span class="text-right">
                                	<select class="width34" id="discussion_decission">
                                    	<option value="">D</option>
                                    </select>
                                </span>
                            </th>
					  ...
					  <?php 
						...
						?>
						  <tr> 
                              ...
                              <td class=""><?php //$bll["sibling"];?> <?php echo $bll["pet_code"];?></td>
					  ...
					  $Clc_ACfd = $Clc_DOfr + $Clc_DWil + $Clc_DOhd + $Clc_DRgt; // Discuss Dis
					  $totlAssD = $Clc_ACfd +  $Clc_AWil + $Clc_AOhd + $Clc_ARgt; // Assessement
					  
					 
					  
					  $Clc_TDis = $Clc_DOfr + $Clc_DWil + $Clc_DOhd + $Clc_DRgt; // Discuss Dis
                                ...
                                <td class="text-center">
                                    ...
                                    <table width="100%">
                                        <tbody><tr>
                                            ...
                                            <td>TBR<br><strong><?=$Clc_ARgt;?></strong></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                                <td class="text-center">
                                    ...
                                    <table width="100%">
                                        <tbody><tr>
										 <td>T DIS'D<br><strong><?=$Clc_TDis;?></strong></td>
                                            <td>&gt;TBO<br><strong><?=$Clc_DOfr;?></strong></td>
                                            <td>WL<br><strong><?=$Clc_DWil;?></strong></td>
                                            <td>*OH*<br><strong><?=$Clc_DOhd;?></strong></td>
                                            <td>TBR<br><strong><?=$Clc_DRgt;?></strong></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                                ...
                                <td class="text-center">
                                	<table width="100%">
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td>ABT<br><strong><?=$NIT;?></strong></td>
                                        </tr>
                                    </tbody></table>
                                    <table width="100%">
                                        <tbody><tr>
