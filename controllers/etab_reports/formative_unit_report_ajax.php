...
class Formative_unit_report_ajax extends CI_Controller{
    ...
    public function get_Unit_Report(){
    ...
    public function generate_unit_report(){
        ...
        $this->data['assessment_titles'] = $this->assessment_report_model->get_unit_assessment_subjects_SessionTerm($gradeID, $sectionID, "_".$session_year."_1");
        /******************************** Students Data 
        /***********************************************/
        if($optional == 0){
            //$this->data['students_gs_data'] = $this->assessment_report_model->get_students_grade_section($gradeID, $sectionID);
            $this->data['students_gs_data'] = $this->assessment_report_model->get_students_grade_section_SessionTerm($gradeID, $sectionID, "_".$session_year."_1");
        }else{
        ...
        if($optional == 0){
            ...
            $this->data['assessment_agg_marks'] = $this->assessment_report_model->Get_Formative_Unit_Marks_CurrentGS_SessionTerm($gradeID, $sectionID, 1, "_".$session_year."_1");
        }else{
        ...
        $pdf->Cell($header_width,10,'Unit Report for Class  '.$class,1,0,'C');
        ...
        for($i=0; $i<$noOfSubject; $i++){
            ...
            if($studentSubject[$i] == 1){
                ...
                if($noOfOptionalSelection > 0){
                    $averageMarks = round((array_sum($studentSbjMarks[$i]) / $this->assessment_report_model->getCountOf($studentSbjMarks[$i], 0)),0);
                }else{
                    $averageMarks = 0;
                }
            }else{
                $averageMarks = round((array_sum($studentSbjMarks[$i])/ $noOfStudents),0);
            }
            $pdf->SetXY($ReportLast_X+45+($i*$cellHeight),$ReportLast_Y+($counter*$cellHeight));
            if($averageMarks==0){
                $pdf->Cell(7,$cellHeight,'',1,0,'C',1);
            }else{
                $pdf->Cell(7,$cellHeight,$averageMarks,1,0,'C',1);
            }
        }
        ...
        for($i=0; $i<$noOfSubject; $i++){
            $numCounter=0;
            if($studentSubject[$i] == 1){
                $numCounter = $this->assessment_report_model->getCountOf($studentSbjMarks[$i], $averageMarks);
            }else{
                for($j=0; $j<$noOfStudents; $j++){
                    if($studentSbjMarks[$i][$j] > $averageMarks){
                        $numCounter++;
                    }
                }
            }
        ...
        for($i=0; $i<$noOfSubject; $i++){
            $numCounter=0;
            if($studentSubject[$i] == 1){
                $numCounter = $this->assessment_report_model->getCountOf_Less($studentSbjMarks[$i], $averageMarks);
            }else{
                for($j=0; $j<$noOfStudents; $j++){
                    if($studentSbjMarks[$i][$j] <= $averageMarks){
                        $numCounter++;
        ...
        $ReportLast_Y = $ReportLast_Y+($counter*$cellHeight)+8;
        $counter=1;
        $cellHeight = 5;
        $cellWidth = 21;
        $pdf->SetFillColor(255,255,255);
    ...
    public function generate_unit_report_html(){
        $gradeID = $this->input->post('grade');
        $sectionID = $this->input->post('section');
        $academic_id = $this->input->post('academic');
        $gradeName = $this->input->post('grade_name');
        ...
        foreach ($this->data['assessment_titles'] as $data) {
            $table_header .= '
                <th class="sorting_asc" role="columnheader" tabindex="'.$table_header_counter.'"  aria-controls="subject_assessment_marks_table" rowspan="1" colspan="1" aria-sort="ascending" aria-label="S.No.">'.$data->subject_name.'</th>
            ';

            $table_footer .= '
                <th rowspan="1" colspan="1"><input type="text" name="filter_"'.$data->subject_code.' placeholder="Filter '.$data->subject_name.'" class="search_init"></th>
            ';

            if($data->optional == '1'){$student_marks_head_counter++;}
            $table_header_counter++;
        }
        $table_header .='<th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="subject_assessment_marks_table" rowspan="1" colspan="1" aria-sort="ascending" aria-label="P">P</th>';
        $table_header .='<th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="subject_assessment_marks_table" rowspan="1" colspan="1" aria-sort="ascending" aria-label="F">F</th>';
        

        $table_footer .= '<th rowspan="1" colspan="1"><input type="text" name="filter_totalMarks" placeholder="Filter P" class="search_init"></th>';
        $table_footer .= '<th rowspan="1" colspan="1"><input type="text" name="filter_percentage" placeholder="Filter F" class="search_init"></th>';
        ...
        foreach ($this->data['students_gs_data'] as $data) {
            ...
            foreach ($this->data['assessment_titles'] as $title) {
                ...
                if($marksObtained==0 && $gotZeroMarks=="No"){
                    $cell .= '<td class=" sorting_1 centered-cell" '.$bgColor.'></td>';
                }else{
            ...
            $table_body .= $cell;
            $table_body .= '<td class=" sorting_1 centered-cell" '.$bgColor.'></td>';
            $table_body .= '<td class=" sorting_1 centered-cell" '.$bgColor.'></td>';
            $table_body .= '</tr>';
        ...
        $html .= '
          <div class="col-md-12 bootstrap-grid sortable-grid ui-sortable">
            ...
            <div class="powerwidget purple" id="datatable-filter-column" data-widget-editbutton="false" role="widget" style="">
              <header role="heading">
                <i class="fa fa-tasks"></i> Report : '.$class.'
                <div class="powerwidget-ctrls" role="menu">
                  <h3>
                    <span class="glyphicon glyphicon-remove close_setup_4 pull-right cursor" style="top: -11px;"></span>
                  </h3>
    ...
    public function get_UnitAssessment_n_Review_Report_pdf(){
        ...
        $pdf_link = '/etab_reports/formative_unit_report_ajax/generate_UnitAssessment_n_Review_report?
        gradeID=' . $gradeID .
        '&sectionID=' . $sectionID .
        '&gradeName=' . $gradeName .
        '&sectionName=' . $sectionName .
    ...
    public function get_term_formative_report_pdf(){
        ...
        $pdf_link = '/etab_reports/formative_unit_report_ajax/formative_term_report?
        gradeID=' . $gradeID .
        '&sectionID=' . $sectionID .
        '&gradeName=' . $gradeName .
        '&sectionName=' . $sectionName .
 ...
 public function formative_term_report(){
        $gradeID = $this->input->get('gradeID');
        $sectionID = $this->input->get('sectionID');
        $gradeName = $this->input->get('gradeName');
        $sectionName = $this->input->get('sectionName');
        ...
        $header_width = $pdf->w - $ReportStarting_X*2;
        $pdf->SetXY($startWith_X,$startWith_Y);
        $pdf->Cell($header_width, $used_height_y, $class . ' (Term-1 Formative Report)',0,0,'C');
        ...
        public function get_Unit_Report_term2_pdf(){
        $gradeID = $this->input->post('grade');
        $sectionID = $this->input->post('section');
        $academic_id = $this->input->post('academic');
        $gradeName = $this->input->post('grade_name');
        ...
        $pdf_link = '/etab_reports/formative_unit_report_ajax/generate_unit_report_term2?
        gradeID=' . $gradeID .
        '&sectionID=' . $sectionID .
        '&gradeName=' . $gradeName .
        '&session_year=' . $session_year .
    ...
    public function generate_unit_report_term2(){
        $gradeID = $this->input->get('gradeID');
        $sectionID = $this->input->get('sectionID');
        $gradeName = $this->input->get('gradeName');
        $sectionName = $this->input->get('sectionName');
        ...
        //$this->data['assessment_titles'] = $this->assessment_report_model->get_unit_assessment_subjects($gradeID, $sectionID);
        if($term == 2){
        $this->data['assessment_titles'] = $this->assessment_report_model->get_unit_assessment_subjects_SessionTerm($gradeID, $sectionID, "_".$session_year."_2");
        ...
        if($optional == 0){
            //$this->data['students_gs_data'] = $this->assessment_report_model->get_students_grade_section($gradeID, $sectionID);
            $this->data['students_gs_data'] = $this->assessment_report_model->get_students_grade_section_SessionTerm($gradeID, $sectionID, "_".$session_year."_2");
        }else{
            $GroupID = substr(substr($gpp_id, -3), 0, 1);
            if($GroupID == 'A'){$GroupID=1;}else
            if($GroupID == 'B'){$GroupID=2;}else
        ...
        if($optional == 0){
            //$this->data['assessment_agg_marks'] = $this->assessment_report_model->Get_Formative_Unit_Marks_CurrentGS($gradeID, $sectionID, 1);
            $this->data['assessment_agg_marks'] = $this->assessment_report_model->Get_Formative_Unit_Marks_CurrentGS_SessionTerm($gradeID, $sectionID, 2, "_".$session_year."_2");
        }else{
        ...
        for($i=0; $i<$noOfSubject; $i++){
            $numCounter=0;
            if($studentSubject[$i] == 1){
                $numCounter = $this->assessment_report_model->getCountOf_Above($studentSbjMarks[$i], $average_Marks[$i]);
            }else{
                for($j=0; $j<$noOfStudents; $j++){
                    if($studentSbjMarks[$i][$j] >= $average_Marks[$i]){
                        $numCounter++;
                    }
                }
            }
            ...
            if(array_sum($studentSbjMarks[$i])==0){
                ...
                $pdf->Cell(7,$cellHeight,$numCounter,1,0,'C'); /*** Change here ***/
            }
        }
        ...
        for($i=0; $i<$noOfSubject; $i++){
            $numCounter=0;
            if($studentSubject[$i] == 1){
                $numCounter = $this->assessment_report_model->getCountOf_Less($studentSbjMarks[$i], $average_Marks[$i]);
            }else{
                for($j=0; $j<$noOfStudents; $j++){
                    if($studentSbjMarks[$i][$j] < $average_Marks[$i]){
                        $numCounter++;
     ...
     public function get_term_formative_report_term2_pdf(){
        ...
        $pdf_link = '/etab_reports/formative_unit_report_ajax/formative_term2_report?
        gradeID=' . $gradeID .
        '&sectionID=' . $sectionID .
        '&gradeName=' . $gradeName .
        '&sectionName=' . $sectionName .
    ...
    public function formative_term2_report(){
        ...
        $header_width = $pdf->w - $ReportStarting_X*2;
        $pdf->SetXY($startWith_X,$startWith_Y);
        $pdf->Cell($header_width, $used_height_y, $class . ' (Term-2 Formative Report)',0,0,'C');
    ...
    public function get_reading_assessment_report(){
        ...
        $pdf_link = '/etab_reports/formative_unit_report_ajax/generate_reading_assessment_report_term1?
        gradeID=' . $gradeID .
        '&sectionID=' . $sectionID .
        '&gradeName=' . $gradeName .
        '&session_year=' . $session_year .
    ...
    public function generate_reading_assessment_report_term1(){
        $gradeID = $this->input->get('gradeID');
        $sectionID = $this->input->get('sectionID');
        $gradeName = $this->input->get('gradeName');
        $sectionName = $this->input->get('sectionName');
        ...
        $this->data['assessment_titles'] = $this->assessment_report_model->get_unit_assessment_subjects_SessionTerm($gradeID, $sectionID, "_".$session_year."_2");
            ...
            $this->data['assessment_titles'] = $this->assessment_report_model->get_reading_assessment_subjects_SessionTerm($gradeID, $sectionID, "_".$session_year."_1");
        ...
        if($optional == 0){
         ...
         if($optional == 0){
            //$this->data['assessment_agg_marks'] = $this->assessment_report_model->Get_Formative_Unit_Marks_CurrentGS($gradeID, $sectionID, 1);
            $this->data['assessment_agg_marks'] = $this->assessment_report_model->Get_Formative_Reading_Marks_CurrentGS_SessionTerm($gradeID, $sectionID, 1, "_".$session_year."_1");
        ...
        $pdf->SetFont($font_name,'B',$font_size);
        $pdf->SetXY($ReportStarting_X,$ReportStarting_Y);
        $pdf->Cell($header_width,10,'Reading Report for Class  '.$class,1,0,'C');
