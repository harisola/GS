       ...
       <!--  <div class="ColVis"><button class="ColVis_Button ColVis_MasterButton"><span>Show / hide columns</span></button></div> -->
          ...
          <table class=" table table-striped table-hover dataTable" id="academic-term" >
            ...
            <?php foreach($view as $val2) {?>
              <tr>
                <td class='centered-cell'><?=$val2["id"]; ?></td>
                <td class='centered-cell'><?=$val2["dname"]; ?></td>
                <td class='centered-cell'><?=$val2["name"]; ?></td>
                <td class="centered-cell"><?=$val2["date_from"]; ?></td>
                <td class='centered-cell'><?=$val2["date_to"]; ?></td>
                <td class='centered-cell'><a href='JavaScript:void(0)' id='<?=$val2["id"];?>' class='edit-link'>Edit</a></td>
              </tr>
            <?php } ?>
			<?php  else : ?>
			<tr>
                <td class='centered-cell'>No Record Found!</td>
