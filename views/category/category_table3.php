...
<div class="callout callout-danger" id = 'alert-validation' style="display: none" > Cannot Data Insert Because Data Already Inserted </div>
...
<tbody>
      ...
      <td class="centered-cell"><b><?php echo $val->id; ?></b></td>
...
<script type="text/javascript">
  if ($('#assessment_grade_table').length) {
       ...
       $(document).ready(function(){
          $('#alert-validation').css('display','');
          $('#alert-validation').fadeOut(5000);
       });
