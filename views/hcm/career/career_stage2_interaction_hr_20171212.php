            ...
            <tr class="<?php echo $class_odd_even; ?>">
               ...
               <?php if($applicant_data->form_location == 0 || $applicant_data->form_location == 1) { ?>
                 <td class=" centered-cell"><?php echo $applicant_data->forward_interaction_name; ?>
                    <a class="btn btn-warning " data-toggle="modal" data-id="<?php echo $applicant_data->id;?>" href="#"><i class="fa fa-mail-forward"></i></a>
                 </td>
               <?php }else{ ?>
                  <td class=" centered-cell"><?php echo $applicant_data->forward_interaction_name; ?>
                  </td>
               ...
               <?php if(empty($applicant_data->form_location) || $applicant_data->form_location == 0) { ?>
                  <td class=" centered-cell">HR
                    <div class="btn-group">
                      <a class="btn btn-danger " data-toggle="modal" data-id="<?php echo $applicant_data->id;?>" href="#"><i class="fa fa-send"></i></a>
                    </div>
                  </td>
               ...
               <?php }else if($applicant_data->form_location == 3) {?>
                  <td class=" centered-cell">in transit from <?php echo $applicant_data->forward_interaction_name;?> to HR
                    <div class="btn-group">
                      <a class="btn btn-success " data-toggle="modal" data-id="<?php echo $applicant_data->form_send_received_id;?>" href="#"><i class="fa fa-check"></i></a>
                    </div>
                  </td>
               <?php } ?>
               <!-- Physical Form END -->
