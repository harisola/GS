...
<div class="col-md-12 no-padding" style="display:none;text-align: center;width: 335px;color#888;text-align:center; position: absolute;top: 40%;left: 40%;background: #f1efef;border: 1px solid #ccc;padding: 10px;" id="Generations_AjaxLoader">
<img src="<?php echo base_url();?>/components/image/gsLoader.gif" width="200" /><br /><hr style="margin: 7px 0;border-top: 1px solid #ccc;">
System updating time sheet...
</div>
        ...
        <!-- Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-footer">
                  <input type="submit" class="greenBTN widthSmall" value="Set Hijri Month Parameter" id="HijriButton" style="width: 46%;">
                </div>
            </div>
    ...
    <div class="modal fade TimeLineModal" id="SetHolidayParameter2" role="dialog">
        ...
        <!-- Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-footer">
                  <input type="submit" class="greenBTN widthSmall" value="Set Holiday Parameter" id="HPButton">
                </div>
            </div>
...
<div class="modal-footer">
<input type="submit" class="greenBTN widthSmall" id="SPButton" value="Set Staff Parameter">
</div><!-- Modal Footer-->
</div>
</div>
