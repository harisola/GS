        ...
        <?php $i=1; foreach ($this->feebill as $feebill) { ?>
            ...
            <?php } ?>
              ...
              <div class="table-responsive scrollitxaxis">
                <h5>Bill # : <?php echo $feebill['gb_id']; ?></h5>
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo substr($fee_desc_b[0], strpos($fee_desc_b[0], '@')+1); ?></td>
                      <?php
                ...
                <?php
                  ...
                  $MEO = FLOOR($studentTotalPayable / $studentTotalMonthly);
                ?>

                <?php if($FMEO > 0) { ?>
                  <div class="row">
                    <div class="col-lg-12 remittance">
                      <font size="3" face="verdana" color="black">Student Outstanding : </font>
                      <font size="5" color="red"><?php echo $MEO; ?></font>
                      <br>
                      <font size="3" face="verdana" color="black">Family Outstanding : </font>
