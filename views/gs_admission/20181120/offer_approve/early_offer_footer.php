...
<script type="text/javascript">
	$('#grade').change(function(){
		...
		$.ajax({
			...
			url:"<?php echo base_url() ?>index.php/gs_admission/early_admission_offer_approve_ajax/get_offer_detail",
			success:function(e){
	...
	$(document).on('click','#AddDetail',function(){
		...
		$.ajax({
			...
			url:"<?php echo base_url() ?>index.php/gs_admission/early_admission_offer_approve_ajax/add_detail",
			success:function(e){
				// console.log(e);
	...
	$(document).on('click','#preperation',function(){
		...
		$.ajax({
			...
			url:"<?php echo base_url() ?>index.php/gs_admission/early_admission_offer_approve_ajax/add_preperation",
			success:function(e){
	...
	$(document).on('click','#offer_submission',function(){
		...
		$.ajax({
			...
			cache:false,
			data:{form_id:form_id},
			url:"<?php echo base_url() ?>index.php/gs_admission/early_admission_offer_approve_ajax/offer_submission",
			success:function(e){
	...
	$(document).on('change','#region',function(){
		...
		$.ajax({
			...
			url:"<?php echo base_url() ?>index.php/gs_admission/early_admission_offer_approve_ajax/get_sub_region",
			success:function(e){
	...
	$(document).on('click','#preperation_submit',function(){
		...
		if(offer_letter_status == 1 && printed_fee_bill_status == 1){
		...
		$.ajax({
			...
			url:"<?php echo base_url(); ?>index.php/gs_admission/early_admission_offer_approve_ajax/insert_update_preperation",
			success:function(e){
				...
				$.ajax({
					...
					cache:false,
					data:{form_id:form_id},
					url:"<?php echo base_url() ?>index.php/gs_admission/early_admission_offer_approve_ajax/get_detail_of_form",
					success:function(f){
						...
						for(var i = 0 ; i < jsonData.length; i++){
							...
							offer_letter = jsonData[i].is_early_admission_printed_offer_letter;
							fif_form = jsonData[i].is_printed_fif;
							photo_taken = jsonData[i].is_printed_photo_token;
							handbook = jsonData[i].is_handbook;
							printedFeeBill = jsonData[i].is_early_admission_printed_fee_bill;
 	...
 	$(document).on('click','#btn-submission',function(){
 		...
 		if(check_signed_offer == 1 && check_offer_pack_handover == 1){
	 		...
	 		$.ajax({
	 			...
	 			url:"<?php echo base_url() ?>index.php/gs_admission/early_admission_offer_approve_ajax/insert_update_submission",
	 			success:function(e){
	 				...
	 				$.ajax({
	 					...
	 					success:function(f){
	 						...
	 						for(var i = 0 ; i < jsonData.length ;i++){
	 							is_signed_offer_letter = jsonData[i].is_early_admission_signed_offer_letter;
	 							is_complete_fif_form = jsonData[i].is_complete_fif_form;
	 							is_signed_hand_book = jsonData[i].is_signed_hand_book;
	 							is_fee_bill_handover = jsonData[i].is_early_offer_pack_handover;
