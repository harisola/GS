  ...
  <!-- <div class="col-md-12 bootstrap-grid"> -->
    <div class="powerwidget <?php echo $online_applicant_color_view; ?> powerwidget-sortable" id="datatable-filter-column" data-widget-editbutton="false" role="widget" style="">
      ...
      <div class="inner-spacer" role="content" style="text-align:center;">
        <button id="exportData" style="position:relative;">Download data in Excel</button>
      ...
      ?>
        <tr>
          ...
          <?php if ($applicant_data->sl2_grade == "") { ?>
            <td>.....</td>
          <?php }else { ?>
            <td><?php echo $applicant_data->sl2_grade; ?></td>
          <?php } ?> 
          <!-- Grade End -->
          ...
          <?php if ($applicant_data->sl2_comments == "") { ?>
            <td>.....</td>                
          <?php } else {?>
            <td><?php echo $applicant_data->sl2_comments; ?></td>
          <?php } ?>
          <!-- Comments End -->
