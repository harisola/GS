...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Validation
        <?php if($this->uri->uri_string() == 'emg/emg_msg') { ?>
        //HCM Applicant Form Validation
        if ($('#emg_send_msg_form').length) {
            $("#emg_send_msg_form").validate({
                ...
                messages: {
                    ...
                    msg_id: {
                        required: 'Please selct message'
                    },

                    message: {
                        required: 'Blank message is forbidden!'
                    }
                },
