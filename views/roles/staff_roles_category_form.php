<div class='col-md-4'>
	<div class='powerwidget dark-red'  data-widget-editbutton="false" data-widget-deletebutton="false" >
		<header>
			<h2>Roles<small>Staff Roles Category</small></h2>
		</header>
		<div class='inner-spacer'>
			...
			<form action='' method='POST' id='insert-role' class='orb-form'>
				...
				<section>
					<label class="input">
						<i class="icon-append fa fa-asterisk"></i>
						<input type="text" placeholder="Enter the Description" name="description" id="description"/>
						<b class="tooltip tooltip-bottom-right">Enter the Description</b>
					</label>
				</section>
...
<div class="col-md-8">
	<div class='powerwidget  marine' data-widget-editbutton="false" data-widget-deletebutton="false">
		<header>
			<h2>Staff Roles Category<small>Organization</small></h2>
		</header>
		<div class="inner-spacer">
