...
.has-success{
  background: hsl(98, 37%, 81%) none repeat scroll 0 0 !important;
	...
	<div class="col-md-8 inner-spacer" role="content">
	 <form id="option_selection2" name="option_selection2" class="orb-form">
		<table class="table table-striped table-bordered table-hover"  style="display:block" style="width:100%" id="tbleStdLst">
			<thead>
			  <tr>
				<th width="5%">ID</th>
				<th width="6%">GS-ID</th>
