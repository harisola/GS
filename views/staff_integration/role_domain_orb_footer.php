...
<!-- Secondary Reporting Modal -->
<div class="modal fade" id="secondary_reporting_modal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="secondary_reporting_header">Secondary Reporting</h4></div>
      <div id="secondary_reporting_modal_body" class="modal-body text-center ativa-scroll">
...
<?php if($this->uri->uri_string() == 'staff_integration/setup_role_new') {?>
  <script type="text/javascript" src="<?php echo base_url()?>components/orgchart/js/primitives.min.js"></script>
  <link href="<?php echo base_url()?>components/orgchart/css/primitives.latest.css" media="screen" rel="stylesheet" type="text/css" />
  ...
  <script type='text/javascript'>
      $(window).load(function () {
          ...
          var items = [
            ...
            foreach($this->data['all_roles'] as $role) { ?>
              ...
              new primitives.orgdiagram.ItemConfig({
                  id: <?php echo $role['id']; ?>,
                  parent: <?php if($role['report_to'] == 0) {echo "null";}else{echo $role['report_to'];} ?>,
                  <?php if($role['is_assistant'] == 1) { ?>                   
                    itemType: primitives.orgdiagram.ItemType.Assistant,
                    <?php if($role['is_assistant'] == $wasPreviousAssistant) { ?>
                  ...
                  <?php } ?>
                  <?php } ?>
                  title: "<?php echo substr($role['gr_id'], 0, 4) . substr($role['gr_id'], -2); ?>",
                  description: "<?php echo $role['staff_formal_name'] . '\n' . $role['c_topline']; ?>",                  
                  <?php if($role['report_to'] > 0) { ?>
                  groupTitle: "<?php echo $role['staff_department']; ?>",
                  <?php } ?>
                  image: "<?php echo $ImageName; ?>",                  
                  itemTitleColor: primitives.common.Colors.Maroon                  
              }),            
            <?php $wasPreviousAssistant = $role['is_assistant']; } ?>              
          ];
          ...
          options.itemTitleFirstFontColor = primitives.common.Colors.Yellow;
          options.itemTitleSecondFontColor = primitives.common.Colors.White;

          jQuery("#orgchart_diagram").orgDiagram(options);          
      });
  </script>
<?php } ?>
...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'staff_integration/setup_domain') {?>
            if ($('#role_domain_edit_table').length) {
                var oTable = $('#role_domain_edit_table').dataTable({
                    "oLanguage": {
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.aneditable_domain_order a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_domain/edit',
                        ...
                        $('.aneditable_domain_name a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_domain/edit',
                        ...
                        $('.aneditable_domain_dname a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_domain/edit',
                        ...
                        $('.aneditable_domain_code a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_domain/edit',
            ...
            <?php } ?>
             ...
             // // View, Edit Role Type
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'staff_integration/setup_role_type') {?>
            if ($('#role_type_edit_table').length) {
                var oTable = $('#role_type_edit_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.aneditable_role_order a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_type/edit',
                        ...
                        $('.aneditable_role_name a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_type/edit',
                        ...
                        $('.aneditable_role_dname a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_type/edit',
                        ...
                        $('.aneditable_role_code a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_type/edit',
            ...
            // View, Edit Role Secondary Reporting
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'staff_integration/setup_role_reporting') {?>
            if ($('#role_reporting_edit_table').length) {
                var oTable = $('#role_reporting_edit_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.aneditable_domain_order a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_reporting/edit',
                        ...
                        $('.aneditable_reporting_name a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_reporting/edit',
                        ...
                        $('.aneditable_reporting_dname a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_reporting/edit',
                        ...
                        $('.aneditable_reporting_description a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_reporting/edit',
            ...
            // View, Edit Role Network
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'staff_integration/setup_role_network') {?>
            if ($('#role_network_edit_table').length) {
                var oTable = $('#role_network_edit_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.aneditable_network_order a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_network/edit',
                        ...
                        $('.aneditable_network_name a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_network/edit',
                        ...
                        $('.aneditable_network_dname a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_network/edit',
            ...
            // View, Edit Role Team
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'staff_integration/setup_role_team') {?>
            if ($('#role_team_edit_table').length) {
                var oTable = $('#role_team_edit_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.aneditable_team_order a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_team/edit',
                        ...
                        $('.aneditable_team_name a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_team/edit',
                        ...
                        $('.aneditable_team_dname a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_team/edit',
                        ...
                        $('.aneditable_team_code a').editable({
                            type: 'text',
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_team/edit',
            ...
            // View, Edit Role in Organization
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'staff_integration/setup_role_new') {?>
            if ($('#role_org_edit_table').length) {
                var oTable = $('#role_org_edit_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        ...
                        $('.aneditable_role_wing a').editable({
                            type: 'select',
                            source: [
                                {value: 0, text: 'All'},
                            ...
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_new/edit',
                        ...
                        $('.aneditable_role_grade a').editable({
                            type: 'select',
                            source: [
                                {value: 0, text: 'All'},
                        ...
                        $('.aneditable_role_section a').editable({
                            type: 'select',
                            source: [
                                {value: 0, text: 'All'},
                        ...
                        $('.aneditable_role_subject a').editable({
                            type: 'select',
                            source: [
                                {value: 0, text: 'All'},
                                {value: 999, text: 'No Subject'},
                        ...
                        $('.aneditable_role_reportto a').editable({
                            type: 'select',
                            source: [                                
                                <?php foreach ($this->data['role'] as $data) { ?>
                                    {value: '<?php echo $data->id; ?>', text: '<?php echo $data->gr_id; ?>'},
                                <?php } ?>
                            ],
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_new/edit',
                        ...
                        $('.aneditable_role_sessionid a').editable({
                            type: 'select',
                            source: [                                
                                <?php foreach ($this->data['academic_session'] as $data) { ?>
                                    {value: '<?php echo $data->id; ?>', text: '<?php echo $data->name; ?>'},
                                <?php } ?>
                            ],
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_new/edit',
                        ...
                        $('.aneditable_role_staffid a').editable({
                            type: 'select2',
                            source: [
                                {value: 0, text: 'Undefined'},
                                <?php foreach ($this->data['staff'] as $data) { ?>
                                    {value: '<?php echo $data->id; ?>', text: '<?php echo $data->name_code . " - " . $data->name; ?>'},
                                <?php } ?>
                            ],
                            url: '<?php echo base_url()?>index.php/staff_integration/setup_role_new/edit',
...
$(document).ready(function(){
    $('[name=new_domain_reset_button]').click(function()  {        
        $('[name=domain_name]').val("");
        $('[name=domain_dname]').val("");
        $('[name=domain_code]').val("");        
        $('#domain_name').focus();
    });
});
...
$(document).ready(function(){
    $('[name=new_role_reset_button]').click(function()  {        
        $('[name=role_name]').val("");
        $('[name=role_dname]').val("");
        $('[name=role_code]').val("");        
        $('#role_name').focus();
...
$(document).ready(function(){
    $('[name=new_reporting_reset_button]').click(function()  {        
        $('[name=reporting_name]').val("");
        $('[name=reporting_dname]').val("");
        $('[name=reporting_description]').val("");        
        $('#reporting_name').focus();
    });
});


$(document).ready(function(){
    $('[name=new_network_reset_button]').click(function()  {        
        $('[name=network_name]').val("");
        $('[name=network_dname]').val("");        
        $('#network_name').focus();
    });
});
...
$(document).ready(function(){
    $('[name=new_team_reset_button]').click(function()  {        
        $('[name=team_name]').val("");
        $('[name=team_dname]').val("");        
        $('#team_name').focus();
    });
...
$(document).on("click", ".secondary_reporting_modal", function (e) {
    e.preventDefault();
    var _self = $(this);
    var role_id = _self.data('id');
    $.post('<?php echo base_url() . "index.php/staff_integration/setup_role_secondary_reporting_modal/";?>?role_id='+role_id, function(data) {
      $('#secondary_reporting_modal_body').html(data);
    });
    $("#secondary_reporting_modal").modal('show');
});
...
<script type="text/javascript" src="<?php echo base_url()?>components/js/bootstrap-select.min.js"></script>
<!--/Scripts-->
