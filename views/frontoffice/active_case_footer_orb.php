...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'fo/active_case_today') {?>
            if ($('#active_case_datatable').length) {
                var oTable = $('#active_case_datatable').dataTable({
                    "oLanguage": {
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.aneditable_acase_category_id a').editable({
                            source: [                                
                                    {value: "1", text: "Close"},                                
                            ],
                            url: '<?php echo base_url()?>index.php/fo/active_case_today/edit',
...
$(document).on("click", ".show_student_activecase", function (e) {
    ...
    $.post('<?php echo base_url() . "index.php/fo/activecase_current_modal/";?>?gsid='+gsid, function(data) {
...
$("#activecase_button").click( function()
   {
      if($("#activecase_id").val() > 0){
        ...
        $.post("<?php echo site_url() . '/fo/active_case_today/add2'; ?>", //Required URL of the page on server
      ...
      if($("#activecase_category").val() > 0){
        ...
        $.post("<?php echo site_url() . '/fo/active_case_today/add'; ?>", //Required URL of the page on server
        { // Data Sending With Request To Server
          gs_id:gs_id,
