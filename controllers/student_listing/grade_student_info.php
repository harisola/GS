...
class Grade_student_info extends CI_Controller{
	...
	private $Ten_Days_Students,$Sixty_Days,$TodayTotal;
	...
	public function index(){
		...
		if($this->ion_auth->logged_in() == FALSE){
			...
			//var_dump( $aca ); exit;
			//$this->class_list_allowed; 
			
			//var_dump( $this->data['allowed_classes']); 
			...
			$data["TodayTotal"] = $this->MPS->TodayTotal;
			
			
			//var_dump(  $header_count ); exit;
