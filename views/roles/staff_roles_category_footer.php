...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 &&   $this->uri->uri_string() == 'roles/staff_roles_category') {?>
                ...
                var oTable = $('#view_table').dataTable({
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        $('.aneditable_org_name a').editable({
                            ...
                            name: 'name',
                            title: 'Category Name',
                            url: '<?php echo base_url()?>index.php/roles/staff_roles_category_ajax/edit',
...
if($('#insert-role').length){
    $('#insert-role').validate({
        ...
        submitHandler: function(form){
            $(form).ajaxSubmit({
                type:"POST",
                url:"<?php echo base_url(); ?>index.php/roles/staff_roles_category_ajax/insert_org_domain",
                cache:false,
                success:function(data){
                   if(data != 1){
                       ...
                       $('#error').fadeOut(5000); 
                        ...
                        $.get("<?php echo base_url(); ?>index.php/roles/staff_roles_category_ajax/getLastId" ,function(e){
                            var name = $('#name').val();
                            var dname = $('#dname').val();
                            var sname = $('#sname').val();
                            var code =  $('#code').val();
