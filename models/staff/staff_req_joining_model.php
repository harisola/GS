<?php
class Staff_req_joining_model extends CI_Model{
	...
	protected $_table_name = 'staff_registered_requirements_joining';
	...
	public function exists_staff_req_joining($StaffID){
		$result = false;
