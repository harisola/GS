...
$(document).ready(function(){
    $('[name=visitor_worker_assignedcard_reset_button]').click(function()  {        
        ...
        $('[name=worker_visit_purpose]').val("");
        $('[name=worker_visit_to_person]').val("");
        $('[name=worker_visit_to_dapartment]').val("");
        $('[name=worker_assigned_card]').val("");
        $('#cnic').focus();*/
    });
});
function restform(){
...
$("#review-form").validate({
	...
	messages: {
		...
		worker_assigned_card: { required: 'Please enter card' }
