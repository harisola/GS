...
<link href="<?php echo base_url()?>components/css/jquery-ui.min.css" rel="stylesheet">
<link href="<?php echo base_url()?>components/css/jquery.comiseo.daterangepicker.css" rel="stylesheet">

<script src="<?php echo base_url()?>components/js/moment.min.js"></script>
<script src="<?php echo base_url()?>components/js/jquery.comiseo.daterangepicker.js"></script>
<script>
$(document).ready(function () {
    $("#e1").daterangepicker({
     datepickerOptions : {
    ...
    $( "#e1" ).datepicker( "option", "dateFormat", 'yy-mm-dd' );
...
<?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 && ($this->uri->uri_string() == 'vehicle/report_vehicle_in' || $this->uri->uri_string() == 'vehicle/report_vehicle_out'))  {?>
            if ($('#attendance_staff_today_table').length) {
                var oTable = $('#attendance_staff_today_table').dataTable({
                    "oLanguage": {
            ...
            <?php } ?>
			<?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'report/attendance_staff_vehicle_previousday')  {?>
            if ($('#attendance_staff_today_table').length) {
                var oTable = $('#attendance_staff_today_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
            ...
            // View, Edit, Delete from Table (Applicant) *** only VIEW
            <?php if($this->data['can_user_view'] == 1 && $this->data['can_user_delete'] == 0 && $this->uri->uri_string() == 'report/attendance_staff_previousday_out') {?>
            if ($('#attendance_staff_previousday_out_table').length) {
                var oTable = $('#attendance_staff_previousday_out_table').dataTable({
                    "oLanguage": {
                        "sSearch": "Search all columns:"                        
                    },
                    //"sDom": '<"search"fTlp><"bottom"><"clear">lrtip',
