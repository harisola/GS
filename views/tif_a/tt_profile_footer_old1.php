...
$(document).on('keypress change','#morning_time,#afternoon_time,#fri_time,#cus_morning,#cus_afternoon,#cus_fri,#sat_hour,#sat_on,#sat_off,#ext_frequency,#ext_time,#cus_ext_time,#cus_ext_freq,#cus_sat_hour,#cus_sat_off,#cus_sat_working',function(e){
...
//=========================================================================//
  ...
  // Standard Updation
   ...
   $(document).on('keypress change','#morning_time_update,#afternoon_time_update,#fri_time_update,#sat_hour_update,#ext_time_update,#ext_frequency_update,#sat_off_update,#sat_on_update',function(e){
