...
class Task_model extends CI_Model{
	...
	public $validation = array(
		array('field' => 'new_task_name', 'label' => 'Task Name', 'rules' => 'trim|required|xss_clean|is_unique[task.name]'),
		array('field' => 'task_hours_limit', 'label' => 'Task duration limit', 'rules' => 'trim|required|xss_clean|numeric'),
		array('field' => 'task_order', 'label' => 'Task Order', 'rules' => 'trim|required|xss_clean|numeric')
	);

	

	public function get_tasks(){
		$query=$this->db->query("SELECT id, name FROM atif_process.task where record_deleted = 0 order by name asc");
