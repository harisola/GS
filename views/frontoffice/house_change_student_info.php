<!-- Datatables View users -->
  ...
  <!-- <div class="col-md-12 bootstrap-grid"> -->
    <div class="powerwidget <?php echo $class_list_color_view; ?> powerwidget-sortable" id="datatable-filter-column" data-widget-editbutton="false" role="widget" style="">
      <header role="heading">
        <h2>House Change<small>Detail</small></h2>
      ...
      <div class="inner-spacer" role="content">
        ...
        <!-- <div class="ColVis"><button class="ColVis_Button ColVis_MasterButton"><span>Show / hide columns</span></button></div> -->
          ...
          <table class="display table table-striped table-hover dataTable" id="housechange_student_table" aria-describedby="class_list_info">
            ...
            <thead>
              <tr role="row">
                ...
                <th class="sorting centered-cell" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Old Status: activate to sort column ascending" style="width: 20px;">Old House</th>
                <th class="sorting centered-cell" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="New Status: activate to sort column ascending" style="width: 20px;">New House</th>
            ...
            <tfoot>
              <tr>
                ...
                <th rowspan="1" colspan="1"><input type="text" name="filter_oldstatus" placeholder="Filter Old House" class="search_init"></th>
                <th rowspan="1" colspan="1"><input type="text" name="filter_oldstatus" placeholder="Filter New House" class="search_init"></th>
          ...
          <?php
            $class_odd_even = 'even';
            $SNo = 1;
            foreach($this->data['HouseChange'] as $table_data) {
          ...
          ?>
            <tr class="<?php echo $class_odd_even; ?>">              
              ...
              <td class=" centered-cell"><?php echo $table_data['old_house_name']; ?></td>
              <td class=" centered-cell"><?php echo $table_data['new_house_name']; ?></td>
