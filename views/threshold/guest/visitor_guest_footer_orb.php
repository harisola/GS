...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // ========================================================================        
        if ($('#visitor_guest_assignedcard_form').length) {
            $("#visitor_guest_assignedcard_form").validate({
...
$(document).ready(function(){
    $('[name=visitor_guest_assignedcard_reset_button]').click(function()  {        
        resetform();
    });
});
...
function resetform(){
	$('[name=cnic]').val("");
        ...
        $('[name=guest_visit_purpose]').val("");
        $('[name=guest_visit_to_person]').val("");
        $('[name=guest_visit_to_dapartment]').val("");
        $('[name=guest_assigned_card]').val("");
        $('#cnic').focus();
}
...
$("#review-form").validate({
	...
	rules: {
		...
		guest_visit_purpose: { required: true },
		
		worker_visit_to_dapartment: { required: true },
	...
	messages: {
		...
		guest_visit_purpose: { required: 'Please enter visiting purpose' },
		
		worker_visit_to_dapartment: { required: 'Please enter department' },
		guest_assigned_card: { required: 'Please enter card' }
