<?php
class Staff_req_onboarding_model extends CI_Model{
	...
	protected $_table_name = 'staff_registered_requirements_onboarding';
	...
	public function exists_staff_req_onboarding($StaffID){
		$result = false;
