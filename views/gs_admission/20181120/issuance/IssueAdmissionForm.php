                            ...
                            <div class="col-md-12 paddingBottom20">
                                <div class="col-md-6">
                                    ...
                                    <div class="input_fields_wrap">
                                        ...
                                        <input name="student_mobile_phone[]"  type="number" class="col-md-10" placeholder="Mobile" id="" value="" style="padding-left:80px;" /> 
                            ...
                            <div class="col-md-12 paddingBottom20">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input_fields_wrap_mother" style="margin-bottom: 14px;">
                                        ...
                                        <input name="mother_mobile_phone[]" type="text" class="col-md-10" placeholder="Mobile" id="mother_mobile" value="" style="padding-left:80px;" /> 
