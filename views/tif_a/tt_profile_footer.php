...
$(document).on('keypress change','#cus_sat_off_update,#cus_sat_working_update',function(e){
  ...
  $(document).on('click','#profile_select',function(e){
    ...
    if($('#TTListing').find('tr').hasClass('selected') == true){

      $('#TTListing').find('tr').removeClass('selected');
    }

    e.target.parentNode.parentNode.className = 'selected';
