<!-- Datatables View users -->
  ...
  <!-- <div class="col-md-12 bootstrap-grid"> -->
    <div class="powerwidget <?php echo $title_background_color_view; ?> powerwidget-sortable" id="datatable-filter-column" data-widget-editbutton="false" role="widget" style="">
      <header role="heading">
        <h2>Applicant Forms<small>View</small></h2>
        ...
        <div id="applicant_view_table_wrapper" class="dataTables_wrapper form-inline" role="grid">
          ...
          ?>
            <tr class="<?php echo $class_odd_even; ?>">              
              ...
              <td class=" "><?php echo $applicant_record->gender; ?></td>
              <td class=" "><?php echo $applicant_record->nic; ?></td>
              <td class=" "><?php echo $applicant_record->mobile_phone; ?></td>
              <td class=" "><?php echo $applicant_record->land_line; ?></td>
              <td class=" "><?php echo $applicant_record->position; ?></td>
