...
class Mark_shortlist_a extends MY_Controller {
	...
	public function index()
	{
		...
		if($this->data['can_user_view'] == 1 && $this->data['can_user_edit'] == 1 && $this->data['can_user_delete'] == 0){
			...
			// Walk-In Applicants
			/*$this->online['applicant_data'] = array($this->career_form_model->get_by(array('email' => '')));*/

			// Online Applicants
			$this->online['applicant_data'] = array($this->career_form_model->get_by(array('email <>' => '')));

			$this->load->view('hcm/career/career_stage1_shortlist_a');
		}
		...
		for ($pageNo = 1; $pageNo <= $pageCount; $pageNo++) {
			...
			if ($templateId == 2) {
			    ...
			    ************************************************************************************/
				...
				//$classtaught_2= str_replace("","",trim("1, 2, 3, 4, 5, 6"));
