...
class Process_model extends CI_Model{
	...
	public $validation = array(
		array('field' => 'process_name', 'label' => 'Process Name', 'rules' => 'trim|required|xss_clean|is_unique[process.name]'),
		array('field' => 'process_category_option', 'label' => 'Process Category', 'rules' => 'trim|required|xss_clean')
	);

	public function get_process_category(){
		$query=$this->db->query("SELECT category FROM atif_process.process where record_deleted = 0 group by category order by category asc");
