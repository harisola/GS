...
<div class="col-md-6 bootstrap-grid sortable-grid ui-sortable">
  ...
  <div class="powerwidget cold-grey" id="assign_teachers_kg_div" data-widget-editbutton="false" role="widget" style="">
    <header role="heading">
      <h2>KG</h2>
    ...
    <div class="inner-spacer" role="content" style="overflow-x:scroll ; overflow-y: hidden;">
      <div class="assign_teacher_kg_image">
