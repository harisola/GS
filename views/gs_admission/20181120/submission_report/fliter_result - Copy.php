...
<!-- Grand Total -->
						  ...
						  <tr><td><?php 
									echo  $active_pn;echo "<br />";
									echo $active_n;echo "<br />";
									echo $active_kg;echo "<br />";
									echo $active_i;echo "<br />";
									echo $active_ii;echo "<br />";
									echo $active_iii;echo "<br />";
									echo $active_iv;echo "<br />";
									echo $active_v;echo "<br />";
									echo $active_vi;echo "<br />";
									echo $active_vii;echo "<br />";
									echo $active_viii;echo "<br />";
									echo $active_ix;echo "<br />";
									echo $active_x;echo "<br />";
									echo $active_xi;echo "<br />";
									echo $active_xii;echo "<br />";
